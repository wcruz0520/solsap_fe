...
Public Class frmDocumentoRE
    ...
    Public Sub CargaFormularioDocumento(sRUC As String, sCardCode As String, sNombre As String, oDocumento As Entidades.wsEDoc_ConsultaRecepcion.ENTRetencion, ofila As Integer, Optional documentoCargadoPorXML As Boolean = False)
        Dim xmlDoc As New Xml.XmlDocument
        Dim strPath As String
        If RecorreFormulario(rsboApp, "frmDocumentoRE") Then
            Exit Sub
        End If
        oCardCode = sCardCode
        _fila = ofila
        ...
        strPath = System.Windows.Forms.Application.StartupPath & "\frmDocumentoRE.srf"
        xmlDoc.Load(strPath)
        Try
            Try
            ...
            Catch exx As Exception
                rsboApp.Forms.Item("frmDocumentoRE").Close()
                xmlDoc = Nothing
                Exit Sub
            End Try
            ...
            oForm = rsboApp.Forms.Item("frmDocumentoRE")
            ...
            oForm.DataSources.DataTables.Item("dtDocs").Columns.Add("Fecha", SAPbouiCOM.BoFieldsType.ft_AlphaNumeric, 250)
            ...
            oForm.DataSources.DataTables.Item("dtDocs").Rows.Add(oDocumento.ENTDetalleRetencion.Count)
            Dim i As Integer = 0

            For Each odetalle As Entidades.wsEDoc_ConsultaRecepcion.ENTDetalleRetencion In oDocumento.ENTDetalleRetencion

                If IIf(IsNothing(odetalle.CodDocRetener), "", odetalle.CodDocRetener).ToString().Length = 0 Then
                    oForm.DataSources.DataTables.Item("dtDocs").SetValue("CodRet", i, "")
                Else
                    oForm.DataSources.DataTables.Item("dtDocs").SetValue("CodRet", i, IIf(IsNothing(IIf(odetalle.CodDocRetener.ToString().Equals("01"), "FACTURA", "")), "", IIf(odetalle.CodDocRetener.ToString().Equals("01"), "FACTURA", "")))
                End If
                ...
                oForm.DataSources.DataTables.Item("dtDocs").SetValue("Fecha", i, IIf(IsNothing(odetalle.FechaEmisionDocRetener), "", odetalle.FechaEmisionDocRetener.ToString("dd/MM/yyyy", CultureInfo.InvariantCulture)))
                oForm.DataSources.DataTables.Item("dtDocs").SetValue("pFiscal", i, _oDocumento.PeriodoFiscal)
                oForm.DataSources.DataTables.Item("dtDocs").SetValue("Base", i, Convert.ToDouble(odetalle.BaseImponible))
                ...
                ElseIf odetalle.Codigo = 6 Then
                    oForm.DataSources.DataTables.Item("dtDocs").SetValue("Impuesto", i, "ISD")
                End If
                oForm.DataSources.DataTables.Item("dtDocs").SetValue("Codigo", i, odetalle.CodigoRetencion.ToString())

                oForm.DataSources.DataTables.Item("dtDocs").SetValue("Porcent", i, Convert.ToDouble(odetalle.PorcentajeRetener))
                oForm.DataSources.DataTables.Item("dtDocs").SetValue("valorR", i, Convert.ToDouble(odetalle.ValorRetenido))

                If Not IsNothing(odetalle.NumDocRetener) Then
                    'If CargaFacturaRelacionadas Then
                    Dim sQueryFactura As String = ""
                    Dim sQueryFacturaAnt As String = ""
                    ...
                    If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS Then
                        If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                            ...
                            sQueryFacturaAnt += " AND ""U_SER_EST"" = '" & odetalle.NumDocRetener.ToString().Substring(0, 3) & "'"
                            sQueryFacturaAnt += " AND ""U_SER_PE"" = '" & odetalle.NumDocRetener.ToString().Substring(3, 3) & "'"
                            sQueryFacturaAnt += " AND ""FolioNum"" = " & Integer.Parse(odetalle.NumDocRetener.Substring(6, 9))
                    ...
                    ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.ONESOLUTIONS Then
                        If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                            ...
                            sQueryFactura += " AND B.""BeginStr"" = '" & odetalle.NumDocRetener.ToString().Substring(0, 3) & "'"
                            sQueryFactura += " AND B.""EndStr"" = '" & odetalle.NumDocRetener.ToString().Substring(3, 3) & "'"
                            sQueryFactura += " AND A.""FolioNum"" =" & Integer.Parse(odetalle.NumDocRetener.Substring(6, 9))
                            ...
                            sQueryFacturaAnt += " AND B.""BeginStr"" = '" & odetalle.NumDocRetener.ToString().Substring(0, 3) & "'"
                            sQueryFacturaAnt += " AND B.""EndStr"" = '" & odetalle.NumDocRetener.ToString().Substring(3, 3) & "'"
                            sQueryFacturaAnt += " AND A.""FolioNum"" =" & Integer.Parse(odetalle.NumDocRetener.Substring(6, 9))
                    ...
                    ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.SYPSOFT Or Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.TOPMANAGE Then
                        If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                            ...
                            sQueryFactura += " WHERE A.""CardCode"" = '" + sCardCode + "'"
                            sQueryFactura += " AND right(A.""NumAtCard"",17) = '" & odetalle.NumDocRetener.ToString().Substring(0, 3) _
                                & "-" & odetalle.NumDocRetener.ToString().Substring(3, 3) & "-" & odetalle.NumDocRetener.ToString().Substring(6, 9) & "'"
                            sQueryFactura += " AND A.""DocStatus""='O' AND A.""CANCELED""='N' "

                            sQueryFacturaAnt = " SELECT ""DocEntry"",(select min(""InstlmntID"") from INV6 where ""DocEntry""=""A"".""DocEntry"" and ""Status""='O') as ""Cuota"" "
                            sQueryFacturaAnt += " FROM ""ODPI"" A "
                            sQueryFacturaAnt += " WHERE A.""CardCode"" = '" + sCardCode + "'"
                            sQueryFacturaAnt += " AND right(A.""NumAtCard"",17) = '" & odetalle.NumDocRetener.ToString().Substring(0, 3) _
                                & "-" & odetalle.NumDocRetener.ToString().Substring(3, 3) & "-" & odetalle.NumDocRetener.ToString().Substring(6, 9) & "'"
                            sQueryFacturaAnt += " AND A.""DocStatus""='O' AND A.""CANCELED""='N' "
                    ...
                    ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.HEINSOHN Then
                        If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                            ...
                            sQueryFactura += " AND B.""BeginStr"" = '" & odetalle.NumDocRetener.ToString().Substring(0, 3) & "'"
                            sQueryFactura += " AND B.""EndStr"" = '" & odetalle.NumDocRetener.ToString().Substring(3, 3) & "'"
                            sQueryFactura += " AND REPLACE(LTRIM(REPLACE(RIGHT(A.""DocNum"",7),'0',' ')),' ','0') =" & Integer.Parse(odetalle.NumDocRetener.Substring(6, 9))
                            sQueryFactura += " AND A.""DocStatus""='O' AND A.""CANCELED""='N' "
                            ...
                            sQueryFacturaAnt += " AND B.""BeginStr"" = '" & odetalle.NumDocRetener.ToString().Substring(0, 3) & "'"
                            sQueryFacturaAnt += " AND B.""EndStr"" = '" & odetalle.NumDocRetener.ToString().Substring(3, 3) & "'"
                            sQueryFacturaAnt += " AND REPLACE(LTRIM(REPLACE(RIGHT(A.""DocNum"",7),'0',' ')),' ','0') =" & Integer.Parse(odetalle.NumDocRetener.Substring(6, 9))
                            sQueryFacturaAnt += " AND A.""DocStatus""='O' AND A.""CANCELED""='N' "
                    ...
                    ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.SOLSAP Then
                        If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                            ...
                            sQueryFacturaAnt += " AND ""U_SS_Est"" = '" & odetalle.NumDocRetener.ToString().Substring(0, 3) & "'"
                            sQueryFacturaAnt += " AND ""U_SS_Pemi"" = '" & odetalle.NumDocRetener.ToString().Substring(3, 3) & "'"
                            sQueryFacturaAnt += " AND ""FolioNum"" = " & Integer.Parse(odetalle.NumDocRetener.Substring(6, 9))
                            sQueryFacturaAnt += " AND ""DocStatus""='O' AND ""CANCELED""='N' "
                        Else
                            sQueryFactura = " SELECT DocEntry,(select min(""InstlmntID"") from INV6 where ""DocEntry""=""OINV"".""DocEntry"" and ""Status""='O') as ""Cuota"" FROM OINV WITH(NOLOCK) WHERE CardCode = '" + sCardCode + "'"
                    ...
                    Try
                        ...
                        Utilitario.Util_Log.Escribir_Log("Query Factura Relacionada:" + sQueryFactura.ToString + " Resultado: " + Factura.ToString, "frmDocumentoRE")
                        If Factura = "" Then
                            Factura = "0"
                        End If
                        NumCuota = CInt(oFuncionesB1.getRSvalue(sQueryFactura, "Cuota", ""))
                        Utilitario.Util_Log.Escribir_Log("Query Factura Relacionada cuota:" + NumCuota.ToString + " Resultado: " + Factura.ToString, "frmDocumentoRE")
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("Query Factura Relacionada:" + ex.Message().ToString() + "-QUERY: " + sQueryFactura, "frmDocumentoRE")
                    End Try
                    ...
                    Utilitario.Util_Log.Escribir_Log(String.Format("Query:{0}..DocEntry-Respuesta:{1}", sQueryFactura, Factura), "frmDocumentoRE")
            ...
            txtSub.Value = formatDecimal(Math.Round(_oDocumento.TotalRetencion, 2).ToString())
            ...
            'oForm.Width = 750
            'oForm.Height = 482
            If oDocumento.ENTDatoAdicionalRetencion IsNot Nothing Then
                LLenarGridDatosAdicionales(oDocumento.ENTDatoAdicionalRetencion.ToList)
            End If
    ...
    Public Sub CargaFormularioDocumentoExistente(IdDocumentoRecibido_UDO As String, Estado As String)
        ...
        Try
            ...
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("Error: " + ex.Message.ToString() + " - Query: " + QueryCabecera, "frmDocumentoRE")
            End Try
            ...
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("Error: " + ex.Message.ToString() + " - Query: " + QueryDetalle, "frmDocumentoRE")
            End Try
    ...
    Private Function CrearPagoRecibido_E_O(ByRef sDocEntryPreliminar As String, DocEntryRERecibida_UDO As String) As Boolean
        ...
        Utilitario.Util_Log.Escribir_Log("Obteniendo campo cliente - QUERY: " + sQueryCB + "Resultado :" + clienteBancario.ToString(), "frmDocumentoRE")
    ...
    Private Function CrearPagoRecibido_E_S(ByRef sDocEntryPreliminar As String, DocEntryRERecibida_UDO As String) As Boolean
        ...
        Try
            ...
            Try
                ...
                End If
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("error SYP_TIPOOPERACION: " + ex.Message.ToString, "frmDocumentoRE")
            End Try
            ...
            For Each oDetalle As Entidades.wsEDoc_ConsultaRecepcion.ENTDetalleRetencion In _oDocumento.ENTDetalleRetencion
                ...
                If oDetalle.ValorRetenido > 0 Then
                    ...
                    If CrTypeCode = 0 Then
                        ...
                        CrTypeCode = oFuncionesB1.getRSvalue(sQueryCrTypeCode, "CrTypeCode", "")
                        Utilitario.Util_Log.Escribir_Log("Obteniendo CrTypeCode (0) RENTA - QUERY: " + sQueryCrTypeCode + "Resultado :" + CrTypeCode.ToString(), "frmDocumentoRE")
                    End If
                    ...
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("CrTypeCode Asignado RENTA - QUERY: " + CrTypeCode.ToString(), "frmDocumentoRE")
                    End Try
                    ...
                    If oFuncionesB1.checkCampoBD("RCT3", "U_SYP_NROAUTO") Then
                        vPay.CreditCards.UserFields.Fields.Item("U_SYP_NROAUTO").Value = _oDocumento.AutorizacionSRI
                    End If
                    ...
                    Try
                        If oFuncionesB1.checkCampoBD("ORCT", "SYP_FECHARET") Then
                            Try
                                vPay.UserFields.Fields.Item("U_SYP_FECHARET").Value = _oDocumento.FechaEmision
                            Catch ex As Exception
                            End Try
                        End If
                        If oFuncionesB1.checkCampoBD("ORCT", "SYP_TipoOperacion") Then
                        ...
                        If oFuncionesB1.checkCampoBD("ORCT", "FX_AUTO_RETENCION") Then
                            vPay.UserFields.Fields.Item("U_FX_AUTO_RETENCION").Value = _oDocumento.AutorizacionSRI
                        End If
                        ...
                        End If
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("error seccion syp: " + ex.ToString(), "frmDocumentoRE")
                    End Try
    ...
    Private Function CrearPagoRecibido_S(ByRef sDocEntryPreliminar As String, DocEntryRERecibida_UDO As String) As Boolean
        ...
        Try
            ...
            If Functions.VariablesGlobales._vgFechaEmisionRetencion = "Y" Then
                vPay.DocDate = _oDocumento.FechaEmision
                vPay.DueDate = _oDocumento.FechaEmision
                vPay.TaxDate = _oDocumento.FechaEmision
            ElseIf Functions.VariablesGlobales._vgFechaEmisionRetencionP = "Y" Then
                vPay.DocDate = _oDocumento.FechaEmision
                vPay.TaxDate = _oDocumento.FechaEmision
            ElseIf IIf(String.IsNullOrEmpty(Functions.VariablesGlobales._FechaAutEnFechaContabRT), "N", Functions.VariablesGlobales._FechaAutEnFechaContabRT) = "Y" Then
                vPay.DocDate = _oDocumento.FechaAutorizacion

            ElseIf Functions.VariablesGlobales.FechaFinMesAnterior = "Y" Then
            ...
            Try
                vPay.UserFields.Fields.Item("U_SYP_PTSC").Value = _oDocumento.PuntoEmision
            Catch ex As Exception
                vPay.UserFields.Fields.Item("U_BPP_PTSC").Value = _oDocumento.PuntoEmision
                oFuncionesAddon.GuardaLOG("PRR", _ClaveAcceso, "Error: 1037 frmDocumentoRE " + ex.Message().ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            End Try
            Try
                vPay.UserFields.Fields.Item("U_SYP_SUCRET").Value = _oDocumento.Establecimiento
            Catch ex As Exception
                oFuncionesAddon.GuardaLOG("PRR", _ClaveAcceso, "Error: 1042 frmDocumentoRE " + ex.Message().ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            End Try
            Try
                vPay.UserFields.Fields.Item("U_SYP_PTCC").Value = _oDocumento.Secuencial
            Catch ex As Exception
                vPay.UserFields.Fields.Item("U_BPP_PTCC").Value = _oDocumento.Secuencial
                oFuncionesAddon.GuardaLOG("PRR", _ClaveAcceso, "Error: 1048 frmDocumentoRE " + ex.Message().ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            End Try
            ...
            'vPay.AccountPayments.SumPaid = _oDocumento.TotalRetencion
            'vPay.AccountPayments.Add()

            Dim CodRetencion As String = ""
            CodRetencion = Functions.VariablesGlobales._CodigoRetencion
            If CodRetencion = "" Then
                oFuncionesAddon.GuardaLOG("PRR", _oDocumento.ClaveAcceso, "ERROR - Revisar la configuracion en la opcion de parametrizaciones, debe tener registrado una Cuenta Contable Retención!", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                Elimina_DocumentoRecibido_RE(DocEntryRERecibida_UDO)
            ...
            If ValorIva > 0 Then
                ...
                vPay.TransferReference = "RTE " + _oDocumento.Secuencial
            End If
...
#Enable Warning BC42030 ' La variable 'ErrMsg' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
    ...
    Private Function CrearPagoRecibido_E_OCB(ByRef sDocEntryPreliminar As String, DocEntryRERecibida_UDO As String) As Boolean
        ...
        Try
            ...
            'CLIENTE BANCARIO 
            oFuncionesAddon.GuardaLOG("PRR", _oDocumento.ClaveAcceso, "Creando Pago Recibido Tipo Cuenta(Retencion) Preliminar", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            ...
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("agregando cuenta" + ex.Message.ToString + Cuenta.ToString(), "frmDocumentoRE")
            End Try
            ...
            Try
                vPay.AccountPayments.SumPaid = _oDocumento.TotalRetencion
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("agregando total retencion " + ex.Message.ToString + _oDocumento.TotalRetencion.ToString(), "frmDocumentoRE")
            End Try
            ...
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("error al agregar lineas pago recibido " + ex.Message.ToString, "frmDocumentoRE")
            End Try
            ...
            For Each oDetalle As Entidades.wsEDoc_ConsultaRecepcion.ENTDetalleRetencion In _oDocumento.ENTDetalleRetencion
                ...
                If oDetalle.ValorRetenido > 0 Then
                    ...
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando cuenta retencion: " + CuentaRetencion.ToString(), "frmDocumentoRE")
                    End Try
                    ...
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando codigo retencion: " + CodRetencion.ToString(), "frmDocumentoRE")
                    End Try
                    ' IIf(oDetalle.Codigo = 1, IIf(CodRetencionRENTA = "", CodRetencion, CodRetencionRENTA), CodRetencion)
                    Try
                        vPay.CreditCards.PaymentMethodCode = CrTypeCode 'IIf(oDetalle.Codigo = 1, IIf(CrTypeCodeRENTA = "", CrTypeCode, CrTypeCodeRENTA), CrTypeCode)
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando codigo tipo codigo: " + CrTypeCode.ToString(), "frmDocumentoRE")
                    End Try

                    Try
                        vPay.CreditCards.CreditCardNumber = _oDocumento.Secuencial
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando numero de tarjeta de credito : " + _oDocumento.Secuencial.ToString(), "frmDocumentoRE")
                    End Try

                    Try
                        vPay.CreditCards.CreditSum = oDetalle.ValorRetenido
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando valor retenido : " + oDetalle.ValorRetenido.ToString(), "frmDocumentoRE")
                    End Try
                    ...
                    Try
                        vPay.CreditCards.FirstPaymentSum = _oDocumento.TotalRetencion
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando total retencion : " + _oDocumento.TotalRetencion.ToString(), "frmDocumentoRE")
                    End Try
                    ...
                    If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS Then
                        ...
                        Try
                            ...
                            End If
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando monto base : " + oDetalle.BaseImponible.ToString(), "frmDocumentoRE")
                        End Try
                        '
                        Try
                            If oFuncionesB1.checkCampoBD("RCT3", "CXS_MONTO_BASE") Then
                        ...
                        Try
                            ...
                            End If
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando numero de retencion : " + _oDocumento.Secuencial.ToString(), "frmDocumentoRE")
                        End Try
                        '
                        Try
                            If oFuncionesB1.checkCampoBD("RCT3", "CXS_NUM_AUTO_RETE") Then
                            ...
                            End If
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando numero de autorizacion de retencion : " + _oDocumento.AutorizacionSRI.ToString(), "frmDocumentoRE")
                        End Try
                        '
                        Try
                            If oFuncionesB1.checkCampoBD("RCT3", "CXS_SER_PTO_RET") Then
                            ...
                            End If
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando est y punto de emision : " + _oDocumento.Establecimiento.ToString() + _oDocumento.PuntoEmision, "frmDocumentoRE")
                        End Try
                        Try
                            If oFuncionesB1.checkCampoBD("RCT3", "Exx_SN_Tip_Finan") Then
                                vPay.CreditCards.UserFields.Fields.Item("U_Exx_SN_Tip_Finan").Value = oCardCode
                            End If
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando est y punto de emision : " + oCardCode.ToString, "frmDocumentoRE")
                        End Try
                    ...
                    ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.SOLSAP Then
                        ...
                        If oFuncionesB1.checkCampoBD("RCT3", "SS_SecRetRec") Then
                            vPay.CreditCards.UserFields.Fields.Item("U_SS_SecRetRec").Value = _oDocumento.Secuencial
                        End If
                        If oFuncionesB1.checkCampoBD("RCT3", "SS_AutRetRec") Then
                            vPay.CreditCards.UserFields.Fields.Item("U_SS_AutRetRec").Value = _oDocumento.AutorizacionSRI
                        End If
                        If oFuncionesB1.checkCampoBD("RCT3", "SS_EstPtoRetRec") Then
                            vPay.CreditCards.UserFields.Fields.Item("U_SS_EstPtoRetRec").Value = _oDocumento.Establecimiento + _oDocumento.PuntoEmision
                        End If
                        ...
                        If oFuncionesB1.checkCampoBD("RCT3", "SS_NombreSN") Then
                            vPay.CreditCards.UserFields.Fields.Item("U_SS_NombreSN").Value = Left(_oDocumento.RazonSocial.ToString, 100)
                        End If

                        If String.IsNullOrEmpty(Functions.VariablesGlobales._CampoNumRetencion) Then
                            vPay.CreditCards.CreditCardNumber = _oDocumento.Secuencial
                        Else
                            vPay.CreditCards.UserFields.Fields.Item(Functions.VariablesGlobales._CampoNumRetencion).Value = _oDocumento.Secuencial
                        End If
                    End If
                    ...
                    Try
                        ...
                        End If
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando docentry udo : " + DocEntryRERecibida_UDO.ToString, "frmDocumentoRE")
                    End Try
                    ...
                    Try
                        ...
                        secuencial += 1
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando lineas medio de pago : " + ex.Message.ToString, "frmDocumentoRE")
                    End Try
            ...
            If Not String.IsNullOrEmpty(Functions.VariablesGlobales._ComentarioPago) Then
                ...
                comentarioPago = comentarioPago.Replace("@NUMRET", _oDocumento.Establecimiento + "-" + _oDocumento.PuntoEmision + "-" + _oDocumento.Secuencial)
                comentarioPago = comentarioPago.Replace("@FECHAEMISIONRET", CDate(_oDocumento.FechaEmision).ToString("yyyy/MM/dd"))
                comentarioPago = comentarioPago.Replace("@FECHAEMISIONFACT", CDate(_oDocumento.ENTDetalleRetencion(0).FechaEmisionDocRetener).ToString("yyyy/MM/dd"))
                comentarioPago = comentarioPago.Replace("@PORCRET", PORCENTAJES)
                comentarioPago = comentarioPago.Replace("@NUMFACT", NUMFACT)


                vPay.JournalRemarks = comentarioPago.ToString.Substring(0.253)
                vPay.Remarks = comentarioPago.ToString.Substring(0.253)

            Else

                If Functions.VariablesGlobales._vgProcesoLoteManamer = "Y" Then

                    vPay.Remarks = "RET" + " " + CLng(_oDocumento.Secuencial).ToString + " " + "FAC" + " " + CLng(Right(_oDocumento.ENTDetalleRetencion(0).NumDocRetener, 9)).ToString
                    vPay.JournalRemarks = "RET" + " " + CLng(_oDocumento.Secuencial).ToString + " " + "FAC" + " " + CLng(Right(_oDocumento.ENTDetalleRetencion(0).NumDocRetener, 9)).ToString
            ...
            Try
                RetVal = vPay.Add()
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("erro al agregar pago recibido tipo cuenta : " + ex.Message.ToString, "frmDocumentoRE")
            End Try
...
#Enable Warning BC42030 ' La variable 'ErrMsg' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
    ...
    Private Function CrearPagoRecibido_E_ONormal(ByRef sDocEntryPreliminar As String, DocEntryRERecibida_UDO As String) As Boolean
        ...
        Try
            ...
            ElseIf Functions.VariablesGlobales._vgProcesoLoteManamer = "Y" Then
                vPay.DocDate = _oDocumento.FechaEmision
                vPay.TaxDate = _oDocumento.FechaEmision
                vPay.DueDate = _oDocumento.FechaEmision
                ...
                If oDetalle.ValorRetenido > 0 Then
                    ...
                    ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.HEINSOHN Then
                        ...
                        If oFuncionesB1.checkCampoBD("ORCT", "HBT_NUM_SERIE_RET") Then
                            vPay.UserFields.Fields.Item("U_HBT_NUM_SERIE_RET").Value = _oDocumento.Establecimiento.ToString + "-" + _oDocumento.PuntoEmision.ToString
                        End If
                        If oFuncionesB1.checkCampoBD("ORCT", "HBT_NUM_RET") Then
                            vPay.UserFields.Fields.Item("U_HBT_NUM_RET").Value = _oDocumento.Secuencial.ToString
                        End If
                        If oFuncionesB1.checkCampoBD("ORCT", "HBT_NUM_AUT") Then
                            vPay.UserFields.Fields.Item("U_HBT_NUM_AUT").Value = _oDocumento.AutorizacionSRI.ToString
                        End If
                        If oFuncionesB1.checkCampoBD("ORCT", "HBT_NUM_AUT") Then
                            vPay.UserFields.Fields.Item("U_HBT_NUM_AUT").Value = _oDocumento.AutorizacionSRI.ToString
                        End If
                        If oFuncionesB1.checkCampoBD("ORCT", "HBT_FEC_RET") Then
                            vPay.UserFields.Fields.Item("U_HBT_FEC_RET").Value = CDate(_oDocumento.FechaAutorizacion)
                        End If
                        If oFuncionesB1.checkCampoBD("ORCT", "HBT_CADRET") Then
                            vPay.UserFields.Fields.Item("U_HBT_CADRET").Value = CDate(_oDocumento.FechaAutorizacion)
                        End If
            ...
            Try
                ...
                End If
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("DIB_TipoOperacion error: " + ex.Message.ToString, "frmDocumentoRE")
            End Try
            'Try
            '    If oFuncionesB1.checkCampoBD("ORCT", "DIB_TipoOperacion") Then
            '        vPay.UserFields.Fields.Item("U_DIB_TipoOperacion").Value = "A-0015"
...
#Enable Warning BC42030 ' La variable 'ErrMsg' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
    ...
    Private Function CrearPagoRecibido_E_OProveedor(ByRef sDocEntryPreliminar As String, DocEntryRERecibida_UDO As String) As Boolean
        ...
        Try
            ...
            Else
                vPay.DocDate = Date.Now
                'vPay.TaxDate = _oDocumento.FechaEmision LO COMENTO PERO NO RECUERDO A UE CLIENTE SE LE HIZO ESTE AJUSTE
                vPay.DueDate = Date.Now
                vPay.TaxDate = Date.Now
            End If
...
#Enable Warning BC42024 ' Variable local sin usar: 'ErrMsg'.
        ...
        Dim _NumDocRet As String = _oDocumento.ENTDetalleRetencion(0).NumDocRetener.ToString().Substring(0, 3) _
                                & "-" & _oDocumento.ENTDetalleRetencion(0).NumDocRetener.ToString().Substring(3, 3) & "-" & _oDocumento.ENTDetalleRetencion(0).NumDocRetener.ToString().Substring(6, 9)

        For Each oDetalle As Entidades.wsEDoc_ConsultaRecepcion.ENTDetalleRetencion In _oDocumento.ENTDetalleRetencion
            If oDetalle.Codigo = 1 Then ' RENTA
                totalRT = totalRT + oDetalle.ValorRetenido
            ElseIf oDetalle.Codigo = 2 Then ' IVA
                totalIVA = totalIVA + oDetalle.ValorRetenido
            End If
        Next
        Try
            ...
            End If
            oGeneralData.SetProperty("U_TM_DOCNUM_CR", _oDocumento.Establecimiento.ToString + "-" + _oDocumento.PuntoEmision.ToString + "-" + _oDocumento.Secuencial.ToString)
            oGeneralData.SetProperty("U_TM_FAUT", _oDocumento.FechaAutorizacion)
            oGeneralData.SetProperty("U_TM_CASRI", _oDocumento.AutorizacionSRI.ToString)
            oGeneralData.SetProperty("U_TM_CACC", _oDocumento.ClaveAcceso.ToString())
            oGeneralData.SetProperty("U_TM_TAXDATE", _oDocumento.FechaAutorizacion)
            ...
            For Each oDetalle As Entidades.wsEDoc_ConsultaRecepcion.ENTDetalleRetencion In _oDocumento.ENTDetalleRetencion
                ...
                oChild.SetProperty("U_TM_BASERET", Convert.ToDouble(formatDecimal(oDetalle.BaseImponible.ToString)))
                oChild.SetProperty("U_TM_IMPRET", Convert.ToDouble(formatDecimal(oDetalle.ValorRetenido.ToString)))
                oChild.SetProperty("U_TM_PORCRET", Convert.ToDouble(formatDecimal(oDetalle.PorcentajeRetener.ToString)))
            Next

            oGeneralParams = oGeneralService.Add(oGeneralData)
            sDocEntryPreliminar = oGeneralParams.GetProperty("DocEntry")
            oFuncionesAddon.GuardaLOG("PRR", _oDocumento.ClaveAcceso, "Comprobante Retencion Ventas Borrador, Creado Exitosamente: # " + sDocEntryPreliminar.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            Actualiza_DocumentoRecibido_RE(DocEntryRERecibida_UDO, sDocEntryPreliminar)
            'rCompany.GetNewObjectCode(sDocEntryPreliminar)
        ...
        Catch ex As Exception
            ...
            Utilitario.Util_Log.Escribir_Log("EEROR al crear registro en el udo comprobante retencion ventas: " + ex.Message, "frmDocumentoRE")
            Return False
        End Try
    End Function
                                    ...
                                    If iReturnValue = 1 Then
                                        ...
                                        If Guarda_DocumentoRecibido_RE(DocEntryRERecibida_UDO) Then
                                            If CrearPagoRecibido(sDocEntryPreliminar, DocEntryRERecibida_UDO) Then
                                                ...
                                                Catch ex As Exception
                                                    Utilitario.Util_Log.Escribir_Log("obtnGrabar - Try Catch Remove Fila:" + ex.Message().ToString(), "frmDocumentoRE")
                                                Finally
                                                    rsboApp.Forms.Item("frmDocumentosRecibidos").Freeze(False)
                                                End Try


                                                oFuncionesAddon.GuardaLOG("PRR", _oDocumento.ClaveAcceso, " Proceso terminado Exitosamente!", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                                                ...
                                                If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS _
                                                    ...
                                                    If CREADAPORGSEDOC = "SI" Then
                                                        Try ' SI ESTA OCULTO E FORMULARIO SE CAE
                                                            ...
                                                            End If
                                                        Catch ex As Exception
                                                            Utilitario.Util_Log.Escribir_Log("et_FORM_DATA_ADD - Try Catch Remove Fila:" + ex.Message().ToString(), "frmDocumentoRE")
                                                        Finally
                                                            rsboApp.Forms.Item("frmDocumentosRecibidos").Freeze(False)
                                                        End Try
                                                    End If
    ...
    Public Function Guarda_DocumentoRecibido_RE(ByRef DocEntryNCRecibida_UDO As String) As Boolean
        ...
        Dim oGeneralParams As SAPbobsCOM.GeneralDataParams
        Dim oCompanyService As SAPbobsCOM.CompanyService
        Utilitario.Util_Log.Escribir_Log("DocEntryNCRecibida_UDO" + DocEntryNCRecibida_UDO.ToString, "frmDocumentoRE")
        Try
            ...
            Try
                ...
                oGeneralData.SetProperty("U_IdGS", _oDocumento.IdRetencion.ToString())
            ...
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("cabecera UDO:" + ex.Message, "frmDocumentoRE")
            End Try
...
#Enable Warning BC42104 ' La variable 'oGeneralData' se usa antes de que se le haya asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
            ...
            Catch ex As Exception
                ' El DataTable no existe porue no no hay adicionales en el xml
                odt = Nothing
            End Try
...
#Enable Warning BC42104 ' La variable 'oGeneralService' se usa antes de que se le haya asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
        ...
        Catch ex As Exception
            ...
            rsboApp.StatusBar.SetText(NombreAddon + " - Ocurrio un error al guardar Pago Recibido(Retencion) Recibida en el UDO:" + ex.Message.ToString(), SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Utilitario.Util_Log.Escribir_Log("Ocurrio un error al guardar Pago Recibido(Retencion) Recibida en el UDO:" + ex.Message, "frmDocumentoRE")
            Return False
        End Try
    End Function
    ...
    Public Function MarcarVisto(ByVal IdDocumento As Integer, ByVal TipoDocumento As Integer, ByRef mensaje As String, idDocumentoRecibido_UDO As String) As Boolean
        Try
            ...
            End If
        Catch ex As Exception
            Utilitario.Util_Log.Escribir_Log("Error MarcarVisto : " + ex.Message.ToString, "frmDocumentoRE")
            Return False
        End Try
    End Function
    ...
    Public Sub GuardarArchivoRETRecibido(ByVal IdDocumento As Integer, ByVal TipoDocumento As Integer)
        ...
        Try
            ...
            If Not File.Exists(filepath) Then
                ...
                Dim FS As FileStream = Nothing
                Dim dbbyte As Byte() = WS.ConsultaArchivoProveedor_PDF(_WS_RecepcionClave, TipoDocumento, _oDocumento.IdRetencion, mensaje)
                If dbbyte Is Nothing Then
                    rsboApp.SetStatusBarMessage(NombreAddon + " - Arreglo de bytes vacío,! " + mensaje.ToString(), SAPbouiCOM.BoMessageTime.bmt_Long, False)
                Else
                    FS = New FileStream(filepath, System.IO.FileMode.Create)
...
#End Region
    ...
    Public Function LLenarGridDatosAdicionales(listInfoAdicional As List(Of Entidades.wsEDoc_ConsultaRecepcion.ENTDatoAdicionalRetencion)) As Boolean
        ...
        Try
            ...
            Dim i As Integer = 0
            For Each Info As Entidades.wsEDoc_ConsultaRecepcion.ENTDatoAdicionalRetencion In listInfoAdicional
    ...
    Public Function LLenarGridDatosAdicionalesExistente(IdUdo As String) As Boolean
        ...
        Try
            ...
            If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                ...
                QueryDetalle += "  FROM ""@GS1_RER"" A "
                QueryDetalle += "  WHERE A.""DocEntry"" =  " + IdUdo
            Else
                QueryDetalle = "SELECT  A.U_Nombre, A.U_Valor "
                QueryDetalle += "  FROM ""@GS1_RER"" A WITH(NOLOCK)"
                QueryDetalle += "  WHERE A.DocEntry =  " + IdUdo
            End If
