...
Public Class frmProcesoLote
    ...
    Public Sub CreaFormularioProcesoLote()
        ...
        If RecorreFormulario(rsboApp, "frmProcesoLote") Then
            Exit Sub
        End If

        strPath = System.Windows.Forms.Application.StartupPath & "\frmProcesoLote.srf"
        xmlDoc.Load(strPath)
        ...
        Try
            ...
            Catch exx As Exception
                rsboApp.Forms.Item("frmProcesoLote").Close()
                xmlDoc = Nothing
                Exit Sub
            End Try
            oForm = rsboApp.Forms.Item("frmProcesoLote")
                                            ...
                                            Try
                                                If oRetencion.FechaAutorizacion <= Date.Now Then
                                                    ...
                                                    If Date.Now.Day > 5 And FecAutRet.Month = Date.Now.Month And FecEmiFac.Month < Date.Now.Month Then
                                                        Dim odt2 As SAPbouiCOM.DataTable = rsboApp.Forms.Item("frmProcesoLote").DataSources.DataTables.Item("dtDocs")
                                                    ...
                                                    ElseIf FecEmiFac.Month < Date.Now.Month And FecAutRet.Month < Date.Now.Month And FecEmiRet.Month < Date.Now.Month Then
                                                        ...
                                                        gcss.SetRowBackColor(y + 1, RGB(251, 163, 26))
                                                    Else
                                                        Dim odt As SAPbouiCOM.DataTable = rsboApp.Forms.Item("frmProcesoLote").DataSources.DataTables.Item("dtDocs")
    ...
    Private Sub rSboApp_ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean) Handles rsboApp.ItemEvent
        Try
            ...
            If pVal.FormTypeEx = "frmProcesoLote" Then
                        ...
                        If Not pVal.Before_Action Then
                            Select Case pVal.ItemUID
                                ...
                                Case "oGrid"
                                    ...
                                    oFor = rsboApp.Forms.Item("frmProcesoLote")
    ...
    Public Function CargarDocumento() As Boolean
        Try
            ...
            Utilitario.Util_Log.Escribir_Log("SALIDA POR PROXY : " + SALIDA_POR_PROXY.ToString, "frmProcesoLote")
            ...
            If SALIDA_POR_PROXY = "Y" Then
                ...
                Utilitario.Util_Log.Escribir_Log("Proxy_puerto : " + Proxy_puerto.ToString, "frmProcesoLote")
                Utilitario.Util_Log.Escribir_Log("Proxy_IP : " + Proxy_IP.ToString, "frmProcesoLote")
                Utilitario.Util_Log.Escribir_Log("Proxy_Usuario : " + Proxy_Usuario.ToString, "frmProcesoLote")
                Utilitario.Util_Log.Escribir_Log("Proxy_Clave : " + Proxy_Clave.ToString, "frmProcesoLote")
            ...
            Select Case cbxTipo.Value
                Case "01"
                    ...
                    Dim oFiltrosRecepcionECM As New wsEDoc_ConsultaRecepcion.ClsBusqueda
                    oFiltrosRecepcionECM.CiaTipoAlojamientoKey = Functions.VariablesGlobales._WS_RecepcionClave
                    If Not String.IsNullOrEmpty(LicTradNum) Then
                        oFiltrosRecepcionECM.RucProveedor = LicTradNum
                    End If
                    oFiltrosRecepcionECM.Estado = _WS_RecepcionCargaEstados

                    Try
                        Dim sRutaCarpeta As String = AppDomain.CurrentDomain.SetupInformation.ApplicationBase & "LOG\"
                        Dim sRuta As String = sRutaCarpeta & "Filtros_Consulta_Recepcion_FC_masivo" + ".xml"
                        If System.IO.Directory.Exists(sRutaCarpeta) Then
                            ...
                            x.Serialize(writer, oFiltrosRecepcionECM)
                            writer.Close()
                    ...
                    Dim z = WS.ConsultarFactura_CabeceraBuscar(oFiltrosRecepcionECM, mensaje).ToList
        ...
        Try
            ...
            ElseIf tipoDoc = "07" Then
                ...
                For Each oRE As Entidades.wsEDoc_ConsultaRecepcion.ENTRetencion In listaREs.GetRange(NumIni, RegistrosXPaginas)
                    ...
                    Dim _FechaEmisionDocRetener As String = oRE.ENTDetalleRetencion(0).FechaEmisionDocRetener.ToString("dd/MM/yyyy")
                    ...
                    oForm.DataSources.DataTables.Item("dtDocs").SetValue("FechaEmisionFactura", i, oRE.ENTDetalleRetencion(0).FechaEmisionDocRetener)
                    If Not String.IsNullOrEmpty(DocPreliminar) Then
    ...
    Private Function ChooseFromList(ByRef pVal As SAPbouiCOM.ItemEvent, ByVal FormUID As String) As Boolean
        ...
        If FormUID = "frmProcesoLote" Then
            oForm = rsboApp.Forms.Item("frmProcesoLote")
    ...
    Private Sub SBO_Application_RightClickEvent(ByRef eventInfo As SAPbouiCOM.ContextMenuInfo, ByRef BubbleEvent As Boolean) Handles rsboApp.RightClickEvent
        ...
        Try
            If eventInfo.FormUID = "frmProcesoLote" And eventInfo.ItemUID = "oGrid" Then
    ...
    Private Sub rSboApp_MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean) Handles rsboApp.MenuEvent
        Try
            ...
            End If
        Catch ex As Exception
            Utilitario.Util_Log.Escribir_Log($"Error rsboApp_MenuEvent: {ex.Message}", "frmProcesoLote")
    ...
    Public Function Guarda_DocumentoRecibido_Factura(ByRef DocEntryFacturaRecibida_UDO As String, ByRef oFac As Entidades.wsEDoc_ConsultaRecepcion.ENTFactura) As Boolean
        ...
        Try
                ...
                Try
                    ...
                    End If
                Catch ex As Exception
                    Utilitario.Util_Log.Escribir_Log("REE - error al obtener CardCode PL : " + ex.ToString, "frmProcesoLote")
                End Try
            ...
            oGeneralParams = oGeneralService.Add(oGeneralData)
                ...
                Utilitario.Util_Log.Escribir_Log("REE - se creo el preliminar : " + DocEntryFacturaRecibida_UDO, "frmProcesoLote")
    ...
    Private Function CrearFacturaPremilinarServicio(ByRef sCardCode As String, ByVal oFactura As Entidades.wsEDoc_ConsultaRecepcion.ENTFactura, ByRef sDocEntryPreliminar As String, ByVal DocEntryFVRecibida_UDO As String) As Boolean
        ...
        Try
            ...
            For Each oDetalle As Entidades.wsEDoc_ConsultaRecepcion.ENTDetalleFactura In oFactura.ENTDetalleFactura
                ...
                Utilitario.Util_Log.Escribir_Log("Obteniendo TAXCODE - QUERY: " + sQueryCodImp + "Resultado :" + CodImp.ToString(), "frmProcesoLote")
                Utilitario.Util_Log.Escribir_Log("Obteniendo TAXCODE - QUERY: " + sQueryCodImpV + "Resultado :" + CodImpV.ToString(), "frmProcesoLote")
                ...
                Utilitario.Util_Log.Escribir_Log("Obteniendo centro de costo - QUERY: " + sQueryCentroCosto + "Resultado :" + CodCentroCosto.ToString(), "frmProcesoLote")
                ...
                Utilitario.Util_Log.Escribir_Log("Obteniendo marca - QUERY: " + sQueryMarca + "Resultado :" + CodMarca.ToString(), "frmProcesoLote")
...
#Enable Warning BC42030 ' La variable 'ErrMsg' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
    ...
    Public Function Guarda_DocumentoRecibido_RE(ByRef DocEntryFacturaRecibida_UDO As String, ByRef _oRetencion As Entidades.wsEDoc_ConsultaRecepcion.ENTRetencion) As Boolean
    ...
    Private Function CrearPagoRecibido_E_OCB(ByRef sCardCode As String, ByRef oRetencion As Entidades.wsEDoc_ConsultaRecepcion.ENTRetencion, ByRef sDocEntryPreliminar As String, DocEntryRERecibida_UDO As String) As Boolean
        ...
        Try
            ...
            For Each oDetalle As Entidades.wsEDoc_ConsultaRecepcion.ENTDetalleRetencion In oRetencion.ENTDetalleRetencion
                ...
                If oDetalle.ValorRetenido > 0 Then
                    ...
                    If oDetalle.Codigo = 1 Then ' RENTA
                        ...
                        Utilitario.Util_Log.Escribir_Log("Obteniendo CODIGO RENTA - QUERY: " + sQueryCodRetencion + "Resultado :" + CodRetencion.ToString(), "frmProcesoLote")
                    ...
                    ElseIf oDetalle.Codigo = 6 Then ' ISD
                        ...
                        CodRetencion = oFuncionesB1.getRSvalue(sQueryCodRetencion, "U_SSID", "")
                        Utilitario.Util_Log.Escribir_Log("Obteniendo CODIGO ISD - QUERY: " + sQueryCodRetencion + "Resultado :" + CodRetencion.ToString(), "frmProcesoLote")
                        If CodRetencion = "" Then
                    ...
                    Utilitario.Util_Log.Escribir_Log("Obteniendo CUENTA RENTA - QUERY: " + sQueryCuentaRetencion + "Resultado :" + CuentaRetencion.ToString(), "frmProcesoLote")
                    ...
                    Utilitario.Util_Log.Escribir_Log("Obteniendo CrTypeCode RENTA - QUERY: " + sQueryCrTypeCode + "Resultado :" + CrTypeCode.ToString(), "frmProcesoLote")
                    ...
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando cuenta retencion: " + CuentaRetencion.ToString(), "frmProcesoLote")
                    End Try
                    ...
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando codigo retencion: " + CodRetencion.ToString(), "frmProcesoLote")
                    End Try
                    ...
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando codigo tipo codigo: " + CrTypeCode.ToString(), "frmProcesoLote")
                    End Try

                    Try
                        vPay.CreditCards.CreditCardNumber = oRetencion.Secuencial
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando numero de tarjeta de credito : " + oRetencion.Secuencial.ToString(), "frmProcesoLote")
                    End Try

                    Try
                        vPay.CreditCards.CreditSum = oDetalle.ValorRetenido
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando valor retenido : " + oDetalle.ValorRetenido.ToString(), "frmProcesoLote")
                    End Try
                    ...
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando total retencion : " + oRetencion.TotalRetencion.ToString(), "frmProcesoLote")
                    End Try
                    ...
                    If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS Then
                        ...
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando fecha autroizacion : " + oRetencion.FechaAutorizacion.ToString(), "frmProcesoLote")
                        End Try
                        ...
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando fecha autroizacion : " + oDetalle.NumDocRetener.ToString(), "frmProcesoLote")
                        End Try
                        '
                        Try
                            ...
                            End If
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando monto base : " + oDetalle.BaseImponible.ToString(), "frmProcesoLote")
                        End Try
                        '
                        Try
                        ...
                        Try
                            ...
                            End If
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando numero de retencion : " + oRetencion.Secuencial.ToString(), "frmProcesoLote")
                        End Try
                        '
                        Try
                            ...
                            End If
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando numero de autorizacion de retencion : " + oRetencion.AutorizacionSRI.ToString(), "frmProcesoLote")
                        End Try
                        '
                        Try
                            ...
                            End If
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando est y punto de emision : " + oRetencion.Establecimiento.ToString() + oRetencion.PuntoEmision, "frmProcesoLote")
                        End Try
                        Try
                            ...
                            End If
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando est y punto de emision : " + sCardCode.ToString, "frmProcesoLote")
                        End Try
                    ...
                    Try
                        ...
                        End If
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando docentry udo : " + DocEntryRERecibida_UDO.ToString, "frmProcesoLote")
                    End Try
                    ...
                    Try
                        ...
                        secuencial += 1
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando lineas medio de pago : " + ex.Message.ToString, "frmProcesoLote")
                    End Try
            ...
            Try
                RetVal = vPay.Add()
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("erro al agregar pago recibido tipo cuenta : " + ex.Message.ToString, "frmProcesoLote")
            End Try
            ...
            If RetVal <> 0 Then
                ...
                Try
                    ...
                    'Dim xml As String = vPay.GetAsXML()
                    If System.IO.Directory.Exists(sRutaCarpeta) Then
                        Utilitario.Util_Log.Escribir_Log("Serializando...", "frmProcesoLote")
                        Dim writer As TextWriter = New StreamWriter(sRuta)
                        writer.Write(xml)
                        writer.Close()
                    End If
                Catch ex As Exception
                    Utilitario.Util_Log.Escribir_Log("EEROR " + ex.Message, "frmProcesoLote")
                End Try
...
#Enable Warning BC42030 ' La variable 'ErrMsg' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
    ...
    Private Function CrearPagoRecibido_E_ONormal(ByRef sCardCode As String, ByRef oRetencion As Entidades.wsEDoc_ConsultaRecepcion.ENTRetencion, ByRef sDocEntryPreliminar As String, DocEntryRERecibida_UDO As String) As Boolean
        Utilitario.Util_Log.Escribir_Log("Inicio funcion creae preliminar sCardCode: " + sCardCode.ToString, "frmProcesoLote")
        Dim RetVal As Long
        Dim ErrCode As Long
        Dim ErrMsg As String
        Dim vPay As SAPbobsCOM.Payments
        ...
        Utilitario.Util_Log.Escribir_Log("Obteniendo CARDCODE - QUERY: " + QryCardCode + "Resultado :" + sCardCode.ToString(), "frmProcesoLote")
        ...
        Utilitario.Util_Log.Escribir_Log("Obteniendo saldo pendiendte - QUERY: " + queryValorRT + "Resultado :" + valorRT.ToString(), "frmProcesoLote")
        ...
        Utilitario.Util_Log.Escribir_Log("Obteniendo docentry de la factura - QUERY: " + docentry + "Resultado :" + _docentry.ToString(), "frmProcesoLote")
        ...
        Utilitario.Util_Log.Escribir_Log("Obteniendo cardcode - QUERY: " + queryCardCode + "Resultado :" + _CardCode.ToString(), "frmProcesoLote")
        ...
        Utilitario.Util_Log.Escribir_Log("Obteniendo fecha de la factura: " + queryDocDate + "Resultado :" + DocDate.ToString(), "frmProcesoLote")
        ...
        Utilitario.Util_Log.Escribir_Log("Obteniendo docnum del medio de pago : " + MedioPago + "Resultado :" + _MedioPago.ToString(), "frmProcesoLote")
        ...
        Utilitario.Util_Log.Escribir_Log("_valorRT Resultado :" + _valorRT.ToString(), "frmProcesoLote")
        'Dim jaja As Double = Convert.ToDouble(valorRT)
        'Dim ejej As Double = ConvertToDouble(valorRT)
        Utilitario.Util_Log.Escribir_Log("sCardCode Resultado :" + sCardCode.ToString(), "frmProcesoLote")
        _CardCode = sCardCode
        Utilitario.Util_Log.Escribir_Log("_CardCode Resultado :" + _CardCode.ToString(), "frmProcesoLote")
        If _docentry <> "0" Then
            Utilitario.Util_Log.Escribir_Log("_docentry Resultado :" + _docentry.ToString(), "frmProcesoLote")
            If valorRetencion <= _valorRT Then
                Utilitario.Util_Log.Escribir_Log("El valor de la retencion : " + valorRetencion.ToString + "es menor o igual  a :" + _valorRT.ToString(), "frmProcesoLote")
                ...
                If Not _MedioPago <> "0" Then
                    ...
                    Try
                        ...
                        Utilitario.Util_Log.Escribir_Log(" cardcode :" + sCardCode.ToString(), "frmProcesoLote")
                        vPay.ApplyVAT = SAPbobsCOM.BoYesNoEnum.tYES
                        vPay.DocCurrency = "USD"
                        ...
                        For Each oDetalle As Entidades.wsEDoc_ConsultaRecepcion.ENTDetalleRetencion In oRetencion.ENTDetalleRetencion
                            ...
                            If oDetalle.ValorRetenido > 0 Then
                                ...
                                If CrTypeCode = 0 Then
                                    ...
                                    CrTypeCode = oFuncionesB1.getRSvalue(sQueryCrTypeCode, "CrTypeCode", "")
                                    Utilitario.Util_Log.Escribir_Log("Obteniendo CrTypeCode (0) RENTA - QUERY: " + sQueryCrTypeCode + "Resultado :" + CrTypeCode.ToString(), "frmProcesoLote")
                                End If
                                'vPay.CreditCards.CreditAcct = IIf(oDetalle.Codigo = 1, IIf(CuentaRetencionRENTA = "", CuentaRetencion, CuentaRetencionRENTA), CuentaRetencion)
                                'vPay.CreditCards.CreditCard = IIf(oDetalle.Codigo = 1, IIf(CodRetencionRENTA = "", CodRetencion, CodRetencionRENTA), CodRetencion)
                                'vPay.CreditCards.PaymentMethodCode = IIf(oDetalle.Codigo = 1, IIf(CrTypeCodeRENTA = "", CrTypeCode, CrTypeCodeRENTA), CrTypeCode)
                                ...
                                Try
                                    vPay.CreditCards.PaymentMethodCode = CrTypeCode 'IIf(oDetalle.Codigo = 1, IIf(CrTypeCodeRENTA = "", CrTypeCode, CrTypeCodeRENTA), CrTypeCode)
                                Catch ex As Exception
                                    Utilitario.Util_Log.Escribir_Log("CrTypeCode Asignado RENTA - QUERY: " + CrTypeCode.ToString(), "frmProcesoLote")
                                End Try
                        ...
                        For Each oDetalle As Entidades.wsEDoc_ConsultaRecepcion.ENTDetalleRetencion In oRetencion.ENTDetalleRetencion
                            If Not IsNothing(oDetalle.NumDocRetener) Then
                                ...
                                Try
                                    ...
                                    Utilitario.Util_Log.Escribir_Log("Query Factura Relacionada:" + sQueryFactura.ToString() + "-Resultado: " + Factura, "frmProcesoLote")
                                    If Factura = "" Then
                                        Factura = "0"
                                    End If
                                Catch ex As Exception
                                    Utilitario.Util_Log.Escribir_Log("Query Factura Relacionada:" + ex.Message().ToString() + "-QUERY: " + sQueryFactura, "frmProcesoLote")
                                ...
                                Utilitario.Util_Log.Escribir_Log(String.Format("Query:{0}..DocEntry-Respuesta:{1}", sQueryFactura, Factura), "frmProcesoLote")
                                If Not Factura = "0" Then
                                    ...
                                    Utilitario.Util_Log.Escribir_Log("Query Factura Relacionada:" + oDetalle.ValorRetenido.ToString() + "-QUERY: " + sQueryFactura, "frmProcesoLote")
                        ...
                        Next
                        Try
                            Utilitario.Util_Log.Escribir_Log("Try FC Relacionada: " + Factura.ToString, "frmProcesoLote")
                            If Not Factura = "0" Then
                                ...
                                Next
                            End If
                            Utilitario.Util_Log.Escribir_Log("Try Salida: " + Factura.ToString, "frmProcesoLote")
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("Error Try fc relacionada: " + ex.ToString, "frmProcesoLote")
                            men = ex.Message.ToString()
                        End Try
    ...
    Private Function CrearPagoRecibido_S(ByRef sCardCode As String, ByRef oRetencion As Entidades.wsEDoc_ConsultaRecepcion.ENTRetencion, ByRef sDocEntryPreliminar As String, DocEntryRERecibida_UDO As String) As Boolean
        ...
        Try
            ...
            Catch ex As Exception
                ...
                oFuncionesAddon.GuardaLOG("PRR", _ClaveAcceso, "Error: 1037 frmProcesoLote " + ex.Message().ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            End Try
            Try
                vPay.UserFields.Fields.Item("U_SYP_SUCRET").Value = oRetencion.Establecimiento
            Catch ex As Exception
                oFuncionesAddon.GuardaLOG("PRR", _ClaveAcceso, "Error: 1042 frmProcesoLote " + ex.Message().ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            End Try
            Try
            ...
            Catch ex As Exception
                ...
                oFuncionesAddon.GuardaLOG("PRR", _ClaveAcceso, "Error: 1048 frmProcesoLote " + ex.Message().ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            End Try
                                ...
                                Try
                                    If ActualizadoEstado_DocumentoRecibido_RE(idDocumentoRecibido_UDO, "docFinal", sClaveAcceso) Then
                                        ...
                                        Try ' SI ESTA OCULTO E FORMULARIO SE CAE
                                            If rsboApp.Forms.Item("frmProcesoLote").Visible = True Then
                                                rsboApp.Forms.Item("frmProcesoLote").Freeze(True)
                                                Dim odt As SAPbouiCOM.DataTable = rsboApp.Forms.Item("frmProcesoLote").DataSources.DataTables.Item("dtDocs")
                                                odt.Rows.Remove(ofila)
                                                rsboApp.Forms.Item("frmProcesoLote").Freeze(False)
                                            End If
                                        Catch ex As Exception
                                        End Try
                                    End If
