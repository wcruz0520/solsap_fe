...
Public Class frmAnexoVentas
    ...
    Public Sub CargaFormularioAnexoVentas()
        Dim xmlDoc As New Xml.XmlDocument
        Dim strPath As String
        If RecorreFormulario(rsboApp, "frmAnexoVentas") Then
            Exit Sub
        End If

        strPath = System.Windows.Forms.Application.StartupPath & "\frmAnexoVentas.srf"
        xmlDoc.Load(strPath)
        Try
            Try
                rsboApp.LoadBatchActions(xmlDoc.InnerXml)
            Catch exx As Exception
                rsboApp.Forms.Item("frmAnexoVentas").Close()
                xmlDoc = Nothing
                Exit Sub
            End Try

            oForm = rsboApp.Forms.Item("frmAnexoVentas")
            ...
            txtCodSN.ChooseFromListUID = "CFL1"
            ...
            Dim lnkC As SAPbouiCOM.LinkedButton
            lnkC = oForm.Items.Item("lnkC").Specific
            lnkC.LinkedObjectType = 2
            lnkC.Item.LinkTo = "txtCodSN"
    ...
    Private Sub CargarGrid()
        ...
        sQuery = Utilitario.Util_Encriptador.Desencriptar(Functions.VariablesGlobales._SS_VentasQRY.Replace("{", "").Replace("}", "").ToString(), sKey)
        ...
        Try
            ...
            Try
                Utilitario.Util_Log.Escribir_Log("QUERY ANEXO VENTAS: " + sQuery, "frmAnexoVentas")
                oGrid.DataTable.ExecuteQuery(sQuery)
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("Query Documentos Enviados Log:" + ex.Message().ToString() + "-QUERY: " + sQuery, "frmAnexoVentas")
            End Try
            ...
            Select Case pVal.EventType
                ...
                Case SAPbouiCOM.BoEventTypes.et_CHOOSE_FROM_LIST
                    ...
                    If oCFLEvento.BeforeAction = False Then
                        ...
                        Dim oForm As SAPbouiCOM.Form = rsboApp.Forms.Item("frmAnexoVentas")

                        If sCFL_ID = "CFL1" Then
    ...
    Public Sub ExportGridToExcel(ByVal grid As SAPbouiCOM.Grid)
        ...
        Try
            ...
            rsboApp.SetStatusBarMessage("Generado visualizacion en Excel..!", SAPbouiCOM.BoMessageTime.bmt_Short, False)
            ...
            ' Liberar objetos COM
            oFuncionesB1.Release(worksheet)
            oFuncionesB1.Release(workbook)
            oFuncionesB1.Release(excelApp)

        Catch ex As Exception

            rsboApp.SetStatusBarMessage("Error al enviar informacion a excel " + ex.Message.ToString, SAPbouiCOM.BoMessageTime.bmt_Short, True)
