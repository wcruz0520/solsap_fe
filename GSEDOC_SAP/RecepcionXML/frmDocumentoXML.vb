...
Public Class frmDocumentoXML
    ...
    ''' <remarks></remarks>
    Public Sub CargaFormularioDocumento(sRUC As String, sCardCode As String, sNombre As String, oDocumento As Factura, ofila As Integer)
        Dim xmlDoc As New Xml.XmlDocument
        Dim strPath As String
        If RecorreFormulario(rsboApp, "frmDocumentoXML") Then
            Exit Sub
        End If
        oCardCode = sCardCode
        _fila = ofila
        strPath = System.Windows.Forms.Application.StartupPath & "\frmDocumentoXML.srf"
        xmlDoc.Load(strPath)
        Try
            Try
                rsboApp.LoadBatchActions(xmlDoc.InnerXml)
                _oDocumento = oDocumento
                _ClaveAcceso = oDocumento.FacturaCabecera._claveAcceso
                '_xml = oDocumento.ArchivoXml
            Catch exx As Exception
                rsboApp.Forms.Item("frmDocumentoXML").Close()
                xmlDoc = Nothing
                Exit Sub
            End Try

            oForm = rsboApp.Forms.Item("frmDocumentoXML")
            ...
            'idGS
            _IdGS = _oDocumento.FacturaCabecera._DocEntry 'SE COMENTA YA QUE ESTE DATO NO SE LO USARA
            ...
            txtClaAcc.Value = _oDocumento.FacturaCabecera._claveAcceso
            ...
            txtNumAut.Value = _oDocumento.FacturaCabecera._NumeroAutorizacion
            ...
            txtFecAut.Value = _oDocumento.FacturaCabecera._FechaAutorizacion
            ...
            txtNumDoc.Value = _oDocumento.FacturaCabecera._estab + "-" + _oDocumento.FacturaCabecera._ptoEmi + "-" + _oDocumento.FacturaCabecera._secuencial
            ...
            oForm.DataSources.DataTables.Item("dtDocs").Rows.Add(oDocumento.facturaDetalle.Count)
            Dim i As Integer = 0

            For Each odetalle As FacturaDetalle In oDocumento.facturaDetalle

                oForm.DataSources.DataTables.Item("dtDocs").SetValue("CodPrin", i, IIf(IsNothing(odetalle._codigoPrincipal), odetalle._descripcion, odetalle._codigoPrincipal))
                oForm.DataSources.DataTables.Item("dtDocs").SetValue("CodAuxi", i, IIf(IsNothing(odetalle._codigoAuxiliar), "", odetalle._codigoAuxiliar)) '
                ...
                If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                    oForm.DataSources.DataTables.Item("dtDocs").SetValue("CodSAP", i, oFuncionesB1.getRSvalue("SELECT ""ItemCode"" FROM ""OSCN"" WHERE ""CardCode"" = '" + sCardCode + "' AND ""Substitute"" = '" + IIf(IsNothing(Trim(odetalle._codigoPrincipal)), Left(odetalle._descripcion, 50), Left(odetalle._codigoPrincipal, 50)) + "'", "ItemCode", ""))
                Else
                    oForm.DataSources.DataTables.Item("dtDocs").SetValue("CodSAP", i, oFuncionesB1.getRSvalue("SELECT ItemCode FROM OSCN WHERE CardCode = '" + sCardCode + "' AND Substitute = '" + IIf(IsNothing(odetalle._codigoPrincipal.Trim), Left(odetalle._descripcion, 50), Left(odetalle._codigoPrincipal, 50)) + "'", "ItemCode", ""))
                End If
                ...
                If IIf(IsNothing(odetalle._descripcion), "", odetalle._descripcion).ToString().Length > 250 Then
                    Try
                        oForm.DataSources.DataTables.Item("dtDocs").SetValue("Descripc", i, odetalle._descripcion.Substring(1, 249))
                    Catch ex As Exception
                        oForm.DataSources.DataTables.Item("dtDocs").SetValue("Descripc", i, "-")
                    End Try
                Else
                    oForm.DataSources.DataTables.Item("dtDocs").SetValue("Descripc", i, IIf(IsNothing(odetalle._descripcion), "", odetalle._descripcion))
                End If

                oForm.DataSources.DataTables.Item("dtDocs").SetValue("Cantid", i, Convert.ToDouble(odetalle._cantidad))
                ...
                oForm.DataSources.DataTables.Item("dtDocs").SetValue("Precio", i, Convert.ToDouble(odetalle._precioUnitario))
                oForm.DataSources.DataTables.Item("dtDocs").SetValue("Desc", i, Convert.ToDouble(odetalle._descuento))
                oForm.DataSources.DataTables.Item("dtDocs").SetValue("Total", i, Convert.ToDouble(odetalle._precioTotalSinImpuesto))
                ...
                If PendienteMapear = False Then
                    If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                        CodigoArticulo = oFuncionesB1.getRSvalue("SELECT ""ItemCode"" FROM ""OSCN"" WHERE ""CardCode"" ='" + sCardCode + "' AND ""Substitute""  = '" + IIf(IsNothing(Trim(odetalle._codigoPrincipal)), Left(odetalle._descripcion, 50), Left(odetalle._codigoPrincipal, 50)) + "'", "ItemCode", "")
                    Else
                        CodigoArticulo = oFuncionesB1.getRSvalue("SELECT ItemCode FROM OSCN WITH(NOLOCK) WHERE CardCode ='" + sCardCode + "' AND Substitute  = '" + IIf(IsNothing(Trim(odetalle._codigoPrincipal)), Left(odetalle._descripcion, 50), Left(odetalle._codigoPrincipal, 50)) + "'", "ItemCode", "")
                    End If
            ...
            For Each facImpuesto As FacturaCabeceraImpuestos In _oDocumento.FacturaCabecera._impuestos
            ...
            txtSubS.Value = formatDecimal(Math.Round(oDocumento.FacturaCabecera._totalSinImpuestos, 2).ToString())
            ...
            txDes.Value = formatDecimal(oDocumento.FacturaCabecera._totalDescuento.ToString())
            ...
            txtTotal.Value = formatDecimal(Math.Round(oDocumento.FacturaCabecera._importeTotal, 2).ToString())
            ...
            '        rsboApp.Forms.Item("frmDocumentoXML").Items.Item("objR").Specific.value = ObjTypeRelacionado
            '        rsboApp.Forms.Item("frmDocumentoXML").Items.Item("docR").Specific.value = DocEntrysRelacionado
            ...
            Dim chkFRes As SAPbouiCOM.CheckBox
            chkFRes = oForm.Items.Item("chkFRes").Specific
            oForm.DataSources.UserDataSources.Add("udchkFRes", SAPbouiCOM.BoDataType.dt_SHORT_TEXT, 1)
            chkFRes.ValOn = "Y"
            chkFRes.ValOff = "N"
            chkFRes.DataBind.SetBound(True, "", "udchkFRes")
            ...
            If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS _
                ...
                If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                    SQUERY = "SELECT ""DocEntry"" FROM ""ODRF"" WHERE ""ObjType"" = 22 AND ""DocStatus"" ='O' AND ""U_SSCREADAR"" = 'SI' AND ""U_NUM_AUTOR"" = '" + _oDocumento.FacturaCabecera._NumeroAutorizacion + "'"
                Else
                    SQUERY = "SELECT DocEntry FROM ODRF WITH(NOLOCK) WHERE ObjType = 22 AND DocStatus ='O' AND U_SSCREADAR = 'SI' AND U_NUM_AUTOR = '" + _oDocumento.FacturaCabecera._NumeroAutorizacion + "'"
                End If
            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.ONESOLUTIONS Then
                If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                    SQUERY = "SELECT ""DocEntry"" FROM ""ODRF"" WHERE ""ObjType"" = 22 AND ""DocStatus"" ='O' AND ""U_SSCREADAR"" = 'SI' AND ""U_NO_AUTORI"" = '" + _oDocumento.FacturaCabecera._NumeroAutorizacion + "'"
                Else
                    SQUERY = "SELECT DocEntry FROM ODRF WITH(NOLOCK) WHERE ObjType = 22 AND DocStatus ='O' AND U_SSCREADAR = 'SI' AND U_NO_AUTORI = '" + _oDocumento.FacturaCabecera._NumeroAutorizacion + "'"
                End If
            ...
            If rsult = "0" Then ' SI ESTA VACÍO VOY Y CONSULTA LA TABLA PEDIDO DE COMPRA PARA VALIDAR SI EXISTE
                ...
                If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS _
                    Or Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.SOLSAP Then
                    If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                        SQUERY2 = "SELECT ""DocEntry"" FROM ""OPOR"" WHERE ""U_SSCREADAR"" = 'SI' AND ""U_NUM_AUTOR"" = '" + _oDocumento.FacturaCabecera._NumeroAutorizacion + "'"
                    Else
                        SQUERY2 = "SELECT DocEntry FROM OPOR WITH(NOLOCK) WHERE U_SSCREADAR = 'SI' AND U_NUM_AUTOR = '" + _oDocumento.FacturaCabecera._NumeroAutorizacion + "'"
                    End If
                ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.ONESOLUTIONS Then
                    If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                        SQUERY2 = "SELECT ""DocEntry"" FROM ""OPOR"" WHERE ""U_SSCREADAR"" = 'SI' AND ""U_NO_AUTORI"" = '" + _oDocumento.FacturaCabecera._NumeroAutorizacion + "'"
                    Else
                        SQUERY2 = "SELECT DocEntry FROM OPOR WITH(NOLOCK) WHERE U_SSCREADAR = 'SI' AND U_NO_AUTORI = '" + _oDocumento.FacturaCabecera._NumeroAutorizacion + "'"
                    End If
                ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.SYPSOFT Then
    ...
    Public Sub CargaFormularioDocumentoExistente(IdDocumentoRecibido_UDO As String, Estado As String)
        ...
        Try
            ...
            If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                ...
                QueryCabecera += " ,""U_SubTot"" ,""U_Sub0"" ,""U_SubNO"""
                QueryCabecera += " ,""U_SubEx"" ,""U_SubSI"" ,""U_Desc"""
                QueryCabecera += " ,""U_ICE"" ,""U_IVA"" ,""U_vTotal"""
            ...
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("Error: " + ex.Message.ToString() + " - Query: " + QueryCabecera, "frmDocumentoXML")
            End Try
            ...
            For i = 0 To odt.Rows.Count - 1
                ...
                Dim txtNumDoc As SAPbouiCOM.EditText
                txtNumDoc = oForm.Items.Item("txtNumDoc").Specific
                txtNumDoc.Value = odt.GetValue("U_NumDoc", i).ToString() '_oDocumento.FacturaCabecera._estab + "-" + _oDocumento.FacturaCabecera._ptoEmi + "-" + _oDocumento.FacturaCabecera._secuencial
                ...
                txtDTot = rsboApp.Forms.Item("frmDocumentoXML").Items.Item("txtDTot").Specific
                ...
                txtDP = rsboApp.Forms.Item("frmDocumentoXML").Items.Item("txtDP").Specific
                ...
                txtDVP = rsboApp.Forms.Item("frmDocumentoXML").Items.Item("txtDVP").Specific
                ...
                txtDG = rsboApp.Forms.Item("frmDocumentoXML").Items.Item("txtDG").Specific
                ...
                txtDI = rsboApp.Forms.Item("frmDocumentoXML").Items.Item("txtDI").Specific
                ...
                txtDT = rsboApp.Forms.Item("frmDocumentoXML").Items.Item("txtDT").Specific
            ...
            oForm.DataSources.DataTables.Item("dtDocs").Columns.Add("CodSAP", Left(SAPbouiCOM.BoFieldsType.ft_AlphaNumeric, 100))
            oForm.DataSources.DataTables.Item("dtDocs").Columns.Add("Descripc", Left(SAPbouiCOM.BoFieldsType.ft_AlphaNumeric, 250))
            oForm.DataSources.DataTables.Item("dtDocs").Columns.Add("Cantid", Left(SAPbouiCOM.BoFieldsType.ft_AlphaNumeric, 100))
            oForm.DataSources.DataTables.Item("dtDocs").Columns.Add("Precio", Left(SAPbouiCOM.BoFieldsType.ft_AlphaNumeric, 100))
            oForm.DataSources.DataTables.Item("dtDocs").Columns.Add("Desc", Left(SAPbouiCOM.BoFieldsType.ft_AlphaNumeric, 100))
            oForm.DataSources.DataTables.Item("dtDocs").Columns.Add("Total", Left(SAPbouiCOM.BoFieldsType.ft_AlphaNumeric, 100))
            ...
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("Error: " + ex.Message.ToString() + " - Query: " + QueryDetalle, "frmDocumentoXML")
            End Try
            ...
            oForm.DataSources.DataTables.Item("dtDocr").Columns.Add("Quantity", Left(SAPbouiCOM.BoFieldsType.ft_AlphaNumeric, 100))
            oForm.DataSources.DataTables.Item("dtDocr").Columns.Add("Price", Left(SAPbouiCOM.BoFieldsType.ft_AlphaNumeric, 250))
            oForm.DataSources.DataTables.Item("dtDocr").Columns.Add("DiscPrcnt", Left(SAPbouiCOM.BoFieldsType.ft_AlphaNumeric, 100))
            oForm.DataSources.DataTables.Item("dtDocr").Columns.Add("TaxCode", Left(SAPbouiCOM.BoFieldsType.ft_AlphaNumeric, 100))
            oForm.DataSources.DataTables.Item("dtDocr").Columns.Add("LineTotal", Left(SAPbouiCOM.BoFieldsType.ft_AlphaNumeric, 100))
            ...
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("Error: " + ex.Message.ToString() + " - Query: " + QueryDetalleRelacionados, "frmDocumentoXML")
            End Try
...
#Enable Warning BC42030 ' La variable 'idForm' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
            If typeEx = "frmDocumentoXML" Then
                            ...
                            Select Case pVal.ItemUID
                                ...
                                Case "btnMapear"
                                    ...
                                    Else ' SI EXISTE EL PROVEEDOR
                                        ...
                                        Dim sClaveAcceso As String = _oDocumento.FacturaCabecera._claveAcceso
                                        Dim sNombre As String = _oDocumento.FacturaCabecera._RazonSocial
                                        ...
                                        For Each oDetalle As FacturaDetalle In _oDocumento.facturaDetalle
                                            listaDetalleArtiulos.Add(New Entidades.DetalleArticulo(sClaveAcceso, IIf(IsNothing(oDetalle._codigoPrincipal), oDetalle._descripcion, oDetalle._codigoPrincipal),
                                        ...
                                        Next
                                        ofrmMapeo.CargaFormularioMapeo(_oDocumento.FacturaCabecera._ruc, oCardCode, sNombre, listaDetalleArtiulos, _fila, "FV")
                                    End If
                                Case "btnPedi"
                                ...
                                Case "obtnGrabar"
                                    ...
                                    ElseIf cbxTipo.Value = "Factura de Servicio" Then '"Servicio"
                                        Try
                                            ...
                                            If iReturnValue = 1 Then
                                                ...
                                                Dim chkFRes As SAPbouiCOM.CheckBox
                                                chkFRes = oForm.Items.Item("chkFRes").Specific
                                                If chkFRes.Checked = True Then
                                                    rsboApp.SetStatusBarMessage(NombreAddon + " - No se puede crear una Factura preliminar de reserva de proveedores tipo Servicio..!", SAPbouiCOM.BoMessageTime.bmt_Medium, True)
                                                    Exit Sub
                                                End If
                                    ...
                                    If Exitoso = True Then
                                        ...
                                        oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, " Proceso terminado Exitosamente!", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                                ...
                                Case True
                                    ...
                                    If Not oDocumentoSAP.CancelStatus = SAPbobsCOM.CancelStatusEnum.csCancellation Then
                                        If Not oDocumentoSAP.DocObjectCode = SAPbobsCOM.BoObjectTypes.oDrafts Then
                                            ...
                                            If CREADAPORGSEDOC = "SI" Then
                                                ...
                                                ActualizadoEstadoUdoFacturaXML(idFacturaGS, "Contabilizado")
                                                ...
                                                'oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, " Documento Preliminar # " + DocEntryPreliminar.ToString() + ", cerrado Satisfactoriamente!!", Functions.FuncionesAddon.Transacciones.CreacionFinal, Functions.FuncionesAddon.TipoLog.Recepcion)
                                                ...
                                                'oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, " Obteniendo Documento Preliminar # " + DocEntryPreliminar.ToString() + ", para cerrarlo", Functions.FuncionesAddon.Transacciones.CreacionFinal, Functions.FuncionesAddon.TipoLog.Recepcion)
                                                ...
                                                '            oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, " Error al Cerrar Documento Preliminar # " + DocEntryPreliminar.ToString() + ", " + ErrCode.ToString() + " - " + ErrMsg.ToString(), Functions.FuncionesAddon.Transacciones.CreacionFinal, Functions.FuncionesAddon.TipoLog.Recepcion)
                                                '        Else
                                                '            oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, " Documento Preliminar # " + DocEntryPreliminar.ToString() + ", cerrado Satisfactoriamente!!", Functions.FuncionesAddon.Transacciones.CreacionFinal, Functions.FuncionesAddon.TipoLog.Recepcion)
                                                '        End If
                                                '    End If
                                                ...
                                                '    oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, " Error al Cerrar Documento Preliminar # " + DocEntryPreliminar.ToString() + ": " + ex.Message.ToString(), Functions.FuncionesAddon.Transacciones.CreacionFinal, Functions.FuncionesAddon.TipoLog.Recepcion)
                                                'Finally
                                                '    oDraft = Nothing
                                                'End Try
                                            End If
                                    ...
                                    Else ' SI ES UNA CANCELACION CAMBIO EL ESTADO EN EDOC A NO SINCRONIZADO
                                        ...
                                        If CREADAPORGSEDOC = "SI" Then
                                            ...
                                            ActualizadoEstadoUdoFacturaXML(idFacturaGS, "Cancelado")
    ...
    Public Function MarcarVisto(ByVal IdDocumento As Integer, ByVal TipoDocumento As Integer, ByRef mensaje As String, idDocumentoRecibido_UDO As String) As Boolean
        Try
            ...
            'ofrmDocumentoXMLsRecibidos.SetProtocolosdeSeguridad()
            If WS.MarcarVisto(_WS_RecepcionClave, IdDocumento, TipoDocumento, mensaje) Then
                ...
                Return True
            Else
                Utilitario.Util_Log.Escribir_Log("Error MarcarVisto : " + mensaje.ToString, "frmDocumentoXML")
            ...
            End If
        Catch ex As Exception
            Utilitario.Util_Log.Escribir_Log("Error MarcarVisto : " + ex.Message.ToString, "frmDocumentoXML")
            Return False
        End Try
    End Function
    ...
    Public Sub ConsutarPDFRecibido(ByVal IdDocumento As Integer, ByVal TipoDocumento As Integer)
        Try
            ...
            Dim nameFile = "01_" & ruc & "_" & año & mes & dia & "_" & numeracion
            Utilitario.Util_Log.Escribir_Log("Nombre archivo" & nameFile, "frmDocumentoXML")
            Dim filepath As String = Functions.VariablesGlobales._RutaProFC & nameFile & ".pdf"
            ...
            ElseIf Not File.Exists(filepath) Then
                ...
                rsboApp.StatusBar.SetText(NombreAddon + " -  No se encuentra PDF con clave : " + _ClaveAcceso.ToString + " verificar en la ruta: " + Functions.VariablesGlobales._RutaProFC.ToString, SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            End If
        Catch ex As Exception
    ...
    Public Sub GuardarArchivoFCRecibido(ByVal IdDocumento As Integer, ByVal TipoDocumento As Integer)
        ...
        Try
            ...
            If Not Directory.Exists(rutarl & "\" & "FACTURAS") Then
                ...
                Utilitario.Util_Log.Escribir_Log("Se creo exitosamente la carpeta " + rutarl & "\" & "FACTURAS".ToString, "frmDocumentoXML")
            End If
            ...
            If Not Directory.Exists(rutarl & "\" & "FACTURAS" & "\" & fechacarpeta) Then
                ...
                Utilitario.Util_Log.Escribir_Log("Se creo exitosamente la carpeta " + rutarl & "\" & "FACTURAS" & "\" & fechacarpeta, "frmDocumentoXML")
            End If
            ...
            If Not File.Exists(filepath) Then
                ...
                Else
                    ...
                    '    Utilitario.Util_Log.Escribir_Log("Se guardo exitosamente la ruta " + filepath, "frmDocumentoXML")
                    'Catch ex As Exception
                    '    Utilitario.Util_Log.Escribir_Log("Ocurrio un error al guardar la ruta " + ex.ToString, "frmDocumentoXML")
    ...
    Private Function CrearFacturaPreliminarRelacionada(ByRef sDocEntryPreliminar As String, ByVal DocEntryFVRecibida_UDO As String) As Boolean
        ...
        'Dim S As String = rsboApp.Forms.Item("frmDocumentoXML").DataSources.DataTables.Item("dtDocr").SerializeAsXML(SAPbouiCOM.BoDataTableXmlSelect.dxs_DataOnly)
        ...
        oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, "Creando Factura Preliminar de tipo: Relacionada", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
        rsboApp.StatusBar.SetText(NombreAddon + " - Creando Factura por favor espere..!", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Warning)

        Dim sRutaCarpeta As String = AppDomain.CurrentDomain.SetupInformation.ApplicationBase & "LOG\"
        Dim sRuta As String = sRutaCarpeta & _oDocumento.FacturaCabecera._DocEntry.ToString() + ".xml"
        If System.IO.Directory.Exists(sRutaCarpeta) Then
            ...
            x.Serialize(writer, _oDocumento)
            writer.Close()
        ...
        Try
            ...
            If Functions.VariablesGlobales._vgFechaEmisionFactura = "Y" Then
                GRPO.DocDate = _oDocumento.FacturaCabecera._fechaEmision
                GRPO.DocDueDate = _oDocumento.FacturaCabecera._fechaEmision
                GRPO.TaxDate = _oDocumento.FacturaCabecera._fechaEmision
            ...
            If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS Then
                GRPO.UserFields.Fields.Item("U_NUM_AUTOR").Value = _oDocumento.FacturaCabecera._NumeroAutorizacion
                GRPO.UserFields.Fields.Item("U_SER_EST").Value = _oDocumento.FacturaCabecera._estab
                GRPO.UserFields.Fields.Item("U_SER_PE").Value = _oDocumento.FacturaCabecera._ptoEmi

                GRPO.FolioNumber = _oDocumento.FacturaCabecera._secuencial
                GRPO.FolioPrefixString = Prefijo

                GRPO.NumAtCard = _oDocumento.FacturaCabecera._estab + _oDocumento.FacturaCabecera._ptoEmi + _oDocumento.FacturaCabecera._secuencial
                Try
                    GRPO.UserFields.Fields.Item("U_tipo_comprob").Value = "01"
                Catch ex As Exception
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_fecha_emi_doc_rel").Value = _oDocumento.FacturaCabecera._fechaEmision
                Catch ex As Exception
                End Try
                ' COMENTAR ESTA LINEA
                'GRPO.NumAtCard = _oDocumento.FacturaCabecera._estab + _oDocumento.FacturaCabecera._ptoEmi + _oDocumento.FacturaCabecera._secuencial
            ...
            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.ONESOLUTIONS Then
                GRPO.UserFields.Fields.Item("U_NO_AUTORI").Value = _oDocumento.FacturaCabecera._NumeroAutorizacion
                GRPO.NumAtCard = _oDocumento.FacturaCabecera._estab + _oDocumento.FacturaCabecera._ptoEmi + _oDocumento.FacturaCabecera._secuencial


            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.SYPSOFT Then
                GRPO.NumAtCard = _oDocumento.FacturaCabecera._estab + "-" + _oDocumento.FacturaCabecera._ptoEmi + "-" + _oDocumento.FacturaCabecera._secuencial
                GRPO.UserFields.Fields.Item("U_SYP_SERIESUC").Value = _oDocumento.FacturaCabecera._estab
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_MDSD").Value = _oDocumento.FacturaCabecera._ptoEmi
                Catch ex As Exception
                    GRPO.UserFields.Fields.Item("U_BPP_MDSD").Value = _oDocumento.FacturaCabecera._ptoEmi
                    Utilitario.Util_Log.Escribir_Log("Error2057frmDocumentoXML: " + ex.Message.ToString(), "recepcionSeidor")
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_MDCD").Value = _oDocumento.FacturaCabecera._secuencial
                Catch ex As Exception
                    GRPO.UserFields.Fields.Item("U_BPP_MDCD").Value = _oDocumento.FacturaCabecera._secuencial
                    Utilitario.Util_Log.Escribir_Log("Error2063frmDocumentoXML: " + ex.Message.ToString(), "recepcionSeidor")
                End Try

                GRPO.UserFields.Fields.Item("U_SYP_NROAUTO").Value = _oDocumento.FacturaCabecera._NumeroAutorizacion
                'CAMPOS USUARIOS PARA TOTALTEK
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_MDTD").Value = "01"
                Catch ex As Exception
                ...
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_FORMAP").Value = _oDocumento.FacturaCabecera._formaPago.ToString
                Catch ex As Exception
                ...
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_SERIESUCO").Value = _oDocumento.FacturaCabecera._estab
                Catch ex As Exception
                    Utilitario.Util_Log.Escribir_Log("U_SYP_SERIESUCO: " + ex.Message.ToString(), "recepcionSeidor")
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_MDSO").Value = _oDocumento.FacturaCabecera._ptoEmi
                Catch ex As Exception
                    Utilitario.Util_Log.Escribir_Log("U_SYP_MDSO: " + ex.Message.ToString(), "recepcionSeidor")
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_NDCO").Value = _oDocumento.FacturaCabecera._secuencial
                Catch ex As Exception
                    Utilitario.Util_Log.Escribir_Log("U_SYP_NDCO: " + ex.Message.ToString(), "recepcionSeidor")
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_NROAUTOO").Value = _oDocumento.FacturaCabecera._NumeroAutorizacion
                Catch ex As Exception
                    Utilitario.Util_Log.Escribir_Log("U_SYP_NROAUTOO: " + ex.Message.ToString(), "recepcionSeidor")
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_FECHAREF").Value = CDate(_oDocumento.FacturaCabecera._fechaEmision)
                Catch ex As Exception
            ...
            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.TOPMANAGE Then
                GRPO.UserFields.Fields.Item("U_TM_NAUT").Value = _oDocumento.FacturaCabecera._NumeroAutorizacion
                GRPO.UserFields.Fields.Item("U_TM_DATEA").Value = _oDocumento.FacturaCabecera._FechaAutorizacion
                GRPO.NumAtCard = _oDocumento.FacturaCabecera._estab.ToString + "-" + _oDocumento.FacturaCabecera._ptoEmi.ToString + "-" + _oDocumento.FacturaCabecera._secuencial.ToString

            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.HEINSOHN Then
                GRPO.UserFields.Fields.Item("U_HBT_AUT_FAC").Value = _oDocumento.FacturaCabecera._NumeroAutorizacion
                GRPO.UserFields.Fields.Item("U_HBT_SER_EST").Value = _oDocumento.FacturaCabecera._estab
                GRPO.UserFields.Fields.Item("U_HBT_PTO_EST").Value = _oDocumento.FacturaCabecera._ptoEmi
                GRPO.NumAtCard = _oDocumento.FacturaCabecera._secuencial.ToString
                GRPO.UserFields.Fields.Item("U_HBT_TIP_COMP").Value = "01"

                If _oDocumento.FacturaCabecera._formaPago = "" Then
                    GRPO.UserFields.Fields.Item("U_HBT_FP").Value = "20"
                ElseIf _oDocumento.FacturaCabecera._formaPago = Nothing Then
                    GRPO.UserFields.Fields.Item("U_HBT_FP").Value = "20"
                Else
                    GRPO.UserFields.Fields.Item("U_HBT_FP").Value = _oDocumento.FacturaCabecera._formaPago
                End If



            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.SOLSAP Then
                GRPO.UserFields.Fields.Item("U_SS_NumAut").Value = _oDocumento.FacturaCabecera._NumeroAutorizacion
                GRPO.UserFields.Fields.Item("U_SS_Est").Value = _oDocumento.FacturaCabecera._estab
                GRPO.UserFields.Fields.Item("U_SS_Pemi").Value = _oDocumento.FacturaCabecera._ptoEmi
                ...
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SS_FecEmiDocRel").Value = CDate(_oDocumento.FacturaCabecera._fechaEmision)
                Catch ex As Exception
                End Try
            End If
            'GRPO.UserFields.Fields.Item("U_SSCLAVE").Value = _oDocumento.FacturaCabecera._claveAcceso
            ...
            Dim dtRELACIONADO As SAPbouiCOM.DataTable = rsboApp.Forms.Item("frmDocumentoXML").DataSources.DataTables.Item("dtDocr") ' DATA TABLE DOCUMENTOS RELACIONADO
            ...
            Try
                ...
                End If
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("error al asignar CtlAccount: " + ex.Message.ToString(), "frmDocumentoXML")
            End Try
            ...
            Try
                If Not String.IsNullOrEmpty(_oDocumento.FacturaCabecera._formaPago) Then


                    If Functions.VariablesGlobales._FormaPagoCompras = "Y" And _oDocumento.FacturaCabecera._totalFormaPago > ValorFP Then
                        ...
                        Dim Total As Decimal = _oDocumento.FacturaCabecera._totalFormaPago
                ...
                End If
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("Error al generar Forma de Pago:" + ex.Message.ToString(), "frmDocumentoXML")
...
#Enable Warning BC42030 ' La variable 'ErrMsg' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
                ...
                oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, "Ocurrio Error al grabar Factura Preliminar de tipo: Relacionada:" + ErrCode.ToString + " - " + ErrMsg.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                Return False
            Else
                rCompany.GetNewObjectCode(sDocEntryPreliminar)
                oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, "Factura Preliminar de tipo: Relacionada, Creada Exitosamente: # " + sDocEntryPreliminar.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
        ...
        Catch ex As Exception
            Elimina_DocumentoRecibido_Factura(DocEntryFVRecibida_UDO)
            rsboApp.StatusBar.SetText(NombreAddon + " - Error:" + ex.Message.ToString(), SAPbouiCOM.BoMessageTime.bmt_Medium, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, "Ocurrio Error al grabar Factura Preliminar de tipo: Relacionada:" + ex.Message.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            Return False
        Finally
            GRPO = Nothing
            GC.Collect()
    ...
    Private Function CrearFacturaPremilinarServicio(ByVal sCardCode As String, ByVal ofactura As Factura, ByRef sDocEntryPreliminar As String, ByVal DocEntryFVRecibida_UDO As String) As Boolean
        ...
        oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, "Creando Factura Preliminar de tipo: Servicio", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
        rsboApp.StatusBar.SetText(NombreAddon + " - Creando Factura por favor espere..!", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Warning)
        'Create the Documents object
        Dim GRPO As SAPbobsCOM.Documents
        Dim RetVal As Long
        ...
        Try
            ...
            If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS Then
                ...
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_fecha_emi_doc_rel").Value = ofactura.FacturaCabecera._fechaEmision
                Catch ex As Exception
                End Try
            ...
            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.SYPSOFT Then
                ...
                Catch ex As Exception
                    GRPO.UserFields.Fields.Item("U_BPP_MDSD").Value = _oDocumento.FacturaCabecera._ptoEmi
                    Utilitario.Util_Log.Escribir_Log("Error2213frmDocumentoXML: " + ex.Message.ToString(), "recepcionSeidor")
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_MDCD").Value = _oDocumento.FacturaCabecera._secuencial
                Catch ex As Exception
                ...
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_FECHAREF").Value = _oDocumento.FacturaCabecera._fechaEmision
                Catch ex As Exception
                    Utilitario.Util_Log.Escribir_Log("U_SYP_FECHAREF: " + ex.Message.ToString(), "recepcionSeidor")
                End Try
            ...
            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.TOPMANAGE Then
                GRPO.UserFields.Fields.Item("U_TM_NAUT").Value = _oDocumento.FacturaCabecera._NumeroAutorizacion
                GRPO.UserFields.Fields.Item("U_TM_DATEA").Value = CDate(_oDocumento.FacturaCabecera._FechaAutorizacion)
                GRPO.NumAtCard = _oDocumento.FacturaCabecera._estab.ToString + "-" + _oDocumento.FacturaCabecera._ptoEmi.ToString + "-" + _oDocumento.FacturaCabecera._secuencial.ToString
            ...
            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.SOLSAP Then
                GRPO.UserFields.Fields.Item("U_SS_NumAut").Value = ofactura.FacturaCabecera._NumeroAutorizacion
                GRPO.UserFields.Fields.Item("U_SS_Est").Value = ofactura.FacturaCabecera._estab
                GRPO.UserFields.Fields.Item("U_SS_Pemi").Value = ofactura.FacturaCabecera._ptoEmi
            ...
            If FormatCode = "" Then
                ...
                oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, "ERROR - No existe parametrización de cuenta contable para factura de proveedor de servicio, vaya a la opcion de configurar por favor!", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                Return False
            End If
            If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
            ...
            If oCheckbox.Checked = True Then
                ...
                GRPO.Lines.LineTotal = formatDecimal(ofactura.FacturaCabecera._totalSinImpuestos)
...
#Enable Warning BC42024 ' Variable local sin usar: 'result'.
                For Each oDetalle As FacturaDetalle In ofactura.facturaDetalle
                    ...
                    Utilitario.Util_Log.Escribir_Log("Obteniendo TAXCODE - QUERY: " + sQueryCodImp + "Resultado :" + CodImp.ToString(), "frmDocumentoXML")
                    Utilitario.Util_Log.Escribir_Log("Obteniendo TAXCODE - QUERY: " + sQueryCodImpV + "Resultado :" + CodImpV.ToString(), "frmDocumentoXML")
                    GRPO.Lines.AccountCode = Cuenta
                    ...
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("ERROR: " + ex.ToString(), "frmDocumentoXML")
                    End Try

                    'GRPO.Lines.ItemDescription = "SERVICIO"
                    GRPO.Lines.ItemDescription = LTrim(RTrim(Left(oDetalle._descripcion.ToString, 100)))
                    GRPO.Lines.Quantity = 1
                    GRPO.Lines.Add()
                    line += 1
                Next
...
#Enable Warning BC42030 ' La variable 'ErrMsg' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
                rsboApp.MessageBox(ErrCode & " " & ErrMsg)
                oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, "Ocurrio Error al grabar Factura Preliminar de tipo: Servicio:" + ErrCode.ToString + " - " + ErrMsg.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                Return False
            Else
                rCompany.GetNewObjectCode(sDocEntryPreliminar)
                oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, "Factura Preliminar de tipo: Servicio, Creada Exitosamente: # " + sDocEntryPreliminar.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                Actualiza_DocumentoRecibido_Factura(DocEntryFVRecibida_UDO, sDocEntryPreliminar)
                Return True
            End If
        ...
        Catch ex As Exception
            Elimina_DocumentoRecibido_Factura(DocEntryFVRecibida_UDO)
            rsboApp.StatusBar.SetText(NombreAddon + " - Error:" + ex.Message.ToString(), SAPbouiCOM.BoMessageTime.bmt_Medium, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, "Ocurrio Error al grabar Factura Preliminar de tipo: Servicio:" + ex.Message.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            Return False
        Finally
            GRPO = Nothing
            GC.Collect()
    ...
    End Function
    Private Function CrearFacturaPreliminarMapeada(ByVal sCardCode As String, ByVal oFactura As Factura, ByRef sDocEntryPreliminar As String, ByVal DocEntryFVRecibida_UDO As String) As Boolean
        ...
        oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, "Creando Factura Preliminar de tipo: Mapeo de Items", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
        rsboApp.StatusBar.SetText(NombreAddon + " - Creando Factura por favor espere..!", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Warning)
...
#Enable Warning BC42024 ' Variable local sin usar: 'iTotalFrgChg_Line'.
        ...
        Try
            ...
            GRPO.Series = oSeries.Series
            GRPO.HandWritten = SAPbobsCOM.BoYesNoEnum.tNO
            GRPO.DocTotal = formatDecimal(oFactura.FacturaCabecera._importeTotal)
            ...
            For Each oDetalle As FacturaDetalle In oFactura.facturaDetalle
                ...
                sQueryCodImpV = " SELECT ""U_SSCOD"" FROM ""@GS_MAPEO_TC"" WHERE ""U_SSCOD"" = '" + oDetalle._impuestos(0)._codigoPorcentaje.ToString + "' "
                CodImpV = oFuncionesB1.getRSvalue(sQueryCodImpV, "U_SSCOD", "")
                Utilitario.Util_Log.Escribir_Log("Obteniendo TAXCODE - QUERY: " + sQueryCodImpV + "Resultado :" + CodImpV.ToString(), "frmDocumentoXML")

                'SELECT DfltWH FROM OITM WITH(NOLOCK) WHERE ItemCode
                If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                    itemCode = oFuncionesB1.getRSvalue("SELECT ""ItemCode"" FROM ""OSCN"" WHERE ""CardCode"" = '" + sCardCode + "' AND ""Substitute"" = '" + IIf(IsNothing(oDetalle._codigoPrincipal), Left(oDetalle._descripcion, 50), Left(oDetalle._codigoPrincipal, 50)) + "'", "ItemCode", "")
                Else
                    itemCode = oFuncionesB1.getRSvalue("SELECT ITemCode FROM OSCN WITH(NOLOCK) WHERE CardCode = '" + sCardCode + "' AND Substitute = '" + IIf(IsNothing(oDetalle._codigoPrincipal), Left(oDetalle._descripcion, 50), Left(oDetalle._codigoPrincipal, 50)) + "'", "ITemCode", "")
                End If
                If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                    itemName = oFuncionesB1.getRSvalue("SELECT ""U_ItemName"" FROM ""OSCN"" WHERE ""CardCode"" = '" + sCardCode + "' AND ""Substitute"" = '" + IIf(IsNothing(oDetalle._codigoPrincipal), oDetalle._descripcion, oDetalle._codigoPrincipal) + "'", "U_ItemName", "")
                Else
                    itemName = oFuncionesB1.getRSvalue("SELECT U_ItemName FROM OSCN WITH(NOLOCK) WHERE CardCode = '" + sCardCode + "' AND Substitute = '" + IIf(IsNothing(oDetalle._codigoPrincipal), oDetalle._descripcion, oDetalle._codigoPrincipal) + "'", "U_ItemName", "")
                End If


                Dim asdad = "SELECT ""ItemCode"" FROM ""OSCN"" WHERE ""CardCode"" = '" + sCardCode + "' AND ""Substitute"" = '" + IIf(IsNothing(oDetalle._codigoPrincipal), Left(oDetalle._descripcion, 50), Left(oDetalle._codigoPrincipal, 50)) + "'"
                Dim _asdad = oFuncionesB1.getRSvalue("SELECT ""ItemCode"" FROM ""OSCN"" WHERE ""CardCode"" = '" + sCardCode + "' AND ""Substitute"" = '" + IIf(IsNothing(oDetalle._codigoPrincipal), Left(oDetalle._descripcion, 50), Left(oDetalle._codigoPrincipal, 50)) + "'", "U_ItemName", "")
                Utilitario.Util_Log.Escribir_Log("1:", "frmDocumentoXML")

                GRPO.Lines.ItemCode = itemCode
                If Not itemName = "" Then
                    GRPO.Lines.ItemDescription = itemName
                End If
                GRPO.Lines.Quantity = formatDecimal(oDetalle._cantidad)

                Utilitario.Util_Log.Escribir_Log("2:", "frmDocumentoXML")
                ...
                Utilitario.Util_Log.Escribir_Log("3:", "frmDocumentoXML")
                ...
                GRPO.Lines.UnitPrice = formatDecimal(oDetalle._precioUnitario)
                Utilitario.Util_Log.Escribir_Log("UnitPrice:" + formatDecimal(oDetalle._precioUnitario).ToString, "frmDocumentoXML")
                If oDetalle._precioUnitario > 0 Then
                    PorDescuento = (CDec(oDetalle._descuento) * 100) / CDec(oDetalle._precioUnitario)
                    Utilitario.Util_Log.Escribir_Log("PorDescuento:" + PorDescuento.ToString, "frmDocumentoXML")
            ...
            'Dim ValorFP As Decimal = CDbl(Functions.VariablesGlobales._ValorFormaPagoCompras)
            Try
                If String.IsNullOrEmpty(_oDocumento.FacturaCabecera._formaPago) Then
...
#Enable Warning BC42030 ' La variable 'ErrMsg' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
                rsboApp.MessageBox(ErrCode & " " & ErrMsg)
                oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, "Ocurrio Error al grabar Factura Preliminar de tipo: Mapeo de Items:" + ErrCode.ToString + " - " + ErrMsg.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                Return False
            Else
                rCompany.GetNewObjectCode(sDocEntryPreliminar)
                oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, "Factura Preliminar de tipo: Mapeo de Items, Creada Exitosamente: # " + sDocEntryPreliminar.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                Actualiza_DocumentoRecibido_Factura(DocEntryFVRecibida_UDO, sDocEntryPreliminar)
                Return True
            End If
        ...
        Catch ex As Exception
            Elimina_DocumentoRecibido_Factura(DocEntryFVRecibida_UDO)
            rsboApp.StatusBar.SetText(NombreAddon + " - Error:" + ex.Message.ToString(), SAPbouiCOM.BoMessageTime.bmt_Medium, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, "Ocurrio Error al grabar Factura Preliminar de tipo: Mapeo de Items:" + ex.Message.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            Return False
        Finally
            GRPO = Nothing
            GC.Collect()
    ...
    Private Function CrearPedidoMapeado(ByVal sCardCode As String, ByVal oFactura As Factura, ByRef sDocEntryPedido As String) As Boolean

        '        Dim RetVal As Long
        '        Dim ErrCode As Long
        '        Dim ErrMsg As String
        '        oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, "Creando Pedido de Compra de tipo: Mapeo de Items", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
        ...
        '#Enable Warning BC42030 ' La variable 'ErrMsg' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
        '                rsboApp.MessageBox(ErrCode & " " & ErrMsg)
        '                oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, "Ocurrio Error al grabar el Pedido de Compra de tipo: Mapeo de Items:" + ErrCode.ToString + " - " + ErrMsg.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
        '                Return False
        '            Else
        '                oForm.Items.Item("chkPedido").Enabled = False
        '                oForm.Items.Item("btnPedi").Enabled = False
        ...
        '                oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, "Pedido de Compra de tipo: Mapeo de Items, Creada Exitosamente ", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
        ...
        '            ' Elimina_DocumentoRecibido_Factura(DocEntryFVRecibida_UDO)
        '            rsboApp.StatusBar.SetText(NombreAddon + " - Error:" + ex.Message.ToString(), SAPbouiCOM.BoMessageTime.bmt_Medium, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
        '            oFuncionesAddon.GuardaLOG("REE", _oDocumento.FacturaCabecera._claveAcceso, "Ocurrio Error al grabar el Pedido de Compra de tipo: Mapeo de Items:" + ex.Message.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
        '            Return False
        '        Finally
        '            GRPO = Nothing
        '            GC.Collect()
    ...
    Public Sub CargaDocumentoRelacionados()
        Try
            Dim oObjType As String = rsboApp.Forms.Item("frmDocumentoXML").Items.Item("objR").Specific.value
            Dim oDocEntrys As String = rsboApp.Forms.Item("frmDocumentoXML").Items.Item("docR").Specific.value
            ...
            End If
            Utilitario.Util_Log.Escribir_Log("Consulta Cabecera " & sQuery, "frmDocumentoXML")
            Try
                rsboApp.Forms.Item("frmDocumentoXML").DataSources.DataTables.Add("dtDocr") ' DATA TABLE, PARA DETALLE DE DOCUMENTOS RELACIONADOS
            Catch ex As Exception
            End Try
            Try
                rsboApp.Forms.Item("frmDocumentoXML").DataSources.DataTables.Add("dtDocRel") ' DATA TABLE, PARA RESUMEN DE LOS DOCUMENTOS RELACIONADOS
            Catch ex As Exception
            End Try

            Dim oGri As SAPbouiCOM.Grid = rsboApp.Forms.Item("frmDocumentoXML").Items.Item("oGridD").Specific
            rsboApp.Forms.Item("frmDocumentoXML").DataSources.DataTables.Item("dtDocr").ExecuteQuery(sQuery)
            oGri.DataTable = rsboApp.Forms.Item("frmDocumentoXML").DataSources.DataTables.Item("dtDocr")
            oGri.Item.Enabled = False
            If oObjType = 22 Then
                'oGri.Columns.Item(0).Visible = False
            ...
            End If
            Utilitario.Util_Log.Escribir_Log("Consulta Detalle " & sQueryResumen, "frmDocumentoXML")

            Dim dt As SAPbouiCOM.DataTable = rsboApp.Forms.Item("frmDocumentoXML").DataSources.DataTables.Item("dtDocRel")
    ...
    Public Function Guarda_DocumentoRecibido_Factura(ByRef DocEntryFacturaRecibida_UDO As String) As Boolean
        ...
        Try
            oFuncionesAddon.GuardaLOG("REE", _ClaveAcceso, "Creando registro de Factura Recibida UDO", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            ...
            oGeneralData.SetProperty("U_IdGS", _oDocumento.FacturaCabecera._DocEntry.ToString())
    ...
    Public Function ActualizadoEstadoSincronizadoEDOC_DocumentoRecibido_Factura(ByRef DocEntryFacturaRecibida_UDO As String, Sincronizado As Integer) As Boolean
        ...
        Try
            ...
            'sDocEntry = oGeneralParams.GetProperty("Code")
        Catch ex As Exception
            Utilitario.Util_Log.Escribir_Log("Error ActualizadoEstadoSincronizadoEDOC_DocumentoRecibido_Factura : " + ex.Message.ToString, "frmDocumentoXML")
    ...
    Public Function ActualizadoEstadoUdoFacturaXML(ByRef IdUdoFcXML As String, Sincronizado As String) As Boolean
...
#Region "Funciones Comentadas"
    ...
    '        Dim dtRECIBIDO As SAPbouiCOM.DataTable = rsboApp.Forms.Item("frmDocumentoXML").DataSources.DataTables.Item("dtDocs")    ' DATA TABLE DOCUMENTOS RECIBIDO
    '        Dim dtRELACIONADO As SAPbouiCOM.DataTable = rsboApp.Forms.Item("frmDocumentoXML").DataSources.DataTables.Item("dtDocr") ' DATA TABLE DOCUMENTOS RELACIONADO
    ...
    '        Try
    '            oUserTable.UserFields.Fields.Item("U_ObjTypeR").Value = rsboApp.Forms.Item("frmDocumentoXML").Items.Item("objR").Specific.value.ToString()
    '        Catch ex As Exception
    '        End Try
    '        Try
    '            oUserTable.UserFields.Fields.Item("U_DocEntryR").Value = rsboApp.Forms.Item("frmDocumentoXML").Items.Item("docR").Specific.value()
    '        Catch ex As Exception
    '        End Try
