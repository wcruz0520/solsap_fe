...
Public Class frmDocumentoNCXML
    ...
    Dim _oDocumento As NotaCredito
    ...
    Public Sub CargaFormularioDocumento(sRUC As String, sCardCode As String, sNombre As String, oDocumento As NotaCredito, ofila As Integer)
        Dim xmlDoc As New Xml.XmlDocument
        Dim strPath As String
        If RecorreFormulario(rsboApp, "frmDocumentoNCXML") Then
            Exit Sub
        End If
        oCardCode = sCardCode
        _fila = ofila
        _sRUC = sRUC
        strPath = System.Windows.Forms.Application.StartupPath & "\frmDocumentoNCXML.srf"
        xmlDoc.Load(strPath)
        Try
            Try
                rsboApp.LoadBatchActions(xmlDoc.InnerXml)
                _oDocumento = oDocumento
                _ClaveAcceso = oDocumento.NotaCreditoCabecera._claveAcceso
            Catch exx As Exception
                rsboApp.Forms.Item("frmDocumentoNCXML").Close()
                xmlDoc = Nothing
                Exit Sub
            End Try

            oForm = rsboApp.Forms.Item("frmDocumentoNCXML")
            ...
            _IdGS = _oDocumento.NotaCreditoCabecera._DocEntry
            ...
            txtClaAcc.Value = _oDocumento.NotaCreditoCabecera._claveAcceso
            ...
            txtNumAut.Value = _oDocumento.NotaCreditoCabecera._NumeroAutorizacion
            ...
            txtFecAut.Value = _oDocumento.NotaCreditoCabecera._FechaAutorizacion
            ...
            txtNumDoc.Value = oDocumento.NotaCreditoCabecera._estab + "-" + oDocumento.NotaCreditoCabecera._ptoEmi + "-" + oDocumento.NotaCreditoCabecera._secuencial
            ...
            oForm.DataSources.DataTables.Item("dtDocs").Rows.Add(oDocumento.NotaCreditoDetalle.Count)
            Dim i As Integer = 0

            For Each odetalle As NotaCreditoDetalle In oDocumento.NotaCreditoDetalle

                oForm.DataSources.DataTables.Item("dtDocs").SetValue("CodPrin", i, IIf(IsNothing(odetalle._codigoInterno), odetalle._descripcion, odetalle._codigoInterno))
                oForm.DataSources.DataTables.Item("dtDocs").SetValue("CodAuxi", i, IIf(IsNothing(odetalle._codigoAdicional), "", odetalle._codigoAdicional)) '
                If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                    oForm.DataSources.DataTables.Item("dtDocs").SetValue("CodSAP", i, oFuncionesB1.getRSvalue("SELECT ""ItemCode"" FROM ""OSCN"" WHERE ""CardCode"" = '" + sCardCode + "' AND ""Substitute"" = '" + Left(odetalle._codigoInterno, 50) + "'", "ItemCode", ""))
                Else
                    oForm.DataSources.DataTables.Item("dtDocs").SetValue("CodSAP", i, oFuncionesB1.getRSvalue("SELECT ItemCode FROM OSCN WHERE CardCode = '" + sCardCode + "' AND Substitute = '" + Left(odetalle._codigoInterno, 50) + "'", "ItemCode", ""))
                End If

                'oForm.DataSources.DataTables.Item("dtDocs").SetValue("Descripc", i, IIf(IIf(IsNothing(odetalle._descripcion), "", odetalle._descripcion).ToString().Length > 250, odetalle._descripcion.Substring(1, 249), IIf(IsNothing(odetalle._descripcion), "", odetalle._descripcion)))
                ...
                If PendienteMapear = False Then
                    If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                        CodigoArticulo = oFuncionesB1.getRSvalue("SELECT ""ItemCode"" FROM ""OSCN"" WHERE ""CardCode"" ='" + sCardCode + "' AND ""Substitute""  = '" + odetalle._codigoInterno + "'", "ItemCode", "")
                    Else
                        CodigoArticulo = oFuncionesB1.getRSvalue("SELECT ItemCode FROM OSCN WITH(NOLOCK) WHERE CardCode ='" + sCardCode + "' AND Substitute  = '" + odetalle._codigoInterno + "'", "ItemCode", "")
                    End If
            ...
            For Each facImpuesto As NotaCreditoCabeceraImpuesto In _oDocumento.NotaCreditoCabecera._impuestos
            ...
            txtSubS.Value = formatDecimal(Math.Round(oDocumento.NotaCreditoCabecera._totalSinImpuestos, 2).ToString())
            ...
            txDes.Value = formatDecimal(Math.Round(oDocumento.NotaCreditoCabecera._totalDescuento, 2).ToString())
            ...
            txtTotal.Value = formatDecimal(Math.Round(oDocumento.NotaCreditoCabecera._valorModificacion, 2).ToString())
    ...
    Public Sub CargaFormularioDocumentoExistente(IdDocumentoRecibido_UDO As String, Estado As String)
        ...
        Try
            ...
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("Error: " + ex.Message.ToString() + " - Query: " + QueryCabecera, "frmDocumentoNCXML")
            End Try
            ...
            For i = 0 To odt.Rows.Count - 1
                ...
                Dim txtNumDoc As SAPbouiCOM.EditText
                txtNumDoc = oForm.Items.Item("txtNumDoc").Specific
                txtNumDoc.Value = odt.GetValue("U_NumDoc", i).ToString() 'oDocumento.NotaCreditoCabecera._estab + "-" + oDocumento.NotaCreditoCabecera._ptoEmi + "-" + oDocumento.NotaCreditoCabecera._secuencial
                ...
                txtDTot = rsboApp.Forms.Item("frmDocumentoNCXML").Items.Item("txtDTot").Specific
                ...
                txtDP = rsboApp.Forms.Item("frmDocumentoNCXML").Items.Item("txtDP").Specific
                ...
                txtDVP = rsboApp.Forms.Item("frmDocumentoNCXML").Items.Item("txtDVP").Specific
                ...
                txtDG = rsboApp.Forms.Item("frmDocumentoNCXML").Items.Item("txtDG").Specific
                ...
                txtDI = rsboApp.Forms.Item("frmDocumentoNCXML").Items.Item("txtDI").Specific
                ...
                txtDT = rsboApp.Forms.Item("frmDocumentoNCXML").Items.Item("txtDT").Specific
            ...
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("Error: " + ex.Message.ToString() + " - Query: " + QueryDetalle, "frmDocumentoNCXML")
            End Try
            ...
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("Error: " + ex.Message.ToString() + " - Query: " + QueryDetalleRelacionados, "frmDocumentoNCXML")
            End Try
...
#Enable Warning BC42030 ' La variable 'idForm' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
            If typeEx = "frmDocumentoNCXML" Then
                        ...
                        If pVal.Before_Action Then
                            Select Case pVal.ItemUID
                                ...
                                Case "btnMapear"
                                    ...
                                    Dim sClaveAcceso As String = _oDocumento.NotaCreditoCabecera._claveAcceso
                                    Dim sNombre As String = _oDocumento.NotaCreditoCabecera._RazonSocial

                                    listaDetalleArtiulos.Clear()
                                    For Each oDetalle As NotaCreditoDetalle In _oDocumento.NotaCreditoDetalle
                                        listaDetalleArtiulos.Add(New Entidades.DetalleArticulo(sClaveAcceso, oDetalle._codigoInterno,
                                                                                               oDetalle._codigoAdicional, oDetalle._descripcion, oDetalle._cantidad, oDetalle._precioUnitario, oDetalle._descuento, oDetalle._precioTotalSinImpuesto))
                                    Next
                                    ofrmMapeo.CargaFormularioMapeo(_oDocumento.NotaCreditoCabecera._ruc, oCardCode, sNombre, listaDetalleArtiulos, _fila, "NC")
                                ...
                                Case "obtnGrabar"
                                    ...
                                    If Exitoso = True Then
                                        ...
                                        oFuncionesAddon.GuardaLOG("NCR", _oDocumento.NotaCreditoCabecera._claveAcceso, " Proceso terminado Exitosamente!", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                                ...
                                Case True
                                    ...
                                    If Not oDocumentoSAP.CancelStatus = SAPbobsCOM.CancelStatusEnum.csCancellation Then
                                        If Not oDocumentoSAP.DocObjectCode = SAPbobsCOM.BoObjectTypes.oDrafts Then
                                            ...
                                            If CREADAPORGSEDOC = "SI" Then
                                                ...
                                                ActualizadoEstadoUdoNotaCreditoXML(idFacturaGS, "Contabilizado")
                                                ...
                                                'oFuncionesAddon.GuardaLOG("REE", _oDocumento.NotaCreditoCabecera._claveAcceso, " Obteniendo Documento Preliminar # " + DocEntryPreliminar.ToString() + ", para cerrarlo", Functions.FuncionesAddon.Transacciones.CreacionFinal, Functions.FuncionesAddon.TipoLog.Recepcion)
                                                ...
                                                '            oFuncionesAddon.GuardaLOG("REE", _oDocumento.NotaCreditoCabecera._claveAcceso, " Error al Cerrar Documento Preliminar # " + DocEntryPreliminar.ToString() + ", " + ErrCode.ToString() + " - " + ErrMsg.ToString(), Functions.FuncionesAddon.Transacciones.CreacionFinal, Functions.FuncionesAddon.TipoLog.Recepcion)
                                                '        Else
                                                '            oFuncionesAddon.GuardaLOG("REE", _oDocumento.NotaCreditoCabecera._claveAcceso, " Documento Preliminar # " + DocEntryPreliminar.ToString() + ", cerrado Satisfactoriamente!!", Functions.FuncionesAddon.Transacciones.CreacionFinal, Functions.FuncionesAddon.TipoLog.Recepcion)
                                                '        End If
                                                '    End If
                                                'Catch ex As Exception
                                                ...
                                                '    oFuncionesAddon.GuardaLOG("REE", _oDocumento.NotaCreditoCabecera._claveAcceso, " Error al Cerrar Documento Preliminar # " + DocEntryPreliminar.ToString() + ": " + ex.Message.ToString(), Functions.FuncionesAddon.Transacciones.CreacionFinal, Functions.FuncionesAddon.TipoLog.Recepcion)
                                                'Finally
                                                '    oDraft = Nothing
                                                'End Try
                                    ...
                                    Else ' SI ES UNA CANCELACION CAMBIO EL ESTADO EN EDOC A NO SINCRONIZADO
                                        ...
                                        If CREADAPORGSEDOC = "SI" Then
                                            ...
                                            ActualizadoEstadoUdoNotaCreditoXML(idFacturaGS, "Cancelado")
    ...
    Public Function MarcarVisto(ByVal IdDocumento As Integer, ByVal TipoDocumento As Integer, ByRef mensaje As String, idDocumentoRecibido_UDO As String) As Boolean
        Try
            ...
            End If
        Catch ex As Exception
            Utilitario.Util_Log.Escribir_Log("Error MarcarVisto : " + ex.Message.ToString, "frmDocumentoNCXML")
            Return False
        End Try
    End Function
    ...
    Public Sub ConsutarPDFRecibido(ByVal IdDocumento As Integer, ByVal TipoDocumento As Integer)
        Try
            ...
            Dim nameFile = "04_" & ruc & "_" & año & mes & dia & "_" & numeracion
            Utilitario.Util_Log.Escribir_Log("Nombre archivo" & nameFile, "frmDocumentoNCXML")

            Dim filepath As String = Functions.VariablesGlobales._RutaProNC & nameFile & ".pdf"
...
#Enable Warning BC42104 ' La variable 'oUserTable' se usa antes de que se le haya asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
    ...
    Private Function CrearNCPreliminarRelacionada(ByRef sDocEntryPreliminar As String, ByVal DocEntryNERecibida_UDO As String) As Boolean
        ...
        Dim ErrCode As Long
        Dim ErrMsg As String
        oFuncionesAddon.GuardaLOG("NCR", _oDocumento.NotaCreditoCabecera._claveAcceso, "Creando Nota de Crédito Preliminar de tipo: Relacionada", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
        ...
        Try
            ...
            'GRPO.DocDate = _oDocumento.NotaCreditoCabecera._fechaEmision
            If Functions.VariablesGlobales._vgFechaEmisionNotaCredito = "Y" Then
                GRPO.DocDate = _oDocumento.NotaCreditoCabecera._fechaEmision
                GRPO.DocDueDate = _oDocumento.NotaCreditoCabecera._fechaEmision
                GRPO.TaxDate = _oDocumento.NotaCreditoCabecera._fechaEmision
            ...
            If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS Then
                GRPO.UserFields.Fields.Item("U_NUM_AUTOR").Value = _oDocumento.NotaCreditoCabecera._NumeroAutorizacion
                GRPO.UserFields.Fields.Item("U_SER_EST").Value = _oDocumento.NotaCreditoCabecera._estab
                GRPO.UserFields.Fields.Item("U_SER_PE").Value = _oDocumento.NotaCreditoCabecera._ptoEmi

                GRPO.FolioNumber = _oDocumento.NotaCreditoCabecera._secuencial
                GRPO.FolioPrefixString = Prefijo
                Try
                    GRPO.UserFields.Fields.Item("U_fecha_emi_doc_rel").Value = _oDocumento.NotaCreditoCabecera._fechaEmision
                Catch ex As Exception
                End Try

            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.ONESOLUTIONS Then
                GRPO.UserFields.Fields.Item("U_NO_AUTORI").Value = _oDocumento.NotaCreditoCabecera._NumeroAutorizacion
                GRPO.NumAtCard = _oDocumento.NotaCreditoCabecera._estab + _oDocumento.NotaCreditoCabecera._ptoEmi + _oDocumento.NotaCreditoCabecera._secuencial

            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.SYPSOFT Then
                GRPO.NumAtCard = _oDocumento.NotaCreditoCabecera._estab + "-" + _oDocumento.NotaCreditoCabecera._ptoEmi + "-" + _oDocumento.NotaCreditoCabecera._secuencial
                GRPO.UserFields.Fields.Item("U_SYP_SERIESUC").Value = _oDocumento.NotaCreditoCabecera._estab
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_MDSD").Value = _oDocumento.NotaCreditoCabecera._ptoEmi
                Catch ex As Exception
                    GRPO.UserFields.Fields.Item("U_BPP_MDSD").Value = _oDocumento.NotaCreditoCabecera._ptoEmi
                End Try
                'Try
                '    GRPO.UserFields.Fields.Item("U_SYP_MDSD").Value = oDocumento.NotaCreditoCabecera._ptoEmi
                'Catch ex As Exception
                '    GRPO.UserFields.Fields.Item("U_BPP_MDSD").Value = oDocumento.NotaCreditoCabecera._ptoEmi
                'End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_MDCD").Value = _oDocumento.NotaCreditoCabecera._secuencial
                Catch ex As Exception
                    GRPO.UserFields.Fields.Item("U_BPP_MDCD").Value = _oDocumento.NotaCreditoCabecera._secuencial
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_NROAUTO").Value = _oDocumento.NotaCreditoCabecera._NumeroAutorizacion
                Catch ex As Exception
                    GRPO.UserFields.Fields.Item("U_SYP_NroAuto").Value = _oDocumento.NotaCreditoCabecera._NumeroAutorizacion
                End Try
                ...
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_SERIESUCO").Value = _oDocumento.NotaCreditoCabecera._estab
                Catch ex As Exception
                    Utilitario.Util_Log.Escribir_Log("U_SYP_SERIESUCO: " + ex.Message.ToString(), "recepcionSeidor")
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_MDSO").Value = _oDocumento.NotaCreditoCabecera._ptoEmi
                Catch ex As Exception
                    Utilitario.Util_Log.Escribir_Log("U_SYP_MDSO: " + ex.Message.ToString(), "recepcionSeidor")
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_NDCO").Value = _oDocumento.NotaCreditoCabecera._secuencial
                Catch ex As Exception
                    Utilitario.Util_Log.Escribir_Log("U_SYP_NDCO: " + ex.Message.ToString(), "recepcionSeidor")
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_NROAUTOO").Value = _oDocumento.NotaCreditoCabecera._NumeroAutorizacion
                Catch ex As Exception
                    Utilitario.Util_Log.Escribir_Log("U_SYP_NROAUTOO: " + ex.Message.ToString(), "recepcionSeidor")
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SYP_FECHAREF").Value = _oDocumento.NotaCreditoCabecera._fechaEmision
                Catch ex As Exception
            ...
            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.TOPMANAGE Then
                GRPO.UserFields.Fields.Item("U_TM_NAUT").Value = _oDocumento.NotaCreditoCabecera._NumeroAutorizacion
                GRPO.UserFields.Fields.Item("U_TM_DATEA").Value = _oDocumento.NotaCreditoCabecera._FechaAutorizacion
                GRPO.NumAtCard = _oDocumento.NotaCreditoCabecera._estab.ToString + "-" + _oDocumento.NotaCreditoCabecera._ptoEmi.ToString + "-" + _oDocumento.NotaCreditoCabecera._secuencial.ToString

            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.HEINSOHN Then
                GRPO.UserFields.Fields.Item("U_HBT_AUT_FAC").Value = _oDocumento.NotaCreditoCabecera._NumeroAutorizacion
                GRPO.UserFields.Fields.Item("U_HBT_SER_EST").Value = _oDocumento.NotaCreditoCabecera._estab
                GRPO.UserFields.Fields.Item("U_HBT_PTO_EST").Value = _oDocumento.NotaCreditoCabecera._ptoEmi
                GRPO.NumAtCard = _oDocumento.NotaCreditoCabecera._secuencial.ToString

                GRPO.UserFields.Fields.Item("U_HBT_TIDOMO").Value = "01"
                GRPO.UserFields.Fields.Item("U_HBT_EST_MOD").Value = _oDocumento.NotaCreditoCabecera._numDocModificado.ToString.Substring(0, 3)
                GRPO.UserFields.Fields.Item("U_HBT_PUFAMO").Value = _oDocumento.NotaCreditoCabecera._numDocModificado.ToString.Substring(4, 3)
                GRPO.UserFields.Fields.Item("U_HBT_NUFAMO").Value = Right(_oDocumento.NotaCreditoCabecera._numDocModificado.ToString, 9)
                GRPO.UserFields.Fields.Item("U_HBT_FEDOMO").Value = _oDocumento.NotaCreditoCabecera._fechaEmisionDocSustento

            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.SOLSAP Then
                GRPO.UserFields.Fields.Item("U_SS_NumAut").Value = _oDocumento.NotaCreditoCabecera._NumeroAutorizacion
                GRPO.UserFields.Fields.Item("U_SS_Est").Value = _oDocumento.NotaCreditoCabecera._estab
                GRPO.UserFields.Fields.Item("U_SS_Pemi").Value = _oDocumento.NotaCreditoCabecera._ptoEmi
                ...
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SS_FecEmiDocRel").Value = _oDocumento.NotaCreditoCabecera._fechaEmision
                Catch ex As Exception
                End Try

            End If

            'GRPO.UserFields.Fields.Item("U_SSCLAVE").Value = _oDocumento.NotaCreditoCabecera._claveAcceso
            ...
            Dim dtRELACIONADO As SAPbouiCOM.DataTable = rsboApp.Forms.Item("frmDocumentoNCXML").DataSources.DataTables.Item("dtDocr") ' DATA TABLE DOCUMENTOS RELACIONADO
            ...
            '        Dim oDocEntrys As String = rsboApp.Forms.Item("frmDocumentoNCXML").Items.Item("docR").Specific.value
            '        If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
            ...
            '        rsboApp.Forms.Item("frmDocumentoNCXML").DataSources.DataTables.Add("dtDocRelRet")
            '        Utilitario.Util_Log.Escribir_Log("Consulta Detalle Retencion " & sQueryRet, "frmDocumentoNCXML")
            '        Dim dtRet As SAPbouiCOM.DataTable = rsboApp.Forms.Item("frmDocumentoNCXML").DataSources.DataTables.Item("dtDocRelRet")
...
#Enable Warning BC42030 ' La variable 'ErrMsg' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
                ...
                oFuncionesAddon.GuardaLOG("NCR", _oDocumento.NotaCreditoCabecera._claveAcceso, "Ocurrio Error al grabar Nota de Crédito Preliminar de tipo: Relacionada:" + ErrCode.ToString + " - " + ErrMsg.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                Return False
            Else
                rCompany.GetNewObjectCode(sDocEntryPreliminar)
                oFuncionesAddon.GuardaLOG("REE", _oDocumento.NotaCreditoCabecera._claveAcceso, "Factura Preliminar de tipo: Relacionada, Creada Exitosamente: # " + sDocEntryPreliminar.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
        ...
        Catch ex As Exception
            ...
            oFuncionesAddon.GuardaLOG("NCR", _oDocumento.NotaCreditoCabecera._claveAcceso, "Ocurrio Error al grabar Factura Preliminar de tipo: Relacionada:" + ex.Message.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            Return False
        Finally
            GRPO = Nothing
            GC.Collect()
    ...
    End Function
    Private Function CrearNCPremilinarServicio(ByVal sCardCode As String, ByVal oNC As NotaCredito, ByRef sDocEntryPreliminar As String, ByVal DocEntryNCRecibida_UDO As String) As Boolean
        ...
        Dim sRuta As String = sRutaCarpeta & oNC.NotaCreditoCabecera._secuencial.ToString() + ".xml"

        If System.IO.Directory.Exists(sRutaCarpeta) Then
            Utilitario.Util_Log.Escribir_Log("Serializando...", "ManejoDeDocumentos")

            Dim x As XmlSerializer = New XmlSerializer(GetType(NotaCredito))
            Dim writer As TextWriter = New StreamWriter(sRuta)
            x.Serialize(writer, oNC)
            writer.Close()
        ...
        Try
            oFuncionesAddon.GuardaLOG("NCR", _oDocumento.NotaCreditoCabecera._claveAcceso, "Creando Nota de Crédito de tipo: Servicio", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            rsboApp.StatusBar.SetText(NombreAddon + " - Creando Nota de Crédito por favor espere..!", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Warning)
            Utilitario.Util_Log.Escribir_Log("1", "NCXML")
            GRPO = rCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oDrafts)
            GRPO.DocObjectCode = SAPbobsCOM.BoObjectTypes.oPurchaseCreditNotes
            GRPO.CardCode = sCardCode
            'GRPO.DocDate = oNC.NotaCreditoCabecera._fechaEmision
            '
            If Functions.VariablesGlobales._vgFechaEmisionNotaCredito = "Y" Then
                GRPO.DocDate = oNC.NotaCreditoCabecera._fechaEmision
                GRPO.DocDueDate = oNC.NotaCreditoCabecera._fechaEmision
                GRPO.TaxDate = oNC.NotaCreditoCabecera._fechaEmision
            ElseIf Functions.VariablesGlobales._vgFechaEmisionNotaCreditoP = "Y" Then
                GRPO.DocDate = oNC.NotaCreditoCabecera._fechaEmision
            Else
                GRPO.DocDate = Today.Date
            ...
            Utilitario.Util_Log.Escribir_Log("2", "NCXML")
            ' DATOS DE AUTORIZACION
            Dim Prefijo As String = Functions.VariablesGlobales._Prefijo_NC
            If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS Then

                Dim est = oNC.NotaCreditoCabecera._numDocModificado.ToString.Substring(0, 3)
                Dim pto = oNC.NotaCreditoCabecera._numDocModificado.ToString.Substring(4, 3)
                Dim sec = Right(oNC.NotaCreditoCabecera._numDocModificado.ToString, 9)

                GRPO.UserFields.Fields.Item("U_NUM_AUTOR").Value = oNC.NotaCreditoCabecera._NumeroAutorizacion
                GRPO.UserFields.Fields.Item("U_SER_EST").Value = oNC.NotaCreditoCabecera._estab
                GRPO.UserFields.Fields.Item("U_SER_PE").Value = oNC.NotaCreditoCabecera._ptoEmi

                GRPO.FolioNumber = oNC.NotaCreditoCabecera._secuencial
                GRPO.FolioPrefixString = Prefijo
                Try
                    GRPO.UserFields.Fields.Item("U_fecha_emi_doc_rel").Value = _oDocumento.NotaCreditoCabecera._fechaEmision
                Catch ex As Exception
            ...
            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.ONESOLUTIONS Then
                GRPO.UserFields.Fields.Item("U_NO_AUTORI").Value = oNC.NotaCreditoCabecera._NumeroAutorizacion
                GRPO.NumAtCard = oNC.NotaCreditoCabecera._estab + oNC.NotaCreditoCabecera._ptoEmi + oNC.NotaCreditoCabecera._secuencial
            ...
            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.HEINSOHN Then
                ...
                Utilitario.Util_Log.Escribir_Log("3", "NCXML")

                GRPO.UserFields.Fields.Item("U_HBT_AUT_FAC").Value = oNC.NotaCreditoCabecera._NumeroAutorizacion
                GRPO.UserFields.Fields.Item("U_HBT_SER_EST").Value = oNC.NotaCreditoCabecera._estab
                GRPO.UserFields.Fields.Item("U_HBT_PTO_EST").Value = oNC.NotaCreditoCabecera._ptoEmi
                GRPO.NumAtCard = oNC.NotaCreditoCabecera._secuencial.ToString

                GRPO.UserFields.Fields.Item("U_HBT_TIDOMO").Value = "01"
                GRPO.UserFields.Fields.Item("U_HBT_EST_MOD").Value = oNC.NotaCreditoCabecera._numDocModificado.ToString.Substring(0, 3)
                GRPO.UserFields.Fields.Item("U_HBT_PUFAMO").Value = oNC.NotaCreditoCabecera._numDocModificado.ToString.Substring(4, 3)
                GRPO.UserFields.Fields.Item("U_HBT_NUFAMO").Value = Right(oNC.NotaCreditoCabecera._numDocModificado.ToString, 9)
                GRPO.UserFields.Fields.Item("U_HBT_FEDOMO").Value = CDate(oNC.NotaCreditoCabecera._fechaEmisionDocSustento)

                Utilitario.Util_Log.Escribir_Log("4", "NCXML")
            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.SOLSAP Then
                GRPO.UserFields.Fields.Item("U_SS_NumAut").Value = oNC.NotaCreditoCabecera._NumeroAutorizacion
                GRPO.UserFields.Fields.Item("U_SS_Est").Value = oNC.NotaCreditoCabecera._estab
                GRPO.UserFields.Fields.Item("U_SS_Pemi").Value = oNC.NotaCreditoCabecera._ptoEmi
                ...
                End Try
                Try
                    GRPO.UserFields.Fields.Item("U_SS_FecEmiDocRel").Value = oNC.NotaCreditoCabecera._fechaEmision
                Catch ex As Exception
                End Try
            End If
            'Dim pe As String = _oDocumento.NotaCreditoCabecera._numDocModificado.ToString.Substring(0, 3)
            'Dim es As String = _oDocumento.NotaCreditoCabecera._numDocModificado.ToString.Substring(4, 3)
            'Dim s As String = Right(_oDocumento.NotaCreditoCabecera._numDocModificado.ToString, 9)
            'U_EREC_CREADO 
            ...
            Utilitario.Util_Log.Escribir_Log("5", "NCXML")
            ...
            End If
            Utilitario.Util_Log.Escribir_Log("6", "NCXML")
            ...
            Utilitario.Util_Log.Escribir_Log("7", "NCXML")

            For Each oDetalle As NotaCreditoDetalle In oNC.NotaCreditoDetalle
                sQueryCodImp = " SELECT ""U_SSID"" FROM ""@GS_MAPEO_TC"" WHERE ""U_SSCOD"" = '" + oNC.NotaCreditoCabecera._impuestos(0)._codigoPorcentaje.ToString + "' "
                CodImp = oFuncionesB1.getRSvalue(sQueryCodImp, "U_SSID", "")
                Utilitario.Util_Log.Escribir_Log("Obteniendo TAXCODE - QUERY: " + sQueryCodImp + "Resultado :" + CodImp.ToString(), "frmDocumentoNCXML")

                sQueryCodImpV = " SELECT ""U_SSCOD"" FROM ""@GS_MAPEO_TC"" WHERE ""U_SSCOD"" = '" + oNC.NotaCreditoCabecera._impuestos(0)._codigoPorcentaje.ToString + "' "
                CodImpV = oFuncionesB1.getRSvalue(sQueryCodImpV, "U_SSCOD", "")
                Utilitario.Util_Log.Escribir_Log("Obteniendo TAXCODE - QUERY: " + sQueryCodImpV + "Resultado :" + CodImpV.ToString(), "frmDocumentoNCXML")

                GRPO.Lines.AccountCode = Cuenta
                GRPO.Lines.LineTotal = formatDecimal(oDetalle._precioUnitario)
                If CodImpV = oNC.NotaCreditoCabecera._impuestos(0)._codigoPorcentaje.ToString Then
                    GRPO.Lines.TaxCode = CodImp.ToString
                End If
                GRPO.Lines.ItemDescription = "SERVICIO"
                GRPO.Lines.Quantity = 1
                GRPO.Lines.DiscountPercent = formatDecimal(oDetalle._descuento) / 100
                GRPO.Lines.Add()
                line += 1
            Next
...
#Enable Warning BC42030 ' La variable 'ErrMsg' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
                rsboApp.MessageBox(ErrCode & " " & ErrMsg)
                oFuncionesAddon.GuardaLOG("NCR", _oDocumento.NotaCreditoCabecera._claveAcceso, "Ocurrio Error al grabar Nota de Crédito Preliminar de tipo: Servicio:" + ErrCode.ToString + " - " + ErrMsg.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                Return False
            Else
                rCompany.GetNewObjectCode(sDocEntryPreliminar)
                oFuncionesAddon.GuardaLOG("NCR", _oDocumento.NotaCreditoCabecera._claveAcceso, "Nota de Crédito Preliminar de tipo: Servicio, Creada Exitosamente: # " + sDocEntryPreliminar.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
    ...
    End Function
    Private Function CrearNCPreliminarMapeada(ByVal sCardCode As String, ByVal oNC As NotaCredito, ByRef sDocEntryPreliminar As String, ByVal DocEntryNCRecibida_UDO As String) As Boolean

        Dim RetVal As Long
        Dim ErrCode As Long
        Dim ErrMsg As String
        oFuncionesAddon.GuardaLOG("NCR", _oDocumento.NotaCreditoCabecera._claveAcceso, "Creando Nota de Crédito Preliminar de tipo: Mapeo de Items", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
        rsboApp.StatusBar.SetText(NombreAddon + " - Creando Nota de Crédito por favor espere..!", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Warning)
...
#Enable Warning BC42024 ' Variable local sin usar: 'iTotalFrgChg_Line'.
        ...
        Try
            ...
            GRPO.DocTotal = formatDecimal(oNC.NotaCreditoCabecera._valorModificacion)
            ...
            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.HEINSOHN Then
                ...
                GRPO.UserFields.Fields.Item("U_HBT_PUFAMO").Value = oNC.NotaCreditoCabecera._numDocModificado.ToString.Substring(4, 3)
                GRPO.UserFields.Fields.Item("U_HBT_NUFAMO").Value = Right(oNC.NotaCreditoCabecera._numDocModificado.ToString, 9)
                GRPO.UserFields.Fields.Item("U_HBT_FEDOMO").Value = oNC.NotaCreditoCabecera._fechaEmisionDocSustento
            ...
            For Each oDetalle As NotaCreditoDetalle In oNC.NotaCreditoDetalle
                ...
                If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                    itemCode = oFuncionesB1.getRSvalue("SELECT ""ItemCode"" FROM ""OSCN"" WHERE ""CardCode"" = '" + sCardCode + "' AND ""Substitute"" = '" + Left(oDetalle._codigoInterno, 50) + "'", "ItemCode", "")
                Else
                    itemCode = oFuncionesB1.getRSvalue("SELECT ItemCode FROM OSCN WITH(NOLOCK) WHERE CardCode = '" + sCardCode + "' AND Substitute = '" + Left(oDetalle._codigoInterno, 50) + "'", "ITemCode", "")
                End If
...
#Enable Warning BC42030 ' La variable 'ErrMsg' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
                rsboApp.MessageBox(ErrCode & " " & ErrMsg)
                oFuncionesAddon.GuardaLOG("NCR", _oDocumento.NotaCreditoCabecera._claveAcceso, "Ocurrio Error al grabar Nota de Crédito Preliminar de tipo: Mapeo de Items:" + ErrCode.ToString + " - " + ErrMsg.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                Return False
            Else
                rCompany.GetNewObjectCode(sDocEntryPreliminar)
                oFuncionesAddon.GuardaLOG("NCR", _oDocumento.NotaCreditoCabecera._claveAcceso, "Nota de Crédito Preliminar de tipo: Mapeo de Items, Creada Exitosamente: # " + sDocEntryPreliminar.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                Actualiza_DocumentoRecibido_NC(DocEntryNCRecibida_UDO, sDocEntryPreliminar)
                Return True
            End If
        ...
        Catch ex As Exception
            Elimina_DocumentoRecibido_NC(DocEntryNCRecibida_UDO)
            rsboApp.StatusBar.SetText(NombreAddon + " - Error:" + ex.Message.ToString(), SAPbouiCOM.BoMessageTime.bmt_Medium, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            oFuncionesAddon.GuardaLOG("NCR", _oDocumento.NotaCreditoCabecera._claveAcceso, "Ocurrio Error al grabar Nota de Crédito Preliminar de tipo: Mapeo de Items:" + ex.Message.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            Return False
        Finally
            GRPO = Nothing
            GC.Collect()
    ...
    Public Sub CargaDocumentoRelacionados()
        Try
            Dim oObjType As String = rsboApp.Forms.Item("frmDocumentoNCXML").Items.Item("objR").Specific.value
            Dim oDocEntrys As String = rsboApp.Forms.Item("frmDocumentoNCXML").Items.Item("docR").Specific.value
            ...
            End If
            Utilitario.Util_Log.Escribir_Log("Consulta Cabecera " & sQuery, "frmDocumentoNCXML")
            Try
                rsboApp.Forms.Item("frmDocumentoNCXML").DataSources.DataTables.Add("dtDocr") ' DATA TABLE, PARA DETALLE DE DOCUMENTOS RELACIONADOS
            Catch ex As Exception
            End Try
            Try
                rsboApp.Forms.Item("frmDocumentoNCXML").DataSources.DataTables.Add("dtDocRel") ' DATA TABLE, PARA RESUMEN DE LOS DOCUMENTOS RELACIONADOS
            Catch ex As Exception
            End Try

            Dim oGri As SAPbouiCOM.Grid = rsboApp.Forms.Item("frmDocumentoNCXML").Items.Item("oGridD").Specific
            rsboApp.Forms.Item("frmDocumentoNCXML").DataSources.DataTables.Item("dtDocr").ExecuteQuery(sQuery)
            oGri.DataTable = rsboApp.Forms.Item("frmDocumentoNCXML").DataSources.DataTables.Item("dtDocr")
            oGri.Item.Enabled = False
            If oObjType = 21 Then
                'oGri.Columns.Item(0).Visible = False
            ...
            End If
            Utilitario.Util_Log.Escribir_Log("Consulta Detalle " & sQueryResumen, "frmDocumentoNCXML")
            Dim dt As SAPbouiCOM.DataTable = rsboApp.Forms.Item("frmDocumentoNCXML").DataSources.DataTables.Item("dtDocRel")
    ...
    Public Function Guarda_DocumentoRecibido_NC(ByRef DocEntryNCRecibida_UDO As String) As Boolean
        ...
        Try
            ...
            oGeneralData.SetProperty("U_IdGS", _oDocumento.NotaCreditoCabecera._DocEntry.ToString())
    ...
    Public Function ActualizadoEstadoUdoNotaCreditoXML(ByRef IdUdoFcXML As String, Sincronizado As String) As Boolean
        ...
        Try
            oFuncionesAddon.GuardaLOG("NCE", _ClaveAcceso, " Actualizando a Sincronizado = " + Sincronizado.ToString(), Functions.FuncionesAddon.Transacciones.CreacionFinal, Functions.FuncionesAddon.TipoLog.Recepcion)
            oCompanyService = rCompany.GetCompanyService
            oGeneralService = oCompanyService.GetGeneralService("GS_NC")
...
#Enable Warning BC42104 ' La variable 'DOCENTRY' se usa antes de que se le haya asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
    ...
    '        ' DATOS DE AUTORIZACION
    '        GRPO.UserFields.Fields.Item("U_NUM_AUTOR").Value =  _oDocumento.NotaCreditoCabecera._NumeroAutorizacion
    '        GRPO.UserFields.Fields.Item("U_SER_EST").Value = oDocumento.NotaCreditoCabecera._estab
    '        GRPO.UserFields.Fields.Item("U_SER_PE").Value = oDocumento.NotaCreditoCabecera._ptoEmi

    '        'U_EREC_CREADO 
    '        GRPO.UserFields.Fields.Item("U_SSCREADAR").Value = "SI"

    '        GRPO.FolioNumber = oDocumento.NotaCreditoCabecera._secuencial
