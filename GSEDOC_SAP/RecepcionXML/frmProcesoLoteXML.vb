...
Public Class frmProcesoLoteXML
    ...
    Public Sub CreaFormularioProcesoLote()
        ...
        If RecorreFormulario(rsboApp, "frmProcesoLoteXML") Then
            Exit Sub
        End If

        strPath = System.Windows.Forms.Application.StartupPath & "\frmProcesoLoteXML.srf"
        xmlDoc.Load(strPath)
        ...
        Try
            ...
            Catch exx As Exception
                rsboApp.Forms.Item("frmProcesoLoteXML").Close()
                xmlDoc = Nothing
                Exit Sub
            End Try
            oForm = rsboApp.Forms.Item("frmProcesoLoteXML")
            ...
            cmbTipo.Select("07", SAPbouiCOM.BoSearchKey.psk_ByValue)
    ...
    Private Sub VerificarSN()
        ...
        Try
            Dim oForm As SAPbouiCOM.Form = rsboApp.Forms.Item("frmProcesoLoteXML")
        ...
        Try
            ...
            For x = 0 To oDatable.Rows.Count - 1
                ...
                Try
                    ...
                    Dim sPreliminar As String = oDataTable.GetValue(12, ofila).ToString()
                    Dim sNomProveedor As String = oDataTable.GetValue(5, ofila).ToString()
                    Dim ClaveAcceso As String = oDataTable.GetValue(7, ofila).ToString()
                    If sPreliminar = "0" Then
                        _fila = indexgrid
                        Dim sRUC As String = oDataTable.GetValue(4, ofila).ToString()
                        If cbxTipo.Value = "07" Then

                            'se comenta debido a que esta seccion ya se encuentra en la funcion Guarda_DocumentoRecibido_RE
                            'Dim results As List(Of Retencion)
                            'results = listaREs.FindAll(Function(column) column.RetCabecera._claveAcceso = ClaveAcceso)
                            'For Each oRt As Retencion In results
                            '    oRetencion = oRt
                            'Next
                            ...
                            sCardCode = oFuncionesB1.getRSvalue(QueryExisteCliente, "CardCode", "")
                            If sCardCode <> "" Then
                                If Guarda_DocumentoRecibido_RE(DocEntryFacturaRecibida_UDO, oRetencion) Then
                                    ...
                                    Try
                                        If Exitoso = True Then
                                            ...
                                            Try
                                                If oRetencion.RetCabecera._FechaAutorizacion <= Date.Now Then

                                                    Dim FecEmiFac As Date = oRetencion.RetDetalleImp(0)._fechaEmisionDocSustento
                                                    Dim FecAutRet As Date = oRetencion.RetCabecera._FechaAutorizacion
                                                    Dim FecEmiRet As Date = oRetencion.RetCabecera._fechaEmision

                                                    If Date.Now.Day > 5 And FecAutRet.Month = Date.Now.Month And FecEmiFac.Month < Date.Now.Month Then
                                                        Dim odt2 As SAPbouiCOM.DataTable = rsboApp.Forms.Item("frmProcesoLoteXML").DataSources.DataTables.Item("dtDocs")
                                                    ...
                                                    ElseIf FecEmiFac.Month < Date.Now.Month And FecAutRet.Month < Date.Now.Month And FecEmiRet.Month < Date.Now.Month Then
                                                        ...
                                                        gcss.SetRowBackColor(y + 1, RGB(251, 163, 26))
                                                    Else
                                                        Dim odt As SAPbouiCOM.DataTable = rsboApp.Forms.Item("frmProcesoLoteXML").DataSources.DataTables.Item("dtDocs")
                                            ...
                                            oFuncionesAddon.GuardaLOG("REE", oRetencion.RetCabecera._claveAcceso, " Proceso terminado Exitosamente!", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                                            Utilitario.Util_Log.Escribir_Log("PL - REE: " + oRetencion.RetCabecera._claveAcceso.ToString(), "ProcesoLote")
                                        Else
                                            Dim odt As SAPbouiCOM.DataTable = rsboApp.Forms.Item("frmProcesoLoteXML").DataSources.DataTables.Item("dtDocs")
                                    ...
                                    If Guarda_DocumentoRecibido_Factura(DocEntryFacturaRecibida_UDO, oFactura) Then
                                        ...
                                        Try
                                            If Exitoso = True Then
                                                ...
                                                ' END ACTUALIZO EL GRID DE FORMULARIO PRINCIPAL
                                                oFuncionesAddon.GuardaLOG("REE", oFactura.FacturaCabecera._claveAcceso, " Proceso terminado Exitosamente!", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                                                Utilitario.Util_Log.Escribir_Log("PL - REE: " + oFactura.FacturaCabecera._claveAcceso.ToString(), "ProcesoLote")
                                            Else
                                                Dim odt As SAPbouiCOM.DataTable = rsboApp.Forms.Item("frmProcesoLoteXML").DataSources.DataTables.Item("dtDocs")
    ...
    Private Sub rSboApp_ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean) Handles rsboApp.ItemEvent
        Try
            ...
            If pVal.FormTypeEx = "frmProcesoLoteXML" Then
                        ...
                        If Not pVal.Before_Action Then
                            Select Case pVal.ItemUID
                                ...
                                Case "oGrid"
                                    ...
                                    oFor = rsboApp.Forms.Item("frmProcesoLoteXML")
    ...
    Public Function CargarDocumento() As Boolean
        Try
            ...
            Utilitario.Util_Log.Escribir_Log("SALIDA POR PROXY : " + SALIDA_POR_PROXY.ToString, "frmProcesoLoteXML")
            ...
            If SALIDA_POR_PROXY = "Y" Then
                ...
                Utilitario.Util_Log.Escribir_Log("Proxy_puerto : " + Proxy_puerto.ToString, "frmProcesoLoteXML")
                Utilitario.Util_Log.Escribir_Log("Proxy_IP : " + Proxy_IP.ToString, "frmProcesoLoteXML")
                Utilitario.Util_Log.Escribir_Log("Proxy_Usuario : " + Proxy_Usuario.ToString, "frmProcesoLoteXML")
                Utilitario.Util_Log.Escribir_Log("Proxy_Clave : " + Proxy_Clave.ToString, "frmProcesoLoteXML")
        ...
        Try
            ...
            ElseIf tipoDoc = "07" Then
                ...
                For Each oRE As Retencion In listaREs.GetRange(NumIni, RegistrosXPaginas)
                    ...
                    Dim _FechaEmisionDocRetener As String = Convert.ToDateTime(oRE.RetDetalleImp(0)._fechaEmisionDocSustento)
                    ...
                    oForm.DataSources.DataTables.Item("dtDocs").SetValue("FechaEmisionFactura", i, CDate(oRE.RetDetalleImp(0)._fechaEmisionDocSustento))
                    If Not String.IsNullOrEmpty(DocPreliminar) Then
...
#Enable Warning BC42104 ' La variable 'm_oProgBar' se usa antes de que se le haya asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
    ...
    Private Function ChooseFromList(ByRef pVal As SAPbouiCOM.ItemEvent, ByVal FormUID As String) As Boolean
        ...
        If FormUID = "frmProcesoLoteXML" Then
            oForm = rsboApp.Forms.Item("frmProcesoLoteXML")
    ...
    Private Sub SBO_Application_RightClickEvent(ByRef eventInfo As SAPbouiCOM.ContextMenuInfo, ByRef BubbleEvent As Boolean) Handles rsboApp.RightClickEvent
        ...
        Try
            If eventInfo.FormUID = "frmProcesoLoteXML" And eventInfo.ItemUID = "oGrid" Then
...
#Enable Warning BC42030 ' La variable 'idForm' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
                    If typeEx = "frmProcesoLoteXML" Then
                        If ofila > 0 Then
                            Dim oForm As SAPbouiCOM.Form = rsboApp.Forms.Item("frmProcesoLoteXML")
                            Dim oDataTable As SAPbouiCOM.DataTable = oForm.DataSources.DataTables.Item("dtDocs")
                            Dim sRUC As String = oDataTable.GetValue(4, ofila).ToString()
                            ...
                            Else ' SI EXISTE EL PROVEEDOR
                                ...
                                If oDataTable.GetValue(0, ofila).ToString() = "Factura" Then
                                    ...
                                    If results.Count > 0 Then
                                        For Each oFC As Factura In results
                                            For Each oDetalle As FacturaDetalle In oFC.facturaDetalle
                                                listaDetalleArtiulos.Add(New Entidades.DetalleArticulo(sClaveAcceso, oDetalle._codigoPrincipal,
                                                                                                  oDetalle._codigoAuxiliar, oDetalle._descripcion, oDetalle._cantidad, oDetalle._precioUnitario, oDetalle._descuento, oDetalle._precioTotalSinImpuesto))
                                            Next
                                        Next
                                    End If
...
#Enable Warning BC42030 ' La variable 'idForm' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
            ...
            End If
        Catch ex As Exception
            Utilitario.Util_Log.Escribir_Log($"Error rsboApp_MenuEvent: {ex.Message}", "frmProcesoLoteXML")
...
#Region "Funciones Proceso Lote"
    ...
    Public Function Guarda_DocumentoRecibido_Factura(ByRef DocEntryFacturaRecibida_UDO As String, ByRef _oFactura As Factura) As Boolean
        ...
        Dim resultsFC As List(Of Factura)
        resultsFC = listaFCs.FindAll(Function(column) column.FacturaCabecera._claveAcceso = _ClaveAcceso)
        'Dim ofactura As Object
        For Each oFac As Factura In resultsFC
            Try
                ...
                Try
                    ...
                    End If
                Catch ex As Exception
                    Utilitario.Util_Log.Escribir_Log("REE - error al obtener CardCode PL : " + ex.ToString, "frmProcesoLoteXML")
                End Try


                numDoc = oFac.FacturaCabecera._estab + "-" + oFac.FacturaCabecera._ptoEmi + "-" + oFac.FacturaCabecera._secuencial
                ...
                oGeneralData.SetProperty("U_RUC", oFac.FacturaCabecera._ruc.ToString())
                oGeneralData.SetProperty("U_Nombre", Left(oFac.FacturaCabecera._RazonSocial.ToString(), 99))
                oGeneralData.SetProperty("U_CardCode", sCardCode.ToString())
                oGeneralData.SetProperty("U_Mapeado", "PL")
                oGeneralData.SetProperty("U_ClaAcc", oFac.FacturaCabecera._claveAcceso.ToString())
                oGeneralData.SetProperty("U_NumAut", oFac.FacturaCabecera._NumeroAutorizacion.ToString())
                oGeneralData.SetProperty("U_FecAut", oFac.FacturaCabecera._FechaAutorizacion.ToString())
                ...
                oGeneralData.SetProperty("U_SubSI", Convert.ToDouble(formatDecimal(oFac.FacturaCabecera._totalSinImpuestos.ToString())))
                oGeneralData.SetProperty("U_Desc", Convert.ToDouble(formatDecimal(oFac.FacturaCabecera._totalDescuento.ToString())))
                oGeneralData.SetProperty("U_vTotal", Convert.ToDouble(formatDecimal(oFac.FacturaCabecera._importeTotal)))
                oGeneralData.SetProperty("U_rGast", "0")
                oGeneralData.SetProperty("U_rImp", "0")
                oGeneralData.SetProperty("U_rTotal", "0")
                oGeneralData.SetProperty("U_IdGS", oFac.FacturaCabecera._DocEntry.ToString())
                ...
                For Each impFAC As FacturaCabeceraImpuestos In oFac.FacturaCabecera._impuestos
                    ...
                    If impFAC._codigo = 2 Then
                        If impFAC._codigoPorcentaje = 2 Or impFAC._codigoPorcentaje = 3 Then
                            BaseImponibleIVA += impFAC._baseImponible
                            Iva += impFAC._valor
                        ElseIf impFAC._codigoPorcentaje = 0 Then
                            BaseImponible0 += impFAC._baseImponible
                        ElseIf impFAC._codigoPorcentaje = 6 Then
                            BaseImponibleNoObjeto += impFAC._baseImponible
                        ElseIf impFAC._codigoPorcentaje = 7 Then
                            BaseImponibleExento += impFAC._baseImponible
                        End If
                    ElseIf impFAC._codigo = 3 Then
                        ICE += impFAC._valor
                    End If
                    ...
                    oGeneralData.SetProperty("U_rTades", Convert.ToDouble(formatDecimal(impFAC._baseImponible.ToString())))
                    oGeneralData.SetProperty("U_rPDesc", Convert.ToDouble(formatDecimal(impFAC._tarifa.ToString())))
                    oGeneralData.SetProperty("U_rDesc", Convert.ToDouble(formatDecimal(impFAC._valor.ToString())))
                Next
                ...
                For Each detalleFac As FacturaDetalle In oFac.facturaDetalle
                    Dim CodPrin As String = ""
                    oChild = oChildren.Add

                    If IsNothing(detalleFac._codigoPrincipal) Then
                        CodPrin = "PL"
                    Else
                        CodPrin = detalleFac._codigoPrincipal.ToString
                    End If

                    oChild.SetProperty("U_CodPrin", Left(CodPrin, 99))
                    If String.IsNullOrEmpty(detalleFac._codigoAuxiliar) Then
                        oChild.SetProperty("U_CodAuxi", "SCA")
                    Else
                        oChild.SetProperty("U_CodAuxi", Left(detalleFac._codigoAuxiliar.ToString(), 99))
                    End If
                    oChild.SetProperty("U_CodSAP", "Servicio PL")
                    oChild.SetProperty("U_Descripc", Left(detalleFac._descripcion.ToString(), 99))
                    oChild.SetProperty("U_Cantid", Convert.ToDouble(formatDecimal(detalleFac._cantidad.ToString())))
                    oChild.SetProperty("U_Precio", Convert.ToDouble(formatDecimal(detalleFac._precioUnitario.ToString())))
                    oChild.SetProperty("U_Desc", Convert.ToDouble(formatDecimal(detalleFac._descuento.ToString())))
                    oChild.SetProperty("U_Total", Convert.ToDouble(formatDecimal(detalleFac._precioTotalSinImpuesto.ToString())))
                Next
                ...
                Utilitario.Util_Log.Escribir_Log("REE - se creo el preliminar : " + DocEntryFacturaRecibida_UDO, "frmProcesoLoteXML")
    ...
    End Function
    Private Function CrearFacturaPremilinarServicio(ByRef sCardCode As String, ByVal oFactura As Factura, ByRef sDocEntryPreliminar As String, ByVal DocEntryFVRecibida_UDO As String) As Boolean
        'Dim oForm As SAPbouiCOM.Form = rsboApp.Forms.Item("frmProcesoLoteXML")
        'Dim oDataTable As SAPbouiCOM.DataTable = oForm.DataSources.DataTables.Item("dtDocs")
        'Dim sRUC As String = oDataTable.GetValue(4, ofila).ToString()
        ...
        oFuncionesAddon.GuardaLOG("REE", oFactura.FacturaCabecera._claveAcceso, "Creando Factura Preliminar de tipo: Servicio", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
        ...
        Try
            ...
            'If QFE = "SI" Then
            '    GRPO.DocDate = oFactura.FacturaCabecera._fechaEmision
            '    GRPO.TaxDate = oFactura.FacturaCabecera._fechaEmision
            '    GRPO.DocDueDate = oFactura.FacturaCabecera._fechaEmision
            'Else
            ...
            If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS Then
                GRPO.UserFields.Fields.Item("U_NUM_AUTOR").Value = oFactura.FacturaCabecera._NumeroAutorizacion
                GRPO.UserFields.Fields.Item("U_SER_EST").Value = oFactura.FacturaCabecera._estab
                GRPO.UserFields.Fields.Item("U_SER_PE").Value = oFactura.FacturaCabecera._ptoEmi
                Try
                ...
                End Try
                GRPO.FolioNumber = oFactura.FacturaCabecera._secuencial
            ...
            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.ONESOLUTIONS Then
                GRPO.UserFields.Fields.Item("U_NO_AUTORI").Value = oFactura.FacturaCabecera._NumeroAutorizacion
                GRPO.NumAtCard = oFactura.FacturaCabecera._estab + oFactura.FacturaCabecera._ptoEmi + oFactura.FacturaCabecera._secuencial
...
#Enable Warning BC42024 ' Variable local sin usar: 'result'.
            For Each oDetalle As FacturaDetalle In oFactura.facturaDetalle



                sQueryCodImp = " SELECT ""U_SSID"" FROM ""@GS_MAPEO_TC"" WHERE ""U_SSCOD"" = '" + oDetalle._impuestos(0)._codigoPorcentaje.ToString + "' "
                CodImp = oFuncionesB1.getRSvalue(sQueryCodImp, "U_SSID", "")

                sQueryCodImpV = " SELECT TOP 1 ""U_SSCOD"" FROM ""@GS_MAPEO_TC"" WHERE ""U_SSCOD"" = '" + oDetalle._impuestos(0)._codigoPorcentaje.ToString + "' "
                ...
                Utilitario.Util_Log.Escribir_Log("Obteniendo TAXCODE - QUERY: " + sQueryCodImp + "Resultado :" + CodImp.ToString(), "frmProcesoLoteXML")
                Utilitario.Util_Log.Escribir_Log("Obteniendo TAXCODE - QUERY: " + sQueryCodImpV + "Resultado :" + CodImpV.ToString(), "frmProcesoLoteXML")
                GRPO.Lines.AccountCode = Cuenta
                GRPO.Lines.LineTotal = formatDecimal(oDetalle._precioTotalSinImpuesto)
                ...
                Utilitario.Util_Log.Escribir_Log("Obteniendo centro de costo - QUERY: " + sQueryCentroCosto + "Resultado :" + CodCentroCosto.ToString(), "frmProcesoLoteXML")
                ...
                Utilitario.Util_Log.Escribir_Log("Obteniendo marca - QUERY: " + sQueryMarca + "Resultado :" + CodMarca.ToString(), "frmProcesoLoteXML")

                Try
                    If CodImpV = oDetalle._impuestos(0)._codigoPorcentaje.ToString Then
                ...
                GRPO.Lines.ItemDescription = Left(oDetalle._descripcion, 99)
...
#Enable Warning BC42030 ' La variable 'ErrMsg' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
                ...
                oFuncionesAddon.GuardaLOG("REE", oFactura.FacturaCabecera._claveAcceso, "PL Ocurrio Error al grabar Factura Preliminar de tipo: Servicio:" + ErrCode.ToString + " - " + ErrMsg.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                Return False
            Else
                rCompany.GetNewObjectCode(sDocEntryPreliminar)
                oFuncionesAddon.GuardaLOG("REE", oFactura.FacturaCabecera._claveAcceso, "PL Factura Preliminar de tipo: Servicio, Creada Exitosamente: # " + sDocEntryPreliminar.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
        ...
        Catch ex As Exception
            ...
            oFuncionesAddon.GuardaLOG("REE", oFactura.FacturaCabecera._claveAcceso, "PL Ocurrio Error al grabar Factura Preliminar de tipo: Servicio:" + ex.Message.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            Return False
        Finally
            GRPO = Nothing
            GC.Collect()
    ...
    Public Function Guarda_DocumentoRecibido_RE(ByRef DocEntryFacturaRecibida_UDO As String, ByRef _oRetencion As Retencion) As Boolean
        ...
        Dim results As List(Of Retencion)
        results = listaREs.FindAll(Function(column) column.RetCabecera._claveAcceso = _ClaveAcceso)
        For Each oRE As Retencion In results
            oRetencion = oRE
        Next
        ...
        For Each detalle As RetDetalleImpuestos In oRetencion.RetDetalleImp
        ...
        Try
            ...
            Dim numDoc As String = oRetencion.RetCabecera._estab + "-" + oRetencion.RetCabecera._ptoEmi + "-" + oRetencion.RetCabecera._secuencial

            oCompanyService = rCompany.GetCompanyService
            oGeneralService = oCompanyService.GetGeneralService("GS_RER")
            oGeneralData = oGeneralService.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralData)
            'oGeneralData.SetProperty("Code", conta)
            oGeneralData.SetProperty("U_RUC", oRetencion.RetCabecera._ruc.ToString())
            oGeneralData.SetProperty("U_Nombre", Left(oRetencion.RetCabecera._RazonSocial.ToString(), 99))
            oGeneralData.SetProperty("U_CardCode", sCardCode.ToString())
            'oGeneralData.SetProperty("U_Mapeado", oForm.Items.Item("lbMapp").Specific.Value.ToString())
            oGeneralData.SetProperty("U_ClaAcc", oRetencion.RetCabecera._claveAcceso.ToString())
            oGeneralData.SetProperty("U_NumAut", oRetencion.RetCabecera._NumeroAutorizacion.ToString())
            oGeneralData.SetProperty("U_FecAut", oRetencion.RetCabecera._FechaAutorizacion.ToString())
            oGeneralData.SetProperty("U_NumDoc", numDoc.ToString())
            oGeneralData.SetProperty("U_FPrelim", DocEntryFacturaRecibida_UDO.ToString())
            oGeneralData.SetProperty("U_vTotal", Convert.ToDouble(formatDecimal(valorRetenido.ToString())))
            oGeneralData.SetProperty("U_IdGS", oRetencion.RetCabecera._DocEntry.ToString())
            oGeneralData.SetProperty("U_Sincro", 0)
            oGeneralData.SetProperty("U_Estado", "docPreliminar")


            oChildren = oGeneralData.Child("GS0_RER")
            For Each detalleRet As RetDetalleImpuestos In oRetencion.RetDetalleImp

                Dim ejeFiscal As String = oRetencion.RetCabecera._periodoFiscal
                ...
                oChild.SetProperty("U_Base", Convert.ToDouble(formatDecimal(detalleRet._baseImponible.ToString())))
                If detalleRet._codigoRetencion = "1" Then
                    oChild.SetProperty("U_Impuesto", "RENTA")
                Else
                    oChild.SetProperty("U_Impuesto", "IVA")
                End If
                oChild.SetProperty("U_Porcent", Convert.ToDouble(formatDecimal(detalleRet._porcentajeRetener.ToString())))
                oChild.SetProperty("U_valorR", Convert.ToDouble(formatDecimal(detalleRet._valorRetenido.ToString())))
        ...
        End Try
    End Function
    Private Function CrearPagoRecibido(ByRef sCardCode As String, ByRef oRetencion As Retencion, ByRef sDocEntryPreliminar As String, DocEntryRERecibida_UDO As String) As Boolean


        If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS _
            Or Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.ONESOLUTIONS _
            Or Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.HEINSOHN Then
    ...
    End Function
    Private Function CrearPagoRecibido_E_O(ByRef sCardCode As String, ByRef oRetencion As Retencion, ByRef sDocEntryPreliminar As String, DocEntryRERecibida_UDO As String) As Boolean
        'Dim RetVal As Long
        'Dim ErrCode As Long
        'Dim ErrMsg As String
        ...
        End If
    End Function
    Private Function CrearPagoRecibido_E_OCB(ByRef sCardCode As String, ByRef oRetencion As Retencion, ByRef sDocEntryPreliminar As String, DocEntryRERecibida_UDO As String) As Boolean
        Dim RetVal As Long
        Dim ErrCode As Long
        Dim ErrMsg As String
        Dim vPay As SAPbobsCOM.Payments
        ...
        Try
            ...
            'CLIENTE BANCARIO 
            oFuncionesAddon.GuardaLOG("PRR", oRetencion.RetCabecera._claveAcceso, "Creando Pago Recibido Tipo Cuenta(Retencion) Preliminar", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            ...
            vPay.DocDate = oRetencion.RetCabecera._FechaAutorizacion
            'vPay.DocDate = oRetencion.RetCabecera._fechaEmision
            'vPay.TaxDate = oRetencion.RetCabecera._fechaEmision
            'vPay.DueDate = oRetencion.RetCabecera._fechaEmision
            vPay.DocRate = 0
            ...
            Try
                vPay.AccountPayments.SumPaid = valorRetenido 'valorRetenido
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("agregando total retencion " + ex.Message.ToString + valorRetenido.ToString(), "ProcesoLote")
            End Try
            ...
            For Each oDetalle As RetDetalleImpuestos In oRetencion.RetDetalleImp
                ...
                If oDetalle._valorRetenido > 0 Then
                    ...
                    If oDetalle._codigo = 1 Then ' RENTA
                        ...
                        Utilitario.Util_Log.Escribir_Log("Obteniendo CODIGO RENTA - QUERY: " + sQueryCodRetencion + "Resultado :" + CodRetencion.ToString(), "frmProcesoLoteXML")
                    ...
                    ElseIf oDetalle._codigo = 6 Then ' ISD
                        ...
                        CodRetencion = oFuncionesB1.getRSvalue(sQueryCodRetencion, "U_SSID", "")
                        Utilitario.Util_Log.Escribir_Log("Obteniendo CODIGO ISD - QUERY: " + sQueryCodRetencion + "Resultado :" + CodRetencion.ToString(), "frmProcesoLoteXML")
                        If CodRetencion = "" Then
                    ...
                    Utilitario.Util_Log.Escribir_Log("Obteniendo CUENTA RENTA - QUERY: " + sQueryCuentaRetencion + "Resultado :" + CuentaRetencion.ToString(), "frmProcesoLoteXML")
                    ...
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando cuenta retencion: " + CuentaRetencion.ToString(), "frmProcesoLoteXML")
                    End Try
                    ...
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando codigo retencion: " + CodRetencion.ToString(), "frmProcesoLoteXML")
                    End Try
                    ...
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando codigo tipo codigo: " + CrTypeCode.ToString(), "frmProcesoLoteXML")
                    End Try

                    Try
                        vPay.CreditCards.CreditCardNumber = oRetencion.RetCabecera._secuencial
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando numero de tarjeta de credito : " + oRetencion.RetCabecera._secuencial.ToString(), "frmProcesoLoteXML")
                    End Try

                    Try
                        vPay.CreditCards.CreditSum = oDetalle._valorRetenido
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando valor retenido : " + oDetalle._valorRetenido.ToString(), "frmProcesoLoteXML")
                    End Try
                    ' _oDocumento.TotalRetencion ' formatDecimal(_oDocumento.TotalRetencion.ToString())
                    ' vPay.CreditCards.CreditType = 1
                    Try
                        vPay.CreditCards.FirstPaymentSum = valorRetenido
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando total retencion : " + valorRetenido.ToString(), "frmProcesoLoteXML")
                    End Try


                    If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS Then
                        Try
                            vPay.CreditCards.FirstPaymentDue = oRetencion.RetCabecera._FechaAutorizacion
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando fecha autroizacion : " + oRetencion.RetCabecera._FechaAutorizacion.ToString(), "frmProcesoLoteXML")
                        End Try
                        ...
                        Try
                            If Not IsNothing(oDetalle._numDocSustento) Then
                                ...
                                vPay.CreditCards.OwnerPhone = oRetencion.RetCabecera._estab + oRetencion.RetCabecera._ptoEmi
                            Else
                        ...
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando fecha autroizacion : " + oDetalle._numDocSustento.ToString(), "frmProcesoLoteXML")
                        End Try
                        '
                        Try
                            ...
                            End If
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando monto base : " + oDetalle._baseImponible.ToString(), "frmProcesoLoteXML")
                        End Try
                        '
                        Try
                        ...
                        Try
                            If oFuncionesB1.checkCampoBD("RCT3", "CXS_NUM_RETE") Then
                                vPay.CreditCards.UserFields.Fields.Item("U_CXS_NUM_RETE").Value = oRetencion.RetCabecera._secuencial
                            End If
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando numero de retencion : " + oRetencion.RetCabecera._secuencial.ToString(), "frmProcesoLoteXML")
                        End Try
                        '
                        Try
                            If oFuncionesB1.checkCampoBD("RCT3", "CXS_NUM_AUTO_RETE") Then
                                vPay.CreditCards.UserFields.Fields.Item("U_CXS_NUM_AUTO_RETE").Value = oRetencion.RetCabecera._NumeroAutorizacion
                            End If
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando numero de autorizacion de retencion : " + oRetencion.RetCabecera._NumeroAutorizacion.ToString(), "frmProcesoLoteXML")
                        End Try
                        '
                        Try
                            If oFuncionesB1.checkCampoBD("RCT3", "CXS_SER_PTO_RET") Then
                                vPay.CreditCards.UserFields.Fields.Item("U_CXS_SER_PTO_RET").Value = oRetencion.RetCabecera._estab + oRetencion.RetCabecera._ptoEmi
                            End If
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando est y punto de emision : " + oRetencion.RetCabecera._estab.ToString() + oRetencion.RetCabecera._ptoEmi, "frmProcesoLoteXML")
                        End Try
                        Try
                            ...
                            End If
                        Catch ex As Exception
                            Utilitario.Util_Log.Escribir_Log("agregando est y punto de emision : " + sCardCode.ToString, "frmProcesoLoteXML")
                        End Try

                    ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.ONESOLUTIONS Then
                        vPay.CreditCards.VoucherNum = oRetencion.RetCabecera._estab + oRetencion.RetCabecera._ptoEmi + oRetencion.RetCabecera._secuencial
                        If oFuncionesB1.checkCampoBD("RCT3", "NUM_AUT") Then
                            vPay.CreditCards.UserFields.Fields.Item("U_NUM_AUT").Value = oRetencion.RetCabecera._NumeroAutorizacion
                        End If
                        If oFuncionesB1.checkCampoBD("RCT3", "FEC_AUT") Then
                            vPay.CreditCards.UserFields.Fields.Item("U_FEC_AUT").Value = oRetencion.RetCabecera._FechaAutorizacion
                        End If
                    ...
                    ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.HEINSOHN Then
                        ...
                        If oFuncionesB1.checkCampoBD("ORCT", "HBT_NUM_SERIE_RET") Then
                            vPay.UserFields.Fields.Item("U_HBT_NUM_SERIE_RET").Value = oRetencion.RetCabecera._estab.ToString + "-" + oRetencion.RetCabecera._ptoEmi.ToString
                        End If
                        If oFuncionesB1.checkCampoBD("ORCT", "HBT_NUM_RET") Then
                            vPay.UserFields.Fields.Item("U_HBT_NUM_RET").Value = oRetencion.RetCabecera._secuencial.ToString
                        End If
                        If oFuncionesB1.checkCampoBD("ORCT", "HBT_NUM_AUT") Then
                            vPay.UserFields.Fields.Item("U_HBT_NUM_AUT").Value = oRetencion.RetCabecera._NumeroAutorizacion.ToString
                        End If
                        If oFuncionesB1.checkCampoBD("ORCT", "HBT_NUM_AUT") Then
                            vPay.UserFields.Fields.Item("U_HBT_NUM_AUT").Value = oRetencion.RetCabecera._NumeroAutorizacion.ToString
                        End If
                        If oFuncionesB1.checkCampoBD("ORCT", "HBT_FEC_RET") Then
                            vPay.UserFields.Fields.Item("U_HBT_FEC_RET").Value = CDate(oRetencion.RetCabecera._FechaAutorizacion)
                        End If
                        If oFuncionesB1.checkCampoBD("ORCT", "HBT_CADRET") Then
                            vPay.UserFields.Fields.Item("U_HBT_CADRET").Value = CDate(oRetencion.RetCabecera._FechaAutorizacion)
                        End If
                    ...
                    Try
                        ...
                        End If
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando docentry udo : " + DocEntryRERecibida_UDO.ToString, "frmProcesoLoteXML")
                    End Try
                    ...
                    Try
                        ...
                        secuencial += 1
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("agregando lineas medio de pago : " + ex.Message.ToString, "frmProcesoLoteXML")
                    End Try
            ...
            Try
                RetVal = vPay.Add()
            Catch ex As Exception
                Utilitario.Util_Log.Escribir_Log("erro al agregar pago recibido tipo cuenta : " + ex.Message.ToString, "frmProcesoLoteXML")
            End Try
            ...
            If RetVal <> 0 Then
                ...
                Try
                    ...
                    Dim sRuta As String = sRutaCarpeta & "\" & sCardCode.ToString() + oRetencion.RetCabecera._DocEntry.ToString() + ".xml"
                    'Dim xml As String = vPay.GetAsXML()
                    If System.IO.Directory.Exists(sRutaCarpeta) Then
                        Utilitario.Util_Log.Escribir_Log("Serializando...", "frmProcesoLoteXML")
                        Dim writer As TextWriter = New StreamWriter(sRuta)
                        writer.Write(xml)
                        writer.Close()
                    End If
                Catch ex As Exception
                    Utilitario.Util_Log.Escribir_Log("EEROR " + ex.Message, "frmProcesoLoteXML")
                End Try
...
#Enable Warning BC42030 ' La variable 'ErrMsg' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
                rsboApp.MessageBox(ErrCode & " " & ErrMsg)
                oFuncionesAddon.GuardaLOG("PRR", oRetencion.RetCabecera._claveAcceso, "Ocurrio Error al grabar Pago Recibido(Retencion) Preliminar: " + ErrCode.ToString + " - " + ErrMsg.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                Return False
            Else
                Try
                    Dim xml As String = vPay.GetAsXML()
                ...
                End Try
                rCompany.GetNewObjectCode(sDocEntryPreliminar)
                oFuncionesAddon.GuardaLOG("PRR", oRetencion.RetCabecera._claveAcceso, "Pago Recibido(Retencion) Preliminar, Creado Exitosamente: # " + sDocEntryPreliminar.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
        ...
        Catch ex As Exception
            ...
            oFuncionesAddon.GuardaLOG("PRR", oRetencion.RetCabecera._claveAcceso, "Error:" + ex.Message.ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            Return False
        Finally
            vPay = Nothing
            GC.Collect()
    ...
    End Function
    Private Function CrearPagoRecibido_E_ONormal(ByRef sCardCode As String, ByRef oRetencion As Retencion, ByRef sDocEntryPreliminar As String, DocEntryRERecibida_UDO As String) As Boolean
        Utilitario.Util_Log.Escribir_Log("Inicio funcion creae preliminar sCardCode: " + sCardCode.ToString, "frmProcesoLoteXML")
        Dim RetVal As Long
        Dim ErrCode As Long
        Dim ErrMsg As String
        Dim vPay As SAPbobsCOM.Payments
        ...
        Dim valorRetenido As Decimal = 0
        Dim valorFactura As Decimal = 0
        Dim SvalorRetenidoR As Decimal = 0
        Dim numFac As String = ""
        Dim numFac2 As String = ""
        'For Each detalle As RetDetalleImpuestos In oRetencion.RetDetalleImp '--*
        ...
        'Dim valorRetenido As Double = valorRetenido
        'Dim queryValorRT As String = oRetencion.RetDetalleImp(0)._numDocSustento.ToString
        Dim _numDocRetener As String = oRetencion.RetDetalleImp(0)._numDocSustento.Substring(0, 3).ToString + "-" + oRetencion.RetDetalleImp(0)._numDocSustento.Substring(3, 3).ToString + "-" + CLng(Right(oRetencion.RetDetalleImp(0)._numDocSustento, 9)).ToString
        Dim est As String = oRetencion.RetDetalleImp(0)._numDocSustento.Substring(0, 3).ToString
        Dim punEmi As String = oRetencion.RetDetalleImp(0)._numDocSustento.Substring(3, 3).ToString
        Dim folio As String = CLng(Right(oRetencion.RetDetalleImp(0)._numDocSustento, 9)).ToString
        ...
        Utilitario.Util_Log.Escribir_Log("Obteniendo CARDCODE - QUERY: " + QryCardCode + "Resultado :" + sCardCode.ToString(), "frmProcesoLoteXML")
        '************************************
        '******************************************
        'If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS Then --*
        ...
        '    If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
        '        queryValorRT = " SELECT (""DocTotal""-""PaidToDate"") as SaldoPendiente "
        '        queryValorRT += " FROM ""OINV"" A INNER JOIN "
        '        queryValorRT += " ""NNM1"" B ON A.""Series"" = B.""Series"" "
        '        queryValorRT += " WHERE A.""CardCode"" = '" + sCardCode + "'"
        '        queryValorRT += " AND B.""BeginStr"" = '" & oRetencion.RetDetalleImp(0)._numDocSustento.ToString().Substring(0, 3) & "'"
        '        queryValorRT += " AND B.""EndStr"" = '" & oRetencion.RetDetalleImp(0)._numDocSustento.ToString().Substring(3, 3) & "'"
        '        queryValorRT += " AND REPLACE(LTRIM(REPLACE(RIGHT(A.""DocNum"",7),'0',' ')),' ','0') =" & Integer.Parse(oRetencion.RetDetalleImp(0)._numDocSustento.Substring(6, 9))
        '        queryValorRT += " AND A.""DocStatus""='O' AND A.""CANCELED""='N' "
        '    Else
        '        queryValorRT = " SELECT (DocTotal-PaidToDate) as SaldoPendiente "
        '        queryValorRT += " FROM OINV A INNER JOIN "
        '        queryValorRT += " NNM1 B ON A.Series = B.Series "
        ...
        'Utilitario.Util_Log.Escribir_Log("Obteniendo saldo pendiendte - QUERY: " + queryValorRT + "Resultado :" + valorRT.ToString(), "frmProcesoLoteXML")
        '******************************************************
        '************************************************************
        If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS Then
            If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
        ...
        ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.HEINSOHN Then
            If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                docentry = " SELECT ""DocEntry"" "
                docentry += " FROM ""OINV"" A INNER JOIN "
                docentry += " ""NNM1"" B ON A.""Series"" = B.""Series"" "
                docentry += " WHERE A.""CardCode"" = '" + sCardCode + "'"
                docentry += " AND B.""BeginStr"" = '" & oRetencion.RetDetalleImp(0)._numDocSustento.ToString().Substring(0, 3) & "'"
                docentry += " AND B.""EndStr"" = '" & oRetencion.RetDetalleImp(0)._numDocSustento.ToString().Substring(3, 3) & "'"
                docentry += " AND REPLACE(LTRIM(REPLACE(RIGHT(A.""DocNum"",7),'0',' ')),' ','0') =" & Integer.Parse(oRetencion.RetDetalleImp(0)._numDocSustento.Substring(6, 9))
                docentry += " AND A.""DocStatus""='O' AND A.""CANCELED""='N' "
            Else
                docentry = " SELECT DocEntry "
                docentry += " FROM OINV A INNER JOIN "
                docentry += " NNM1 B ON A.Series = B.Series "
        ...
        Utilitario.Util_Log.Escribir_Log("Obteniendo docentry de la factura - QUERY: " + docentry + "Resultado :" + _docentry.ToString(), "frmProcesoLoteXML")
        '***********************************************************
        '**************************************************************
        'If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS Then
        '    If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
        ...
        'Utilitario.Util_Log.Escribir_Log("Obteniendo cardcode - QUERY: " + queryCardCode + "Resultado :" + _CardCode.ToString(), "frmProcesoLoteXML")

        '*************************************************
        '****************************************************
        If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS Then
            If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                queryDocDate = " SELECT ""DocDate"" from  OINV where ""U_SER_EST""='" + est + "' and ""U_SER_PE""='" + punEmi + "' and cast(""FolioNum"" as varchar)='" + folio + "'"
            Else
                queryDocDate = " SELECT DocDate from oinv where (U_SER_EST +'-'+ U_SER_PE +'-'+ cast(FolioNum as varchar))='" + _numDocRetener + "' "
            End If
        ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.HEINSOHN Then
            If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                docentry = " SELECT ""DocDate"" "
                docentry += " FROM ""OINV"" A INNER JOIN "
                docentry += " ""NNM1"" B ON A.""Series"" = B.""Series"" "
                docentry += " WHERE A.""CardCode"" = '" + sCardCode + "'"
                docentry += " AND B.""BeginStr"" = '" & oRetencion.RetDetalleImp(0)._numDocSustento.ToString().Substring(0, 3) & "'"
        ...
        Utilitario.Util_Log.Escribir_Log("Obteniendo fecha de la factura: " + queryDocDate + "Resultado :" + DocDate.ToString(), "frmProcesoLoteXML")
        '*****************************************************
        '********************************************************
        ...
        If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS Then
            If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                MedioPago = " SELECT top 1 T1.""DocNum"" from  RCT3 T0 inner join ORCT T1 ON T1.DocEntry = T0.DocNum where T1.""Canceled""='N' AND T0.""VoucherNum""='" + Left(oRetencion.RetDetalleImp(0)._numDocSustento.ToString(), 15) + "' and T0.""U_CXS_NUM_AUTO_RETE""='" + oRetencion.RetCabecera._NumeroAutorizacion + "'"
            Else
                MedioPago = " SELECT top 1 T1.DocNum from  RCT3 T0 inner join ORCT T1 ON T1.DocEntry = T0.DocNum where T1.Canceled='N' AND T0.VoucherNum='" + Left(oRetencion.RetDetalleImp(0)._numDocSustento.ToString(), 15) + "' and T0.U_CXS_NUM_AUTO_RETE='" + oRetencion.RetCabecera._NumeroAutorizacion + "'"
            End If
        ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.HEINSOHN Then
            If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                MedioPago = " SELECT top 1 T1.""DocNum"" from  RCT3 T0 inner join ORCT T1 ON T1.""DocEntry""=T0.""DocNum"" where T1.""Canceled""='N' AND T0.""VoucherNum""='" + Left(oRetencion.RetDetalleImp(0)._numDocSustento.ToString(), 15) + "' and T1.""U_HBT_NUM_AUT""='" + oRetencion.RetCabecera._NumeroAutorizacion + "'"
            Else
                MedioPago = " SELECT top 1 T1.DocNum from  RCT3 T0 inner join ORCT T1 ON T1.DocEntry = T0.DocNum where T1.Canceled='N' AND T0.VoucherNum='" + Left(oRetencion.RetDetalleImp(0)._numDocSustento.ToString(), 15) + "' and T1.U_HBT_NUM_AUT='" + oRetencion.RetCabecera._NumeroAutorizacion + "'"
            End If
        End If
        ...
        Utilitario.Util_Log.Escribir_Log("Obteniendo docnum del medio de pago : " + MedioPago + "Resultado :" + _MedioPago.ToString(), "frmProcesoLoteXML")
        '*************************************************+
        Dim _valorRT As Double = 0
        ...
        Try
            ...
            '_valorRT = ConvertToDouble(valorRT)
            Utilitario.Util_Log.Escribir_Log("_valorRT Resultado :" + _valorRT.ToString(), "frmProcesoLoteXML")
            'Dim jaja As Double = Convert.ToDouble(valorRT)
            'Dim ejej As Double = ConvertToDouble(valorRT)
            Utilitario.Util_Log.Escribir_Log("sCardCode Resultado :" + sCardCode.ToString(), "frmProcesoLoteXML")
        Catch ex As Exception
            Utilitario.Util_Log.Escribir_Log("ERROR CONTINUO :" + ex.Message.ToString, "frmProcesoLoteXML")
        End Try


        '_CardCode = sCardCode
        Utilitario.Util_Log.Escribir_Log("_CardCode Resultado :" + sCardCode.ToString(), "frmProcesoLoteXML")
        If _docentry <> "0" Then
            Utilitario.Util_Log.Escribir_Log("_docentry Resultado :" + _docentry.ToString(), "frmProcesoLoteXML")
            'If valorRetenido <= _valorRT Then--*
            Utilitario.Util_Log.Escribir_Log("El valor de la retencion : " + valorRetenido.ToString + "es menor o igual  a :" + _valorRT.ToString(), "frmProcesoLoteXML")
            ...
            If Not _MedioPago <> "0" Then
                ...
                Dim diaRT As String = CDate(oRetencion.RetCabecera._fechaEmision).Day
                Dim mesRT As Integer = CDate(oRetencion.RetCabecera._fechaEmision).Month
                ...
                Try
                    ...
                    oFuncionesAddon.GuardaLOG("PRR", oRetencion.RetCabecera._claveAcceso, "Creando Pago Recibido(Retencion) Preliminar", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                    ...
                    Utilitario.Util_Log.Escribir_Log(" cardcode :" + sCardCode.ToString(), "frmProcesoLoteXML")
                    vPay.ApplyVAT = SAPbobsCOM.BoYesNoEnum.tYES
                    vPay.DocCurrency = "USD"
                    ...
                    'If _diaRT <= 8 And mesRT < mes Then
                    '    vPay.DocDate = oRetencion.RetCabecera._fechaEmision
                    'Else
                    '    vPay.DocDate = Date.Now
                    'End If

                    'se comento debido a que no sabemos si el cliente necesitara estas validaciones
                    ...
                    '    ElseIf Date.Now.Day <= 5 And FecEmiRet.Month < Date.Now.Month And FecAutRet.Month = Date.Now.Month And FecEmiFac.Month < Date.Now.Month Then
                    ...
                    '        If Date.Now.Day <= 5 And FecEmiRet.Year < Date.Now.Year And FecAutRet.Year = Date.Now.Year And FecEmiFac.Year < Date.Now.Year Then
                    '            vPay.DocDate = UltDiaFecha
                    '            fechaVencRtMP = UltDiaFecha
                    '        ElseIf FecEmiRet.Month < Date.Now.Year And FecAutRet.Year < Date.Now.Year And FecEmiFac.Year < Date.Now.Year Then
                    '            vPay.DocDate = UltDiaFecha 'Date.Now
                    '            fechaVencRtMP = UltDiaFecha
                    '        ElseIf Date.Now.Day <= 5 And FecEmiRet.Year = Date.Now.Year And FecAutRet.Year = Date.Now.Year And FecEmiFac.Year < Date.Now.Year Then
                    '            vPay.DocDate = UltDiaFecha
                    '            fechaVencRtMP = UltDiaFecha
                    '        Else
                    '            vPay.DocDate = Date.Now
                    ...
                    'vPay.Remarks = "RET" + " " + CLng(oRetencion.RetCabecera._secuencial).ToString + " " + "FAC" + " " + CLng(Right(oRetencion.RetDetalleImp(0)._numDocSustento, 9)).ToString

                    'vPay.Remarks = "RET" + " " + CLng(oRetencion.RetCabecera._secuencial).ToString + " " + "FAC" + " " + CLng(Right(oDetalle._numDocSustento, 9)).ToString
                    'vPay.JournalRemarks = "RET" + " " + CLng(oRetencion.RetCabecera._secuencial).ToString + " " + "FAC" + " " + CLng(Right(oRetencion.RetDetalleImp(0)._numDocSustento, 9)).ToString
                    ...
                    For Each oDetalle As RetDetalleImpuestos In oRetencion.RetDetalleImp
                        ...
                        If oDetalle._valorRetenido > 0 Then
                            ...
                            CrTypeCode = oFuncionesB1.getRSvalue(sQueryCrTypeCode, "CrTypeCode", "")
                            Dim TypeCode As Integer = CrTypeCode
                            Utilitario.Util_Log.Escribir_Log("Obteniendo CrTypeCode RENTA - QUERY: " + sQueryCrTypeCode + "Resultado :" + CrTypeCode.ToString(), "frmProcesoLoteXML")
                            If CrTypeCode = 0 Then
                                sQueryCrTypeCode = "select ""CrTypeCode"" from ""OCRP"" where ""CreditCard"" = '" & TypeCode & "'"
                                CrTypeCode = oFuncionesB1.getRSvalue(sQueryCrTypeCode, "CrTypeCode", "")
                                Utilitario.Util_Log.Escribir_Log("Obteniendo CrTypeCode (0) RENTA - QUERY: " + sQueryCrTypeCode + "Resultado :" + CrTypeCode.ToString(), "frmProcesoLoteXML")
                            End If
                            'vPay.CreditCards.CreditAcct = IIf(oDetalle._codigo = 1, IIf(CuentaRetencionRENTA = "", CuentaRetencion, CuentaRetencionRENTA), CuentaRetencion)
                            'vPay.CreditCards.CreditCard = IIf(oDetalle._codigo = 1, IIf(CodRetencionRENTA = "", CodRetencion, CodRetencionRENTA), CodRetencion)
                            'vPay.CreditCards.PaymentMethodCode = IIf(oDetalle._codigo = 1, IIf(CrTypeCodeRENTA = "", CrTypeCode, CrTypeCodeRENTA), CrTypeCode)
                            ...
                            Try
                                vPay.CreditCards.PaymentMethodCode = CrTypeCode 'IIf(oDetalle._codigo = 1, IIf(CrTypeCodeRENTA = "", CrTypeCode, CrTypeCodeRENTA), CrTypeCode)
                            Catch ex As Exception
                                Utilitario.Util_Log.Escribir_Log("CrTypeCode Asignado RENTA - QUERY: " + CrTypeCode.ToString(), "frmProcesoLoteXML")
                            End Try



                            vPay.CreditCards.CreditCardNumber = oRetencion.RetCabecera._secuencial
                            vPay.CreditCards.CreditSum = oDetalle._valorRetenido ' _oDocumento.TotalRetencion ' formatDecimal(_oDocumento.TotalRetencion.ToString())
                            ' vPay.CreditCards.CreditType = 1
                            vPay.CreditCards.FirstPaymentSum = oDetalle._baseImponible
                    ...
                    For Each oDetalle As RetDetalleImpuestos In oRetencion.RetDetalleImp
                        If Not IsNothing(oDetalle._numDocSustento) Then
                            ...
                            Dim _est As String = oDetalle._numDocSustento.Substring(0, 3).ToString
                            Dim _punEmi As String = oDetalle._numDocSustento.Substring(3, 3).ToString
                            Dim _folio As String = CLng(Right(oDetalle._numDocSustento, 9)).ToString
                            ...
                            If Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS Then
                                ...
                                If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                                    queryValorRT = " SELECT (""DocTotal""-""PaidToDate"") as SaldoPendiente from  OINV where ""CardCode""='" + sCardCode.ToString + "' and ""U_SER_EST""='" + _est + "' and ""U_SER_PE""='" + _punEmi + "' and cast(""FolioNum"" as varchar)='" + _folio + "'"
                                Else
                                    queryValorRT = " SELECT (DocTotal-PaidToDate) as SaldoPendiente from oinv where CardCode='" + sCardCode.ToString + "' and (U_SER_EST + U_SER_PE + cast(FolioNum as varchar))='" + _est + _punEmi + _folio + "' "
                                End If
                            ...
                            ElseIf Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.HEINSOHN Then
                                ...
                                If rCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_HANADB Then
                                    ...
                                    queryValorRT += " ""NNM1"" B ON A.""Series"" = B.""Series"" "
                                    queryValorRT += " WHERE A.""CardCode"" = '" + sCardCode + "'"
                                    queryValorRT += " AND B.""BeginStr"" = '" & oDetalle._numDocSustento.ToString().Substring(0, 3) & "'"
                                    queryValorRT += " AND B.""EndStr"" = '" & oDetalle._numDocSustento.ToString().Substring(3, 3) & "'"
                                    queryValorRT += " AND REPLACE(LTRIM(REPLACE(RIGHT(A.""DocNum"",7),'0',' ')),' ','0') =" & Integer.Parse(oDetalle._numDocSustento.Substring(6, 9))
                                    queryValorRT += " AND A.""DocStatus""='O' AND A.""CANCELED""='N' "
                                Else
                                    queryValorRT = " SELECT (DocTotal-PaidToDate) as SaldoPendiente "
                                    queryValorRT += " FROM OINV A INNER JOIN "
                            ...
                            Dim valorRT As String = oFuncionesAddon.getRSvalue(queryValorRT, "SaldoPendiente", "")
                            Utilitario.Util_Log.Escribir_Log("Obteniendo saldo pendiendte - QUERY: " + queryValorRT + "Resultado :" + valorRT.ToString(), "frmProcesoLoteXML")
                            valorFactura = CDec(valorRT)
                            numFac = oDetalle._numDocSustento.ToString()

                            If numFac = oDetalle._numDocSustento And numFac2 <> numFac Then
                                SvalorRetenidoR = 0
                            End If

                            SvalorRetenidoR += Convert.ToDouble(oDetalle._valorRetenido)
                            'If numFac2 = numFac Then
                            If SvalorRetenidoR > valorFactura Then

                                rsboApp.StatusBar.SetText(NombreAddon + " - El valor de la retencion recibida: " + SvalorRetenidoR.ToString() + " es mayor al valor pendiente: " + valorFactura.ToString + " de la factura " + oDetalle._numDocSustento.ToString(), SAPbouiCOM.BoMessageTime.bmt_Medium, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                                men = "El valor de la retencion recibida: " + SvalorRetenidoR.ToString() + " es mayor al valor pendiente: " + valorFactura.ToString + " de la factura " + oDetalle._numDocSustento.ToString + " del SN " + sCardCode.ToString
                                Return False
                            End If
                            ...
                            Try
                                ...
                                Utilitario.Util_Log.Escribir_Log("Query Factura Relacionada:" + sQueryFactura.ToString() + "-Resultado: " + Factura, "frmProcesoLoteXML")
                                If Factura = "" Then
                                    Factura = "0"
                                End If
                            Catch ex As Exception
                                Utilitario.Util_Log.Escribir_Log("Query Factura Relacionada:" + ex.Message().ToString() + "-QUERY: " + sQueryFactura, "frmProcesoLoteXML")
                            ...
                            Utilitario.Util_Log.Escribir_Log(String.Format("Query:{0}..DocEntry-Respuesta:{1}", sQueryFactura, Factura), "frmProcesoLoteXML")
                            If Not Factura = "0" Then
                                ...
                                Utilitario.Util_Log.Escribir_Log("Query Factura Relacionada:" + oDetalle._valorRetenido.ToString() + "-QUERY: " + sQueryFactura, "frmProcesoLoteXML")
                        ...
                        'Exit For
                        i += 1
                        numFac2 = oDetalle._numDocSustento.ToString()
                    Next



                    Try
                        Utilitario.Util_Log.Escribir_Log("Try FC Relacionada: " + Factura.ToString, "frmProcesoLoteXML")
                        If Not Factura = "0" Then
                            ...
                            Next
                        End If
                        Utilitario.Util_Log.Escribir_Log("Try Salida: " + Factura.ToString, "frmProcesoLoteXML")
                    Catch ex As Exception
                        Utilitario.Util_Log.Escribir_Log("Error Try fc relacionada: " + ex.ToString, "frmProcesoLoteXML")
                        men = ex.Message.ToString()
                    End Try
...
#Enable Warning BC42030 ' La variable 'ErrMsg' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
            ...
            Else
                ...
                men = "Ya existe un Medio de Pago registrado para la factura " + oRetencion.RetDetalleImp(0)._numDocSustento.ToString() + " , con numero de documento: " + _MedioPago.ToString
                Return False
            End If

            'Else
            '    rsboApp.StatusBar.SetText(NombreAddon + " - El valor de la retencion recibida: " + valorRetenido.ToString() + " es mayor al valor pendiente: " + _valorRT.ToString + " de la factura " + _numDocRetener.ToString, SAPbouiCOM.BoMessageTime.bmt_Medium, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            '    men = "El valor de la retencion recibida: " + valorRetenido.ToString() + " es mayor al valor pendiente: " + _valorRT.ToString + " de la factura " + _numDocRetener.ToString + " del SN " + sCardCode.ToString
            '    Return False
    ...
    Private Function ConvertToDouble(s As String) As Double
        ...
        Return result
    End Function
    Private Function CrearPagoRecibido_S(ByRef sCardCode As String, ByRef oRetencion As Retencion, ByRef sDocEntryPreliminar As String, DocEntryRERecibida_UDO As String) As Boolean
        Dim RetVal As Long
        Dim ErrCode As Long
        Dim ErrMsg As String
        Dim vPay As SAPbobsCOM.Payments
        Try
            ...
            Try
                vPay.UserFields.Fields.Item("U_SYP_PTSC").Value = oRetencion.RetCabecera._ptoEmi
            Catch ex As Exception
                vPay.UserFields.Fields.Item("U_BPP_PTSC").Value = oRetencion.RetCabecera._ptoEmi
                oFuncionesAddon.GuardaLOG("PRR", _ClaveAcceso, "Error: 1037 frmProcesoLoteXML " + ex.Message().ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            End Try
            Try
                vPay.UserFields.Fields.Item("U_SYP_SUCRET").Value = oRetencion.RetCabecera._estab
            Catch ex As Exception
                oFuncionesAddon.GuardaLOG("PRR", _ClaveAcceso, "Error: 1042 frmProcesoLoteXML " + ex.Message().ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            End Try
            Try
                vPay.UserFields.Fields.Item("U_SYP_PTCC").Value = oRetencion.RetCabecera._secuencial
            Catch ex As Exception
                vPay.UserFields.Fields.Item("U_BPP_PTCC").Value = oRetencion.RetCabecera._secuencial
                oFuncionesAddon.GuardaLOG("PRR", _ClaveAcceso, "Error: 1048 frmProcesoLoteXML " + ex.Message().ToString(), Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
            End Try


            If oFuncionesB1.checkCampoBD("ORCT", "SYP_FECHARET") Then
                Try
                    vPay.UserFields.Fields.Item("U_SYP_FECHARET").Value = oRetencion.RetCabecera._fechaEmision
                Catch ex As Exception
                End Try
            End If
            ...
            If oFuncionesB1.checkCampoBD("ORCT", "FX_AUTO_RETENCION") Then
                vPay.UserFields.Fields.Item("U_FX_AUTO_RETENCION").Value = oRetencion.RetCabecera._NumeroAutorizacion
            End If
            ...
            If CodRetencion = "" Then
                oFuncionesAddon.GuardaLOG("PRR", oRetencion.RetCabecera._claveAcceso, "ERROR - Revisar la configuracion en la opcion de parametrizaciones, debe tener registrado una Cuenta Contable Retención!", Functions.FuncionesAddon.Transacciones.CreacionPreliminar, Functions.FuncionesAddon.TipoLog.Recepcion)
                Elimina_DocumentoRecibido_RE(DocEntryRERecibida_UDO)
            ...
            If ValorIva > 0 Then
                ...
                vPay.TransferReference = "RTE " + oRetencion.RetCabecera._secuencial
            End If
...
#Enable Warning BC42030 ' La variable 'ErrMsg' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
    ...
    'Private Function CrearFacturaPremilinarServicio(ByVal sCardCode As String, ByVal ofactura As Factura, ByRef sDocEntryPreliminar As String, ByVal DocEntryFVRecibida_UDO As String) As Boolean
    ...
    '            'Dim CodImpV As SAPbobsCOM.Recordset = rsboApp.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
    '            Dim result As String
    '            For Each oDetalle As FacturaDetalle In ofactura.ENTDetalleFactura
...
#Disable Warning BC42024 ' Variable local sin usar: '_fila'.
            Dim _fila As Integer
#Enable Warning BC42024 ' Variable local sin usar: '_fila'.
...
#Enable Warning BC42030 ' La variable 'ErrMsg' se ha pasado como referencia antes de haberle asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
                                Dim odt2 As SAPbouiCOM.DataTable = rsboApp.Forms.Item("frmProcesoLoteXML").DataSources.DataTables.Item("dtDocs")
                                odt2.SetValue(14, ofila, "Error el procesar preliminar: " + ErrMsg)
                                'rsboApp.MessageBox(ErrCode & " " & ErrMsg)

                            Else
                                Try
                                    If ActualizadoEstadosUDO_RER(idDocumentoRecibido_UDO, "docFinal", sClaveAcceso) Then
                                        ...
                                        ofrmDocumentoREXML.ActualizadoEstadoUdoRetencionXML(idFacturaGS, "Contabilizado")
                                        ...
                                        Try ' SI ESTA OCULTO E FORMULARIO SE CAE
                                            If rsboApp.Forms.Item("frmProcesoLoteXML").Visible = True Then
                                                rsboApp.Forms.Item("frmProcesoLoteXML").Freeze(True)
                                                Dim odt As SAPbouiCOM.DataTable = rsboApp.Forms.Item("frmProcesoLoteXML").DataSources.DataTables.Item("dtDocs")
                                                odt.Rows.Remove(ofila)
                                                rsboApp.Forms.Item("frmProcesoLoteXML").Freeze(False)
                                            End If
                                        Catch ex As Exception
                                        End Try
                                    End If
    ...
    Public Function ActualizadoEstadosUDO_RER(ByRef DocEntryFacturaRecibida_UDO As String, Estado As String, ByVal sClaveAcceso As String) As Boolean
        ...
        Try
            ...
            oGeneralData.SetProperty("U_Estado", Estado)
            oGeneralData.SetProperty("U_FechaS", Integer.Parse(Date.Now.ToString("yyyyMMdd")))
            oGeneralData.SetProperty("U_Sincro", 1)
        ...
        Try
            ...
            If Cabfc.RecordCount > 0 Then
                ...
                While (Cabfc.EoF = False)
                    ...
                    If (Cabfc.Fields.Item("FechaAutorizacion").Value.ToString()) = "" Then
                        Factura.FacturaCabecera._FechaAutorizacion = Cabfc.Fields.Item("FechaEmision").Value.ToString()
                    Else
                        Factura.FacturaCabecera._FechaAutorizacion = Cabfc.Fields.Item("FechaAutorizacion").Value.ToString()
                    End If
                ...
                While (CabRT.EoF = False)
                    ...
                    If DetRT.RecordCount > 0 Then
                        ...
                        While (DetRT.EoF = False)
                            ...
                            RtDet._fechaEmisionDocSustento = DetRT.Fields.Item("FecEmiDocSus").Value.ToString()
