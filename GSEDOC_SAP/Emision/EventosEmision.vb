                        ...
                        ElseIf pVal.ItemUID = "btnAccion" And pVal.BeforeAction = True Then
                            ...
                            ElseIf btnAccion.Caption = "(GS) Ver XML" Or btnAccion.Caption = "(SS) Ver XML" Then
                                ...
                                Catch ex As Exception
                                    rSboApp.SetStatusBarMessage(NombreAddon + " - Existio un error: " + ex.Message.ToString(), SAPbouiCOM.BoMessageTime.bmt_Short, True)
                                End Try
                            ElseIf btnAccion.Caption = "(GS) Consultar AUT" Or btnAccion.Caption = "(SS) Consultar AUT" Then
                            ...
                            ElseIf btnAccion.Caption = "(GS) Reenviar SRI" Or btnAccion.Caption = "(SS) Reenviar SRI" Then
                                ...
                                If (FechaSalidaEnVivo = "") Or (FechaSalidaEnVivo <> "") Then
                                    ...
                                    End If
                                End If
                            ElseIf btnAccion.Caption = "(GS) Reenviar MAIL" Or btnAccion.Caption = "(SS) Reenviar MAIL" Then
                                mForm.Freeze(True)
                                Try
            ...
            ElseIf evento = "ACTUALIZAR" Then
                ...
                Try
                    If EsElectronico = "FE" Then
                        If UDFEA = "2" Then
                            If Functions.VariablesGlobales._ActApiSS = "Y" Then
                                btnAccion.ValidValues.Add("(SS) Ver RIDE", "(SS) Ver Ride")
                                btnAccion.ValidValues.Add("(SS) Ver XML", "(SS) Ver XML")
                                btnAccion.ValidValues.Add("(SS) Reenviar MAIL", "(SS) Reenviar Mail")
                                btnAccion.Select("(SS) Ver RIDE", SAPbouiCOM.BoSearchKey.psk_ByValue)
                        ...
                        ElseIf UDFEA = "5" Then
                            If Functions.VariablesGlobales._ActApiSS = "Y" Then
                                btnAccion.ValidValues.Add("(SS) Ver RIDE", "(SS) Ver Ride")
                                btnAccion.ValidValues.Add("(SS) Consultar AUT", "(SS) Cons. Autorizacion")
                                btnAccion.ValidValues.Add("(SS) Ver XML", "(SS) Ver XML")
                                'btnAccion.ValidValues.Add("(GS) Reenviar MAIL", "(GS) Reenviar Mail")
                                btnAccion.Select("(SS) Ver RIDE", SAPbouiCOM.BoSearchKey.psk_ByValue)
                                btnAccion.Item.Visible = True
                        ...
                        ElseIf UDFEA = "4" Then
                            If Functions.VariablesGlobales._ActApiSS = "Y" Then
                                btnAccion.ValidValues.Add("(SS) Reenviar SRI", "(SS) Reenviar SRI")
                                btnAccion.Select("(SS) Reenviar SRI", SAPbouiCOM.BoSearchKey.psk_ByValue)
                                btnAccion.Item.Visible = True
                                lbEstado.Item.ForeColor = RGB(204, 0, 0)
