    ...
    Private Sub CargaDatos()
        ...
        Try
            ...
            For i = 0 To odt.Rows.Count - 1
                ...
                ElseIf odt.GetValue("U_Nombre", i).ToString().Equals("APISS_EpND") Then
                    oUserDataSource = oForm.DataSources.UserDataSources.Item("EdP_Nd")
                    oUserDataSource.ValueEx = odt.GetValue("U_Valor", i).ToString()
                        ...
                        Select Case pVal.ItemUID
                            ...
                            Case "obtnGrabar"
                                ...
                                Try
                                    ...
                                    oUserDataSource = oForm.DataSources.UserDataSources.Item("EdP_Nd")
                                    olistaDetalleConfiguracion.Add(New Entidades.ConfiguracionDetalle("APISS_EpND", oUserDataSource.ValueEx.ToString()))
                                    Functions.VariablesGlobales._ApiFactEmiSS = oUserDataSource.ValueEx
