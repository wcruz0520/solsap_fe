...
Public Class frmAcercaDe
    ...
    Public Sub CargaFormularioAcercaDe()
        ...
        Dim Anio As String = DateAndTime.Today.Year.ToString
        Dim copyright As String = $"Copyright © {Anio} SOLSAP S.A."
