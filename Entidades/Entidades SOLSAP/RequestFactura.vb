...
Public Class infoFacturaFE
    ...
    Public Property reembolsos As List(Of reembolsoFE)
End Class
...
Public Class reembolsoFE
    ...
    Public Property detalleImpuestos As List(Of detImpReemFE)
End Class

Public Class detImpReemFE
    Public Property codigo As String
    Public Property codigoPorcentaje As String
