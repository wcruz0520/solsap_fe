...
Namespace wsEDoc_Retencion41
    ...
    Partial Public Class WSEDOCNUBE_RETENCIONES
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.Entidades.My.MySettings.Default.Entidades_wsEDoc_Retencion41_WSEDOC_RETENCIONES
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/IWSEDOCNUBE_RETENCIONES/EnviarRetencionSRI_XML", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function EnviarRetencionSRI_XML(ByVal Credencial As String, ByVal Entorno As String, <System.Xml.Serialization.XmlElementAttribute(DataType:="base64Binary")> ByVal Retencion() As Byte, ByRef mensaje As String) As RespuestaEDOC
            Dim results() As Object = Me.Invoke("EnviarRetencionSRI_XML", New Object() {Credencial, Entorno, Retencion, mensaje})
            mensaje = CType(results(1),String)
            Return CType(results(0),RespuestaEDOC)
        End Function
        
        '''<remarks/>
        Public Overloads Sub EnviarRetencionSRI_XMLAsync(ByVal Credencial As String, ByVal Entorno As String, ByVal Retencion() As Byte, ByVal mensaje As String)
            Me.EnviarRetencionSRI_XMLAsync(Credencial, Entorno, Retencion, mensaje, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub EnviarRetencionSRI_XMLAsync(ByVal Credencial As String, ByVal Entorno As String, ByVal Retencion() As Byte, ByVal mensaje As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("EnviarRetencionSRI_XML", New Object() {Credencial, Entorno, Retencion, mensaje}, Me.EnviarRetencionSRI_XMLOperationCompleted, userState)
        End Sub
