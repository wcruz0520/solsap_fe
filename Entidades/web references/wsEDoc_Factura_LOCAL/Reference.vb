...
'
Namespace wsEDoc_Factura_LOCAL
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9037.0"),  _
     ...
     System.Web.Services.WebServiceBindingAttribute(Name:="BasicHttpBinding_IWSEDOC_FACTURAS", [Namespace]:="http://tempuri.org/")>  _
    Partial Public Class WSEDOC_FACTURAS
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.Entidades.My.MySettings.Default.Entidades_wsEDoc_Factura_LOCAL_WSEDOC_FACTURAS
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/IWSEDOC_FACTURAS/EnviarFacturaSRI", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function EnviarFacturaSRI(ByVal clave As String, ByVal Entorno As String, ByRef Factura As ENTFactura, ByRef mensaje As String) As RespuestaEDOC
            Dim results() As Object = Me.Invoke("EnviarFacturaSRI", New Object() {clave, Entorno, Factura, mensaje})
            Factura = CType(results(1),ENTFactura)
            mensaje = CType(results(2),String)
            Return CType(results(0),RespuestaEDOC)
        End Function
        
        '''<remarks/>
        Public Overloads Sub EnviarFacturaSRIAsync(ByVal clave As String, ByVal Entorno As String, ByVal Factura As ENTFactura, ByVal mensaje As String)
            Me.EnviarFacturaSRIAsync(clave, Entorno, Factura, mensaje, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub EnviarFacturaSRIAsync(ByVal clave As String, ByVal Entorno As String, ByVal Factura As ENTFactura, ByVal mensaje As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("EnviarFacturaSRI", New Object() {clave, Entorno, Factura, mensaje}, Me.EnviarFacturaSRIOperationCompleted, userState)
        End Sub
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/IWSEDOC_FACTURAS/EnviarFacturaSRI_XML", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
    ...
    Partial Public Class EnviarFacturaSRICompletedEventArgs
        ...
        '''<remarks/>
        Public ReadOnly Property Factura() As ENTFactura
            Get
                Me.RaiseExceptionIfNecessary
                Return CType(Me.results(1),ENTFactura)
            End Get
        End Property
