...
'
Namespace wsEDoc_GuiaRemision41
    ...
    Partial Public Class WSEDOCNUBE_GUIAS_REMISION
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.Entidades.My.MySettings.Default.Entidades_wsEDoc_GuiaRemision41_WSEDOC_GUIAS_REMISION
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/IWSEDOCNUBE_GUIAS_REMISION/EnviarGuiaRemisionSRI_XML", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function EnviarGuiaRemisionSRI_XML(ByVal Credencial As String, ByVal Entorno As String, <System.Xml.Serialization.XmlElementAttribute(DataType:="base64Binary")> ByVal GuiaRemision() As Byte, ByRef mensaje As String) As RespuestaEDOC
            Dim results() As Object = Me.Invoke("EnviarGuiaRemisionSRI_XML", New Object() {Credencial, Entorno, GuiaRemision, mensaje})
            mensaje = CType(results(1),String)
            Return CType(results(0),RespuestaEDOC)
        End Function
        
        '''<remarks/>
        Public Overloads Sub EnviarGuiaRemisionSRI_XMLAsync(ByVal Credencial As String, ByVal Entorno As String, ByVal GuiaRemision() As Byte, ByVal mensaje As String)
            Me.EnviarGuiaRemisionSRI_XMLAsync(Credencial, Entorno, GuiaRemision, mensaje, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub EnviarGuiaRemisionSRI_XMLAsync(ByVal Credencial As String, ByVal Entorno As String, ByVal GuiaRemision() As Byte, ByVal mensaje As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("EnviarGuiaRemisionSRI_XML", New Object() {Credencial, Entorno, GuiaRemision, mensaje}, Me.EnviarGuiaRemisionSRI_XMLOperationCompleted, userState)
        End Sub
