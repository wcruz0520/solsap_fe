...
Public Class Servico_Ivend_Citikold
    ...
    Private Sub GETPArametros_INIT()
        ...
        'variables globales solsap - Willikiller
        Functions.VariablesGlobales._ActApiSS = ConsultaParametro("SAED", "PARAMETROS", "CONFIGURACION", "APISS") 'check activo api solsap
        Functions.VariablesGlobales._ApiAutSS = ConsultaParametro("SAED", "PARAMETROS", "CONFIGURACION", "APISS_EpAut") 'endp autenticacion
        Functions.VariablesGlobales._ApiAutUser = ConsultaParametro("SAED", "PARAMETROS", "CONFIGURACION", "APISS_User") 'usuario
    ...
    Private Sub trabajo_hilo_emision(objdr As List(Of DataRow))
        ...
        Try
            ...
            Dim oNegocioSolsap As Negocio.ManejoDeDocumentoSolsap = Nothing
            ...
            Try
                ...
                ElseIf Functions.VariablesGlobales._ActApiSS = "Y" Then
                    ...
                    oNegocioSolsap = New Negocio.ManejoDeDocumentoSolsap(oCompany, Nothing, "S", ConfigurationManager.AppSettings("Tipo_Pch_Sap"))
            ...
            For Each row As DataRow In objdr
                ...
                Try
                    If oDocumentoTraza.SRI_Code.ToString().Equals("01") Then ' FACTURA
                        ...
                        ElseIf Functions.VariablesGlobales._ActApiSS = "Y" Then
                            oDocumentoTraza.Oberva = oNegocioSolsap.ProcesaEnvioDocumento(oDocumentoTraza.DocEntry, "FCE")
                        Else
                    ...
                    ElseIf oDocumentoTraza.SRI_Code.ToString().Equals("05") Then ' NOTA DE DEBITO
                        ...
                        ElseIf Functions.VariablesGlobales._ActApiSS = "Y" Then
                            oDocumentoTraza.Oberva = oNegocioSolsap.ProcesaEnvioDocumento(oDocumentoTraza.DocEntry, "NDE")
                        Else
                    ...
                    ElseIf oDocumentoTraza.SRI_Code.ToString().Equals("04") Then ' NOTA DE CREDITO
                        ...
                        ElseIf Functions.VariablesGlobales._ActApiSS = "Y" Then
                            oDocumentoTraza.Oberva = oNegocioSolsap.ProcesaEnvioDocumento(oDocumentoTraza.DocEntry, "NCE")
                        Else
                    ...
                    ElseIf oDocumentoTraza.SRI_Code.ToString().Equals("07") Then
                        ...
                        ElseIf Functions.VariablesGlobales._ActApiSS = "Y" Then
                            oDocumentoTraza.Oberva = oNegocioSolsap.ProcesaEnvioDocumento(oDocumentoTraza.DocEntry, "REE")
                        Else
                    ...
                    ElseIf oDocumentoTraza.SRI_Code.ToString().Equals("03") Or oDocumentoTraza.DocSubType.ToString().Equals("41") Then
                        ...
                        ElseIf Functions.VariablesGlobales._ActApiSS = "Y" Then
                            oDocumentoTraza.Oberva = oNegocioSolsap.ProcesaEnvioDocumento(oDocumentoTraza.DocEntry, "LQE")
                        Else
        ...
        Try
            ...
            For Each row As DataRow In objdr
                ...
                Try
                    ...
                    ElseIf Functions.VariablesGlobales._ActApiSS = "Y" Then
                        oDocumentoTraza.Oberva = oNegocioSolsap.ProcesaEnvioDocumento(oDocumentoTraza.DocEntry, prefijoDLL, True)
                        modoSincro = "Webservices Sincro"
                    Else
