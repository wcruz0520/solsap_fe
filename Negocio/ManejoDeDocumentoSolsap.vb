...
Public Class ManejoDeDocumentoSolsap
    ...
    Private authManager As ApiAuthManager
    Private requestManager As ApiRequestManager
    Private facturaManager As FacturaManager
    ...
    Sub New(ByVal Company As SAPbobsCOM.Company, ByVal sboApp As SAPbouiCOM.Application, tipoManejo As String, ByVal ProveedorSAPBO As String)
        ...
        dbManager = New DatabaseQueryManager(rCompany, rsboApp, _tipoManejo, oFuncionesAddon)
        authManager = New ApiAuthManager(_tipoManejo, rsboApp, rCompany)
        requestManager = New ApiRequestManager(_tipoManejo, rsboApp, authManager)
        facturaManager = New FacturaManager(rCompany, rsboApp, _tipoManejo, oFuncionesAddon, dbManager, Me)
    End Sub
...
#Region "Consulta de Documentos"
    Public Function ConsultarFactura(ByVal TipoFactura As String, ByVal DocEntry As Integer) As Object
        Return facturaManager.ConsultarFactura(TipoFactura, DocEntry)
    End Function

    Public Function ObtenerTokenAutenticacion() As String
        Return authManager.ObtenerTokenAutenticacion()
    End Function

    Public Function EnviarFacturaSolsap(factura As Entidades.RequestFactura) As Entidades.ResponseDocuments
        Return requestManager.EnviarFacturaSolsap(factura)
    End Function

    Public Function EnviarNCSolsap(factura As Entidades.RequestFactura) As Entidades.ResponseDocuments
        Return requestManager.EnviarNCSolsap(factura)
    End Function

    Public Function ConsultaPDF(sClaveAcceso As String, tipoDoc As String) As Boolean
        Return requestManager.ConsultaPDF(sClaveAcceso, tipoDoc)
    End Function

    Public Function ConsultaXML(sClaveAcceso As String, tipoDoc As String) As Boolean
        Return requestManager.ConsultaXML(sClaveAcceso, tipoDoc)
    End Function
                ...
                If Not oObjeto Is Nothing Then
                    ...
                    If Not objetoRespuesta Is Nothing Then
                        ...
                        If _EstadoAutorizacion.ToString().Equals("2") Or _EstadoAutorizacion.ToString().Equals("AUTORIZADO") Then
                            ...
                            ResponseconsEst = ConsultarDoc(RequestconsEst)
...
#End Region
    ...
    Public Function ValidarCamposNulos(dataset As DataSet, numTabla As String) As Boolean
    ...
    Public Function ConsultarDoc(reqEstado As Entidades.RequestConsulta) As Entidades.ResponseConsulta
        ...
        Catch webEx As WebException
            ...
            If respErr IsNot Nothing Then
                ...
                End Using
            End If
            If _tipoManejo = "A" Then rsboApp.SetStatusBarMessage("Error consultar documento SRI: " & mensajeError, SAPbouiCOM.BoMessageTime.bmt_Short, True)
            Return Nothing

        Catch ex As Exception
            If _tipoManejo = "A" Then rsboApp.SetStatusBarMessage("Error consultar documento SRI: " & ex.Message, SAPbouiCOM.BoMessageTime.bmt_Short, True)
            Return Nothing
        End Try
    ...
    Public Function FormatearNumero(valor As Object) As String
