...
Public Class ManejoDeDocumentos
...
#Region "Consulta de Documentos"
    Public Function ConsultarFactura(ByVal TipoFactura As String, ByVal DocEntry As Integer, ByVal TipoWS As String) As Object
        Dim oFactura As Object = Nothing

        If TipoWS = "NUBE_4_1" Then
            oFactura = ConsultarFactura_NUBE_4_1(TipoFactura, DocEntry, TipoWS)
        Else
            oFactura = ConsultarFactura_LOCAL_NUBE(TipoFactura, DocEntry, TipoWS)
        End If

        Return oFactura

    End Function
    Public Function ConsultarFactura_LOCAL_NUBE(ByVal TipoFactura As String, ByVal DocEntry As Integer, ByVal TipoWS As String) As Object
        ...
        If TipoWS = "LOCAL" Then
            listaDetalle = New List(Of Entidades.wsEDoc_Factura_LOCAL.ENTDetalleFactura)
            listaDatosAdicional = New List(Of Entidades.wsEDoc_Factura_LOCAL.ENTDatoAdicionalFactura)
            FormasdePago = New List(Of Entidades.wsEDoc_Factura_LOCAL.ENTFacturaPagos)
        ElseIf TipoWS = "NUBE" Then
            listaDetalle = New List(Of Entidades.wsEDoc_Factura.ENTDetalleFactura)
            listaDatosAdicional = New List(Of Entidades.wsEDoc_Factura.ENTDatoAdicionalFactura)
            FormasdePago = New List(Of Entidades.wsEDoc_Factura.ENTFacturaPagos)
        End If
        ...
        Try
            ...
            Else
                If _Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS Then
                    SP = "GS_SAP_FE_ObtenerFacturadeVenta "
                ElseIf _Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.ONESOLUTIONS Then
                ...
                ElseIf _Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.TOPMANAGE Then
                    SP = "GS_SAP_FE_TM_OBTENERFACTURADEVENTA "
                End If
            ...
            If Not ds Is Nothing And Not ds.Tables.Count = 0 Then
                ...
                If TipoWS = "LOCAL" Then
                    oFactura = New Entidades.wsEDoc_Factura_LOCAL.ENTFactura
                Else
                    oFactura = New Entidades.wsEDoc_Factura.ENTFactura
                    ...
                    If i = 0 Then
                        Try
                            ...
                            For Each r As DataRow In ds.Tables(0).Rows
                                ...
                                'Validacion de la clave de Aceeso para evitar Documentos autorizados por
                                'clave de acceso que corresponde a otro documento al usar copiar/duplicar en SAP
                                ...
                                If Not r("AgenteRetencion") = "0" Then
                                    oFactura.AgenteRetencion = r("AgenteRetencion")
                                End If
                                ...
                                If Not r("ContribuyenteRimpe") = "0" Then
                                    oFactura.ContribuyenteRimpe = r("ContribuyenteRimpe")
                                End If
                                ...
                                If TipoWS = "LOCAL" Then
                                    lstimpfact = New List(Of Entidades.wsEDoc_Factura_LOCAL.ENTFacturaImpuesto)
                                Else
                                    lstimpfact = New List(Of Entidades.wsEDoc_Factura.ENTFacturaImpuesto)
                                End If

                                If r("Base12") <> 0 Then
                                    Dim impfaIVA As Object
                                    If TipoWS = "LOCAL" Then
                                        impfaIVA = New Entidades.wsEDoc_Factura_LOCAL.ENTFacturaImpuesto
                                    Else
                                        impfaIVA = New Entidades.wsEDoc_Factura.ENTFacturaImpuesto
                                    End If
                                    ...
                                    If r("DescuentoAdicional12") <> "0" Then
                                        impfaIVA.DescuentoAdicional = r("DescuentoAdicional12")
                                ...
                                If r("Base13") <> 0 Then
                                    ...
                                    If r("DescuentoAdicional13") <> "0" Then
                                        impfaIVA.DescuentoAdicional = r("DescuentoAdicional13")
                                        aplicadoDescuentoAdicional = True
                                    End If
                                    'End If
                                ...
                                If r("Base0") <> 0 Then
                                    ...
                                    If TipoWS = "LOCAL" Then
                                        impfaNOIVA = New Entidades.wsEDoc_Factura_LOCAL.ENTFacturaImpuesto
                                    Else
                                        impfaNOIVA = New Entidades.wsEDoc_Factura.ENTFacturaImpuesto
                                    End If
                                    ...
                                    If r("DescuentoAdicional0") <> "0" Then
                                        impfaNOIVA.DescuentoAdicional = r("DescuentoAdicional0")
                                        aplicadoDescuentoAdicional = True
                                    End If
                                    'End If
                                ...
                                If r("BaseNoi") <> 0 Then
                                    ...
                                    If r("DescuentoAdicionalNoi") <> "0" Then
                                        impfaNOIVA.DescuentoAdicional = r("DescuentoAdicionalNoi")
                                        aplicadoDescuentoAdicional = True
                                    End If
                                    'End If
                                ...
                                If r("BaseExen") <> 0 Then
                                    ...
                                    If r("DescuentoAdicionalExen") <> "0" Then
                                        impfaNOIVA.DescuentoAdicional = r("DescuentoAdicionalExen")
                                        aplicadoDescuentoAdicional = True
                                    End If
                                    'End If
                                ...
                                If r("BaseIce") <> 0 Then
                                    ...
                                    'impfaNOIVA.Valor = r("TotalIvaIce")
                                    ...
                                    'If aplicadoDescuentoAdicional = False Then
                                    If r("DescuentoAdicionalIce") <> "0" Then
                                        impfaNOIVA.DescuentoAdicional = r("DescuentoAdicionalIce")
                                        aplicadoDescuentoAdicional = True
                                    End If
                                    'End If
                                ...
                                If r("Base5") <> 0 Then
                                    ...
                                    If r("DescuentoAdicional5") <> "0" Then
                                        impfaNOIVA.DescuentoAdicional = r("DescuentoAdicional5")
                                        aplicadoDescuentoAdicional = True
                                    End If
                                    'End If
                                ...
                                If r("Base14") <> 0 Then
                                    ...
                                    If r("DescuentoAdicional14") <> "0" Then
                                        impfaNOIVA.DescuentoAdicional = r("DescuentoAdicional14")
                                        aplicadoDescuentoAdicional = True
                                    End If
                                    'End If
                                ...
                                If r("Base15") <> 0 Then
                                    ...
                                    If r("DescuentoAdicional15") <> "0" Then
                                        impfaNOIVA.DescuentoAdicional = r("DescuentoAdicional15")
                                        aplicadoDescuentoAdicional = True
                                    End If
                                    'End If
                    ...
                    ElseIf i = 1 Then
                        Try
                            For Each r As DataRow In ds.Tables(1).Rows
                                ...
                                If TipoWS = "LOCAL" Then
                                    itemDetalleFactura = New Entidades.wsEDoc_Factura_LOCAL.ENTDetalleFactura
                                Else
                                    itemDetalleFactura = New Entidades.wsEDoc_Factura.ENTDetalleFactura
                                End If
                                ...
                                If TipoWS = "LOCAL" Then
                                    listaDetalleDatoAdicional = New List(Of Entidades.wsEDoc_Factura_LOCAL.ENTDatoAdicionalDetalleFactura)
                                Else
                                    listaDetalleDatoAdicional = New List(Of Entidades.wsEDoc_Factura.ENTDatoAdicionalDetalleFactura)
                                End If
                                ...
                                If Not r("ConceptoAdicional1") = "0" Then
                                    ...
                                    If TipoWS = "LOCAL" Then
                                        itemDetalleDatoAdicional = New Entidades.wsEDoc_Factura_LOCAL.ENTDatoAdicionalDetalleFactura
                                    Else
                                        itemDetalleDatoAdicional = New Entidades.wsEDoc_Factura.ENTDatoAdicionalDetalleFactura
                                    End If
                                ...
                                If Not r("ConceptoAdicional2") = "0" Then
                                    ...
                                    If TipoWS = "LOCAL" Then
                                        itemDetalleDatoAdicional2 = New Entidades.wsEDoc_Factura_LOCAL.ENTDatoAdicionalDetalleFactura
                                    Else
                                        itemDetalleDatoAdicional2 = New Entidades.wsEDoc_Factura.ENTDatoAdicionalDetalleFactura
                                    End If
                                ...
                                If Not r("ConceptoAdicional3") = "0" Then
                                    ...
                                    If TipoWS = "LOCAL" Then
                                        itemDetalleDatoAdicional3 = New Entidades.wsEDoc_Factura_LOCAL.ENTDatoAdicionalDetalleFactura
                                    Else
                                        itemDetalleDatoAdicional3 = New Entidades.wsEDoc_Factura.ENTDatoAdicionalDetalleFactura
                                    End If
                                ...
                                If TipoWS = "LOCAL" Then
                                    lstimpdetalle = New List(Of Entidades.wsEDoc_Factura_LOCAL.ENTDetalleFacturaImpuesto)

                                Else
                                    lstimpdetalle = New List(Of Entidades.wsEDoc_Factura.ENTDetalleFacturaImpuesto)
                                ...
                                If r("TaxCodeAp") = "IVA_EXE" Then ' 0%
                                    If TipoWS = "LOCAL" Then
                                        ...
                                        impdetalleIVA = New Entidades.wsEDoc_Factura_LOCAL.ENTDetalleFacturaImpuesto
                                    Else

                                        impdetalleIVA = New Entidades.wsEDoc_Factura.ENTDetalleFacturaImpuesto
                                    End If
                                    'impdetalleIVA.Codigo = "2"
...
#Disable Warning BC42104 ' La variable 'listaDetalle' se usa antes de que se le haya asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
                                listaDetalle.Add(itemDetalleFactura)
#Enable Warning BC42104 ' La variable 'listaDetalle' se usa antes de que se le haya asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
                            Next
                    ...
                    ElseIf i = 2 Then
                        Try
                            For Each r As DataRow In ds.Tables(2).Rows
                                ...
                                If TipoWS = "LOCAL" Then
                                    itemDatoAdicionalFac = New Entidades.wsEDoc_Factura_LOCAL.ENTDatoAdicionalFactura
                                Else
                                    itemDatoAdicionalFac = New Entidades.wsEDoc_Factura.ENTDatoAdicionalFactura
                                End If

                                itemDatoAdicionalFac.Nombre = r("Concepto")
                                itemDatoAdicionalFac.Descripcion = r("Descripcion")
#Disable Warning BC42104 ' La variable 'listaDatosAdicional' se usa antes de que se le haya asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
                                listaDatosAdicional.Add(itemDatoAdicionalFac)
#Enable Warning BC42104 ' La variable 'listaDatosAdicional' se usa antes de que se le haya asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
                            Next
                    ...
                    ElseIf i = 3 Then
                        Try
                            ...
                            For Each r As DataRow In ds.Tables(3).Rows
                                Dim Pago As Object
                                If TipoWS = "LOCAL" Then
                                    Pago = New Entidades.wsEDoc_Factura_LOCAL.ENTFacturaPagos
                                Else
                                    Pago = New Entidades.wsEDoc_Factura.ENTFacturaPagos
                                End If
                                ...
                                End If
#Disable Warning BC42104 ' La variable 'FormasdePago' se usa antes de que se le haya asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
                                FormasdePago.Add(Pago)
#Enable Warning BC42104 ' La variable 'FormasdePago' se usa antes de que se le haya asignado un valor. Podría darse una excepción de referencia NULL en tiempo de ejecución.
                            Next
            ...
            Try
                ...
                Dim sRuta As String = sRutaCarpeta & oFactura.Secuencial.ToString() + oFactura.SecuencialERP.ToString() + ".xml"
                If System.IO.Directory.Exists(sRutaCarpeta) Then
                    ...
                    If TipoWS = "LOCAL" Then
                        x = New XmlSerializer(GetType(Entidades.wsEDoc_Factura_LOCAL.ENTFactura))
                    Else
                        x = New XmlSerializer(GetType(Entidades.wsEDoc_Factura.ENTFactura))
                    End If
        ...
        End Try
    End Function
    Public Function ConsultarFactura_NUBE_4_1(ByVal TipoFactura As String, ByVal DocEntry As Integer, ByVal TipoWS As String) As Object
        Dim oFactura As Entidades.wsEDoc_Factura41.ENTFactura = Nothing
        Dim listaDetalle As List(Of Entidades.wsEDoc_Factura41.ENTDetalleFactura)
        Dim listaDatosAdicional As List(Of Entidades.wsEDoc_Factura41.ENTDatoAdicionalFactura)
        Dim FormasdePago As List(Of Entidades.wsEDoc_Factura41.ENTFacturaPagos)

        'If TipoWS = "NUBE_4_1" Then
        listaDetalle = New List(Of Entidades.wsEDoc_Factura41.ENTDetalleFactura)
        listaDatosAdicional = New List(Of Entidades.wsEDoc_Factura41.ENTDatoAdicionalFactura)
        FormasdePago = New List(Of Entidades.wsEDoc_Factura41.ENTFacturaPagos)
        'End If
        ...
        Try
            ...
            If Not ds Is Nothing And Not ds.Tables.Count = 0 Then
                ...
                oFactura = New Entidades.wsEDoc_Factura41.ENTFactura
                ...
                For i As Integer = 0 To ds.Tables.Count - 1
                            ...
                            For Each r As DataRow In ds.Tables(0).Rows
                                ...
                                Try
                                    ...
                                    Else
                                        oFactura.Tipo = r("TipoFactura")
                                    End If
                                    'oFuncionesAddon.GuardaLOG(TipoFactura, DocEntry, "Inicia cabecera", Functions.FuncionesAddon.Transacciones.Creacion, Functions.FuncionesAddon.TipoLog.Emision)
                                    Utilitario.Util_Log.Escribir_Log(" (0.- Normal, 1.- Exportadores, 2.- Reembolsos)", "ManejoDeDocumentos")
                                    Utilitario.Util_Log.Escribir_Log("Tipo Factura : " & oFactura.Tipo.ToString(), "ManejoDeDocumentos")
                                Catch ex As Exception
                                    Utilitario.Util_Log.Escribir_Log("Error: " + ex.Message.ToString(), "ManejoDeDocumentos")
                                ...
                                If Not r("NombreComercial") = "" Then
                                    oFactura.NombreComercial = r("NombreComercial")
                                End If
                                ' oFuncionesAddon.GuardaLOG(TipoFactura, DocEntry, "NombreComercial", Functions.FuncionesAddon.Transacciones.Creacion, Functions.FuncionesAddon.TipoLog.Emision)
                                Utilitario.Util_Log.Escribir_Log("NombreComercial: " + oFactura.NombreComercial.ToString, "ManejoDeDocumentos")
                                oFactura.Ruc = r("RUC")
                                'oFactura.Ruc = "0992737964001"
                                'oFuncionesAddon.GuardaLOG(TipoFactura, DocEntry, "RUC", Functions.FuncionesAddon.Transacciones.Creacion, Functions.FuncionesAddon.TipoLog.Emision)
                                oFactura.CodigoDocumento = r("CodigoDocumento")
                                oFactura.Establecimiento = r("Establecimiento")
                                oFactura.PuntoEmision = r("PuntoEmision")
                                oFactura.Secuencial = r("SecuencialDocumento")
                                ...
                                End If
                                Utilitario.Util_Log.Escribir_Log("oFactura.Secuencial : " & oFactura.Secuencial.ToString(), "ManejoDeDocumentos")
                                'oFuncionesAddon.GuardaLOG(TipoFactura, DocEntry, "Secuencial", Functions.FuncionesAddon.Transacciones.Creacion, Functions.FuncionesAddon.TipoLog.Emision)
                                oFactura.DireccionMatriz = r("DireccionMatriz")
                                Try
                                    oFactura.FechaEmision = CDate(r("FechaEmision")).ToString("yyyy-MM-dd")
                                ...
                                'oFactura.FechaEmision = r("FechaEmision")
                                oFactura.DireccionEstablecimiento = r("DireccionEstablecimiento")
                                'oFuncionesAddon.GuardaLOG(TipoFactura, DocEntry, "DireccionEstablecimiento", Functions.FuncionesAddon.Transacciones.Creacion, Functions.FuncionesAddon.TipoLog.Emision)
                                If Not r("ContribuyenteEspecial") = "0" Then
                                    oFactura.ContribuyenteEspecial = r("ContribuyenteEspecial")
                                Else
                                    oFactura.ContribuyenteEspecial = Nothing
                                End If
                                'oFuncionesAddon.GuardaLOG(TipoFactura, DocEntry, "ObligadoContabilidad", Functions.FuncionesAddon.Transacciones.Creacion, Functions.FuncionesAddon.TipoLog.Emision)
                                oFactura.ObligadoContabilidad = r("ObligadoContabilidad")
                                If Not r("GuiaRemision") = "0" Then
                                    oFactura.GuiaRemision = r("GuiaRemision")
                                End If
                                ...
                                If Not r("ContribuyenteRimpe") = "0" Then
                                    oFactura.ContribuyenteRimpe = Convert.ToBoolean(r("ContribuyenteRimpe"))
                                End If
                                ...
                                oFactura.RazonSocialComprador = r("RazonSocialComprador")
                                oFactura.IdentificacionComprador = r("IdentificacionComprador")
                                'oFuncionesAddon.GuardaLOG(TipoFactura, DocEntry, "IdentificacionComprador", Functions.FuncionesAddon.Transacciones.Creacion, Functions.FuncionesAddon.TipoLog.Emision)
                                Try
                                    If Not r("DirComprador") = "" Then
                                        oFactura.DirComprador = r("DirComprador")
                                    End If
                                ...
                                oFactura.Campo2 = r("Campo2")
                                oFactura.Campo3 = r("Campo3")
                                oFactura.Campo4 = r("Campo4")
                                oFactura.Campo5 = r("Campo5")
                                oFactura.Campo6 = r("Campo6")
                                oFactura.Campo7 = r("Campo7")
                                oFactura.Campo8 = r("Campo8")
                                oFactura.Campo9 = r("Campo9")
                                oFactura.Campo10 = r("Campo10")
                                'new DM 08012025
                                oFactura.Campo10 = r("Campo10")
                                oFactura.Campo11 = r("Campo11")
                                oFactura.Campo12 = r("Campo12")
                                oFactura.Campo13 = r("Campo13")
                                oFactura.Campo14 = r("Campo14")
                                oFactura.Campo15 = r("Campo15")

                                'IMPUESTO FACTURA
                                'Impuestos totalizados en la factura.
                                Dim lstimpfact As Object
                                lstimpfact = New List(Of Entidades.wsEDoc_Factura41.ENTFacturaImpuesto)

                                If r("Base8") <> 0 Then
                                    Dim impfaIVA As Object
                                    impfaIVA = New Entidades.wsEDoc_Factura41.ENTFacturaImpuesto
                                    ...
                                    If r("DescuentoAdicional8") <> "0" Then
                                        impfaIVA.DescuentoAdicional = r("DescuentoAdicional8")
                                        aplicadoDescuentoAdicional = True
                                    End If
                                ...
                                If r("Base12") <> 0 Then
                                    ...
                                    lstimpfact.Add(impfaIVA)
                                End If
                                'oFuncionesAddon.GuardaLOG(TipoFactura, DocEntry, "Base12", Functions.FuncionesAddon.Transacciones.Creacion, Functions.FuncionesAddon.TipoLog.Emision)
                                If r("Base13") <> 0 Then
                                    Dim impfaIVA As Object
                                    impfaIVA = New Entidades.wsEDoc_Factura41.ENTFacturaImpuesto
                                ...
                                If r("Base0") <> 0 Then
                                    ...
                                    Dim impfaNOIVA As Object
                                    impfaNOIVA = New Entidades.wsEDoc_Factura41.ENTFacturaImpuesto
                                ...
                                ' oFuncionesAddon.GuardaLOG(TipoFactura, DocEntry, "Termina cabecera", Functions.FuncionesAddon.Transacciones.Creacion, Functions.FuncionesAddon.TipoLog.Emision)
                                oFactura.ENTFacturaImpuesto = lstimpfact.ToArray
                            Next
                        Catch ex As Exception
                            If _tipoManejo = "A" Then
                    ...
                    ElseIf i = 1 Then
                        Try
                            For Each r As DataRow In ds.Tables(1).Rows
                                ...
                                Dim itemDetalleFactura As Object
                                itemDetalleFactura = New Entidades.wsEDoc_Factura41.ENTDetalleFactura
                                ...
                                ''Datos adicionales de cada detalle del item                                     
                                Dim listaDetalleDatoAdicional As Object
                                listaDetalleDatoAdicional = New List(Of Entidades.wsEDoc_Factura41.ENTDatoAdicionalDetalleFactura)
                                'Adicional1
                                If Not r("ConceptoAdicional1") = "0" Then
                                    Dim itemDetalleDatoAdicional As Object
                                    itemDetalleDatoAdicional = New Entidades.wsEDoc_Factura41.ENTDatoAdicionalDetalleFactura
                                    itemDetalleDatoAdicional.Nombre = r("ConceptoAdicional1")
                                    itemDetalleDatoAdicional.Descripcion = r("NombreAdicional1")
                                    listaDetalleDatoAdicional.Add(itemDetalleDatoAdicional)
                                End If
                                ...
                                If Not r("ConceptoAdicional2") = "0" Then
                                    ...
                                    itemDetalleDatoAdicional2 = New Entidades.wsEDoc_Factura41.ENTDatoAdicionalDetalleFactura
                                    itemDetalleDatoAdicional2.Nombre = r("ConceptoAdicional2")
                                    itemDetalleDatoAdicional2.Descripcion = r("NombreAdicional2")
                                    listaDetalleDatoAdicional.Add(itemDetalleDatoAdicional2)
                                End If
                                ...
                                If Not r("ConceptoAdicional3") = "0" Then
                                    Dim itemDetalleDatoAdicional3 As Object
                                    itemDetalleDatoAdicional3 = New Entidades.wsEDoc_Factura41.ENTDatoAdicionalDetalleFactura
                                    itemDetalleDatoAdicional3.Nombre = r("ConceptoAdicional3")
                                    itemDetalleDatoAdicional3.Descripcion = r("NombreAdicional3")
                                    listaDetalleDatoAdicional.Add(itemDetalleDatoAdicional3)
                                End If
                                ...
                                lstimpdetalle = New List(Of Entidades.wsEDoc_Factura41.ENTDetalleFacturaImpuesto)
                                'impdetalleIVA = New Entidades.wsEDoc_Factura41.ENTDetalleFacturaImpuesto
                            ...
                            'oFuncionesAddon.GuardaLOG(TipoFactura, DocEntry, "Termina detalle", Functions.FuncionesAddon.Transacciones.Creacion, Functions.FuncionesAddon.TipoLog.Emision)
                            oFactura.ENTDetalleFactura = listaDetalle.ToArray
                        Catch ex As Exception
                            If _tipoManejo = "A" Then
                                rsboApp.SetStatusBarMessage("DETALLE: " & ex.Message().ToString(), SAPbouiCOM.BoMessageTime.bmt_Short, True)
                    ...
                    ElseIf i = 2 Then
                        Try
                            For Each r As DataRow In ds.Tables(2).Rows
                                Dim itemDatoAdicionalFac As Object
                                itemDatoAdicionalFac = New Entidades.wsEDoc_Factura41.ENTDatoAdicionalFactura
                            ...
                            'oFuncionesAddon.GuardaLOG(TipoFactura, DocEntry, "Termina campos adicionale", Functions.FuncionesAddon.Transacciones.Creacion, Functions.FuncionesAddon.TipoLog.Emision)
                            oFactura.ENTDatoAdicionalFactura = listaDatosAdicional.ToArray
                        Catch ex As Exception
                            If _tipoManejo = "A" Then
                                rsboApp.SetStatusBarMessage("Cabecera Campo Adicional: " & ex.Message().ToString(), SAPbouiCOM.BoMessageTime.bmt_Short, True)
                    ...
                    ElseIf i = 3 Then
                        Try
                            ...
                            For Each r As DataRow In ds.Tables(3).Rows
                                Dim Pago As Object
                                Pago = New Entidades.wsEDoc_Factura41.ENTFacturaPagos
                            ...
                            'oFuncionesAddon.GuardaLOG(TipoFactura, DocEntry, "Termina forma de pago", Functions.FuncionesAddon.Transacciones.Creacion, Functions.FuncionesAddon.TipoLog.Emision)
                            oFactura.ENTFacturaPagos = FormasdePago.ToArray
                        Catch ex As Exception
                            If _tipoManejo = "A" Then
                                rsboApp.SetStatusBarMessage("Forma de Pago : " & ex.Message().ToString(), SAPbouiCOM.BoMessageTime.bmt_Short, True)
            ...
            Try
                ...
                If System.IO.Directory.Exists(sRutaCarpeta) Then
                    Utilitario.Util_Log.Escribir_Log("Serializando...", "ManejoDeDocumentos")
                    If TipoWS = "NUBE_4_1" Then
                        Dim x As XmlSerializer = New XmlSerializer(GetType(Entidades.wsEDoc_Factura41.ENTFactura))
                        Dim writer As TextWriter = New StreamWriter(sRuta)
                        x.Serialize(writer, oFactura)
                        writer.Close()
                        Utilitario.Util_Log.Escribir_Log("Serializado..." + sRuta, "ManejoDeDocumentos")
                    Else
                        Dim x As XmlSerializer = New XmlSerializer(GetType(Entidades.wsEDoc_Factura.ENTFactura))
                        Dim writer As TextWriter = New StreamWriter(sRuta)
                        x.Serialize(writer, oFactura)
                        writer.Close()
                        Utilitario.Util_Log.Escribir_Log("Serializado..." + sRuta, "ManejoDeDocumentos")
    ...
    Public Function ConsultarNotadeCredito(ByVal TipoNC As String, ByVal DocEntry As Integer, ByVal TipoWS As String) As Object

        Dim oNotaCredito As Object = Nothing
        If TipoWS = "NUBE_4_1" Then
            oNotaCredito = ConsultarNotadeCredito_NUBE_4_1(TipoNC, DocEntry, TipoWS)
        Else
            oNotaCredito = ConsultarNotadeCredito_LOCAL_NUBE(TipoNC, DocEntry, TipoWS)
        End If

        Return oNotaCredito

    End Function
    Public Function ConsultarNotadeCredito_LOCAL_NUBE(ByVal TipoNC As String, ByVal DocEntry As Integer, ByVal TipoWS As String) As Object

        Dim oNotaCredito As Object = Nothing
        Dim listaDetalle As Object
        Dim listaDatosAdicional As Object
        If TipoWS = "LOCAL" Then
            listaDetalle = New List(Of Entidades.wsEDoc_NotaDeCredito_LOCAL.ENTDetalleNotaCredito)
            listaDatosAdicional = New List(Of Entidades.wsEDoc_NotaDeCredito_LOCAL.ENTDatoAdicionalNotaCredito)
        Else
            listaDetalle = New List(Of Entidades.wsEDoc_NotaDeCredito.ENTDetalleNotaCredito)
            listaDatosAdicional = New List(Of Entidades.wsEDoc_NotaDeCredito.ENTDatoAdicionalNotaCredito)
        End If
        ...
        Try
            If _Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS Then
                SP = "GS_SAP_FE_ObtenerNotaDeCredito "
            ElseIf _Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.ONESOLUTIONS Then
                SP = "GS_SAP_FE_ONE_OBTENERNOTADECREDITO "
            ElseIf _Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.HEINSOHN Then
                SP = "GS_SAP_FE_HEI_OBTENERNOTADECREDITO "
            ElseIf _Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.SYPSOFT Then
                SP = "GS_SAP_FE_SYP_OBTENERNOTADECREDITO "
            ElseIf _Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.TOPMANAGE Then
                SP = "GS_SAP_FE_TM_OBTENERNOTADECREDITO "
            End If
            ...
            If Not ds Is Nothing And Not ds.Tables.Count = 0 Then
                If TipoWS = "LOCAL" Then
                    oNotaCredito = New Entidades.wsEDoc_NotaDeCredito_LOCAL.ENTNotaCredito
                Else
                    oNotaCredito = New Entidades.wsEDoc_NotaDeCredito.ENTNotaCredito
                End If
                ...
                For i As Integer = 0 To ds.Tables.Count - 1
                    If i = 0 Then
                        For Each r As DataRow In ds.Tables(0).Rows
                            ...
                            If Not r("ContribuyenteRimpe") = "0" Then
                                oNotaCredito.ContribuyenteRimpe = r("ContribuyenteRimpe")
                            End If
                            ...
                            ' oNotaCredito.TotalDescuento = r("TotalDescuento")

                            '   oNotaCredito.Propina = r("Propina")
                            ...
                            'oNotaCredito.Estado = r("Telefono")
                            'oNotaCredito. = r("Telefono2")
                            ...
                            Dim lstimpfact As Object
                            If TipoWS = "LOCAL" Then
                                lstimpfact = New List(Of Entidades.wsEDoc_NotaDeCredito_LOCAL.ENTNotaCreditoImpuesto)
                            Else
                                lstimpfact = New List(Of Entidades.wsEDoc_NotaDeCredito.ENTNotaCreditoImpuesto)
                            End If

                            If r("Base12") <> 0 Then
                                Dim impfaIVA As Object
                                If TipoWS = "LOCAL" Then
                                    impfaIVA = New Entidades.wsEDoc_NotaDeCredito_LOCAL.ENTNotaCreditoImpuesto
                                Else
                                    impfaIVA = New Entidades.wsEDoc_NotaDeCredito.ENTNotaCreditoImpuesto
                                End If
                                'impfaIVA.Codigo = "2"
                                'impfaIVA.CodigoPorcentaje = "2"
                                'impfaIVA.Tarifa = "12"
                            ...
                            If r("Base0") <> 0 Then
                                Dim impfaNOIVA As Object
                                If TipoWS = "LOCAL" Then
                                    impfaNOIVA = New Entidades.wsEDoc_NotaDeCredito_LOCAL.ENTNotaCreditoImpuesto
                                Else
                                    impfaNOIVA = New Entidades.wsEDoc_NotaDeCredito.ENTNotaCreditoImpuesto
                                End If
                                'impfaNOIVA.Codigo = "2"
                                'impfaNOIVA.CodigoPorcentaje = "0"
                                'impfaNOIVA.Tarifa = "0"
                    ...
                    ElseIf i = 1 Then
                        For Each r As DataRow In ds.Tables(1).Rows
                            Dim itemDetalleNC As Object
                            If TipoWS = "LOCAL" Then
                                itemDetalleNC = New Entidades.wsEDoc_NotaDeCredito_LOCAL.ENTDetalleNotaCredito
                            Else
                                itemDetalleNC = New Entidades.wsEDoc_NotaDeCredito.ENTDetalleNotaCredito
                            End If
                            ...
                            Else
                                ...
                                Dim listaDetalleDatoAdicional As Object
                                If TipoWS = "LOCAL" Then
                                    listaDetalleDatoAdicional = New List(Of Entidades.wsEDoc_NotaDeCredito_LOCAL.ENTDatoAdicionalDetalleNotaCredito)
                                Else
                                    listaDetalleDatoAdicional = New List(Of Entidades.wsEDoc_NotaDeCredito.ENTDatoAdicionalDetalleNotaCredito)
                                End If
                                ...
                                If Not r("ConceptoAdicional1") = "0" Then
                                    Dim itemDetalleDatoAdicional As Object
                                    If TipoWS = "LOCAL" Then
                                        itemDetalleDatoAdicional = New Entidades.wsEDoc_NotaDeCredito_LOCAL.ENTDatoAdicionalDetalleNotaCredito
                                    Else
                                        itemDetalleDatoAdicional = New Entidades.wsEDoc_NotaDeCredito.ENTDatoAdicionalDetalleNotaCredito
                                    End If
                                    itemDetalleDatoAdicional.Nombre = r("ConceptoAdicional1")
                                    itemDetalleDatoAdicional.Descripcion = r("NombreAdicional1")
                                    listaDetalleDatoAdicional.Add(itemDetalleDatoAdicional)
                                ...
                                If Not r("ConceptoAdicional2") = "0" Then
                                    Dim itemDetalleDatoAdicional2 As Object
                                    If TipoWS = "LOCAL" Then
                                        itemDetalleDatoAdicional2 = New Entidades.wsEDoc_NotaDeCredito_LOCAL.ENTDatoAdicionalDetalleNotaCredito
                                    Else
                                        itemDetalleDatoAdicional2 = New Entidades.wsEDoc_NotaDeCredito.ENTDatoAdicionalDetalleNotaCredito
                                    End If
                                    itemDetalleDatoAdicional2.Nombre = r("ConceptoAdicional2")
                                    itemDetalleDatoAdicional2.Descripcion = r("NombreAdicional2")
                                    listaDetalleDatoAdicional.Add(itemDetalleDatoAdicional2)
                                ...
                                If Not r("ConceptoAdicional3") = "0" Then
                                    Dim itemDetalleDatoAdicional3 As Object
                                    If TipoWS = "LOCAL" Then
                                        itemDetalleDatoAdicional3 = New Entidades.wsEDoc_NotaDeCredito_LOCAL.ENTDatoAdicionalDetalleNotaCredito
                                    Else
                                        itemDetalleDatoAdicional3 = New Entidades.wsEDoc_NotaDeCredito.ENTDatoAdicionalDetalleNotaCredito
                                    End If
                                    itemDetalleDatoAdicional3.Nombre = r("ConceptoAdicional3")
                                    itemDetalleDatoAdicional3.Descripcion = r("NombreAdicional3")
                                    listaDetalleDatoAdicional.Add(itemDetalleDatoAdicional3)
                            ...
                            Dim impdetalleIVA As Object
                            If TipoWS = "LOCAL" Then
                                lstimpdetalle = New List(Of Entidades.wsEDoc_NotaDeCredito_LOCAL.ENTDetalleNotaCreditoImpuesto)

                            Else
                                lstimpdetalle = New List(Of Entidades.wsEDoc_NotaDeCredito.ENTDetalleNotaCreditoImpuesto)
                            ...
                            If r("TaxCodeAp") = "IVA_EXE" Then ' 0%
                                If TipoWS = "LOCAL" Then
                                    ...
                                    impdetalleIVA = New Entidades.wsEDoc_NotaDeCredito_LOCAL.ENTDetalleNotaCreditoImpuesto
                                Else

                                    impdetalleIVA = New Entidades.wsEDoc_NotaDeCredito.ENTDetalleNotaCreditoImpuesto
                                End If
                                impdetalleIVA.Codigo = r("Codigo")
                                impdetalleIVA.CodigoPorcentaje = r("CodigoPorcentaje")
                                impdetalleIVA.Tarifa = r("Tarifa")
                    ...
                    ElseIf i = 2 Then
                        For Each r As DataRow In ds.Tables(2).Rows
                            Dim itemDatoAdicionalFac As Object
                            If TipoWS = "LOCAL" Then
                                itemDatoAdicionalFac = New Entidades.wsEDoc_NotaDeCredito_LOCAL.ENTDatoAdicionalNotaCredito
                            Else
                                itemDatoAdicionalFac = New Entidades.wsEDoc_NotaDeCredito.ENTDatoAdicionalNotaCredito
                            End If
                            itemDatoAdicionalFac.Nombre = r("Concepto")
                            itemDatoAdicionalFac.Descripcion = r("Descripcion")
                            listaDatosAdicional.Add(itemDatoAdicionalFac)
            ...
            Try
                Dim sRutaCarpeta As String = AppDomain.CurrentDomain.SetupInformation.ApplicationBase & "LOG\"
                Dim sRuta As String = sRutaCarpeta & oNotaCredito.Secuencial.ToString() + oNotaCredito.SecuencialERP.ToString() + ".xml"
                If System.IO.Directory.Exists(sRutaCarpeta) Then
                    Utilitario.Util_Log.Escribir_Log("Serializando...", "ManejoDeDocumentos")
                    ...
                    If TipoWS = "LOCAL" Then
                        x = New XmlSerializer(GetType(Entidades.wsEDoc_NotaDeCredito_LOCAL.ENTNotaCredito))
                    Else
                        x = New XmlSerializer(GetType(Entidades.wsEDoc_NotaDeCredito.ENTNotaCredito))
                    End If

                    Dim writer As TextWriter = New StreamWriter(sRuta)
                    x.Serialize(writer, oNotaCredito)
                    writer.Close()
                    Utilitario.Util_Log.Escribir_Log("Serializado..." + sRuta, "ManejoDeDocumentos")
                End If
        ...
        End Try
    End Function
    Public Function ConsultarNotadeCredito_NUBE_4_1(ByVal TipoNC As String, ByVal DocEntry As Integer, ByVal TipoWS As String) As Object
        ...
        Try
            ...
            Try
                ...
                If System.IO.Directory.Exists(sRutaCarpeta) Then
                    Utilitario.Util_Log.Escribir_Log("Serializando...", "ManejoDeDocumentos")
                    If TipoWS = "NUBE_4_1" Then
                        Dim x As XmlSerializer = New XmlSerializer(oNotaCredito.GetType)
                        Dim writer As TextWriter = New StreamWriter(sRuta)
                        x.Serialize(writer, oNotaCredito)
                        writer.Close()
                        Utilitario.Util_Log.Escribir_Log("Serializado..." + sRuta, "ManejoDeDocumentos")
    ...
    Public Function ConsultarRetencion(ByVal TipoRE As String, ByVal DocEntry As Integer, ByVal TipoWS As String) As Object
        Dim oRetencion As Object = Nothing

        If TipoWS = "NUBE_4_1" Then
            oRetencion = ConsultarRetencion_NUBE_4_1(TipoRE, DocEntry, TipoWS)
        Else
            oRetencion = ConsultarRetencion_LOCAL_NUBE(TipoRE, DocEntry, TipoWS)
        End If

        Return oRetencion
    End Function

    Public Function ConsultarRetencion_LOCAL_NUBE(ByVal TipoRE As String, ByVal DocEntry As Integer, ByVal TipoWS As String) As Object

        Dim oRetencion As Object = Nothing
        Dim lstimpfact As Object
        Dim listaDatosAdicional As Object
        Dim listaRetDocSusRet As Object = Nothing

        Dim listaRetPago As New List(Of Entidades.wsEDoc_Retencion_LOCAL.ENTRetencionDocSustentoPago)
        Dim listaRetDocSus As New List(Of Entidades.wsEDoc_Retencion_LOCAL.ENTRetencionDocSustento)
        listaRetDocSusRet = New List(Of Entidades.wsEDoc_Retencion_LOCAL.ENTRetencionDocSustentoRetencion)

        Dim ListoRetencionDocSustentoReem As New List(Of Entidades.wsEDoc_Retencion_LOCAL.ENTRetencionDocSustentoReembolso)

        If TipoWS = "LOCAL" Then
            lstimpfact = New List(Of Entidades.wsEDoc_Retencion_LOCAL.ENTRetencionDocSustento)
            listaDatosAdicional = New List(Of Entidades.wsEDoc_Retencion_LOCAL.ENTDatoAdicionalRetencion)


        Else
            lstimpfact = New List(Of Entidades.wsEDoc_Retencion.ENTDetalleRetencion)
            listaDatosAdicional = New List(Of Entidades.wsEDoc_Retencion.ENTDatoAdicionalRetencion)
        End If

        Dim oRetencionDocSustento As New Entidades.wsEDoc_Retencion_LOCAL.ENTRetencionDocSustento
        ...
        Try
            ...
            If _Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.EXXIS Then
                If TipoRE = "RDM" Then
                    SP = "GS_SAP_FE_ObtenerRetencionNotaDebito"
                ...
                End If
                If TipoRE = "REA" Then
                    SP = "GS_SAP_FE_ObtenerRetencionAnticipo"
                ...
                Else
                    ...
                    Catch ex As Exception
                        ...
                        oFuncionesAddon.GuardaLOG(TipoRE, DocEntry, "Consultando Retención con # DocEntry = " + ex.ToString() + ", SP: " + SP.ToString(), Functions.FuncionesAddon.Transacciones.Creacion, Functions.FuncionesAddon.TipoLog.Emision)
            ...
            ElseIf _Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.ONESOLUTIONS Then
                If TipoRE = "REA" Then
                    SP = "GS_SAP_FE_ONE_OBTENERRETENCIONANTICIPO"

                    oFuncionesAddon.GuardaLOG(TipoRE, DocEntry, "Consultando Retención con # DocEntry = " + DocEntry.ToString() + ", SP: " + SP.ToString(), Functions.FuncionesAddon.Transacciones.Creacion, Functions.FuncionesAddon.TipoLog.Emision)


                Else
                    SP = "GS_SAP_FE_ONE_OBTENERRETENCION"
            ...
            ElseIf _Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.HEINSOHN Then
                If TipoRE = "REA" Then
                    SP = "GS_SAP_FE_HEI_OBTENERRETENCIONANTICIPO"

                    oFuncionesAddon.GuardaLOG(TipoRE, DocEntry, "Consultando Retención con # DocEntry = " + DocEntry.ToString() + ", SP: " + SP.ToString(), Functions.FuncionesAddon.Transacciones.Creacion, Functions.FuncionesAddon.TipoLog.Emision)


                Else
                    SP = "GS_SAP_FE_HEI_OBTENERRETENCION"
            ...
            ElseIf _Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.SYPSOFT Then
                If TipoRE = "REA" Then
                    SP = "GS_SAP_FE_SYP_OBTENERRETENCIONANTICIPO "

                    oFuncionesAddon.GuardaLOG(TipoRE, DocEntry, "Consultando Retención con # DocEntry = " + DocEntry.ToString() + ", SP: " + SP.ToString(), Functions.FuncionesAddon.Transacciones.Creacion, Functions.FuncionesAddon.TipoLog.Emision)


                Else
                    SP = "GS_SAP_FE_SYP_OBTENERRETENCION "
            ...
            ElseIf _Nombre_Proveedor_SAP_BO = Functions.FuncionesAddon.PROVEEDOR_DE_SAPBO.TOPMANAGE Then
                If TipoRE = "REA" Then
                    SP = "GS_SAP_FE_TM_OBTENERRETENCIONANTICIPO "

                    oFuncionesAddon.GuardaLOG(TipoRE, DocEntry, "Consultando Retención con # DocEntry = " + DocEntry.ToString() + ", SP: " + SP.ToString(), Functions.FuncionesAddon.Transacciones.Creacion, Functions.FuncionesAddon.TipoLog.Emision)


                Else
                    SP = "GS_SAP_FE_TM_OBTENERRETENCION "
            ...
            If Not ds Is Nothing And Not ds.Tables.Count = 0 Then
                If TipoWS = "LOCAL" Then
                    oRetencion = New Entidades.wsEDoc_Retencion_LOCAL.ENTRetencion
                Else
                    oRetencion = New Entidades.wsEDoc_Retencion.ENTRetencion
                ...
                For i As Integer = 0 To ds.Tables.Count - 1
                    If i = 0 Then
                        For Each r As DataRow In ds.Tables(0).Rows
                            ...
                            If Not r("ContribuyenteRimpe") = "0" Then
                                oRetencion.AgenteRetencion = r("ContribuyenteRimpe")
                            End If
                    ...
                    ElseIf i = 1 Then
                        For Each r As DataRow In ds.Tables(1).Rows
                            ...
                            If TipoWS = "LOCAL" Then
                                impfaIVA = New Entidades.wsEDoc_Retencion_LOCAL.ENTRetencionDocSustento
                                'listaRetDocSusRet = New List(Of Entidades.wsEDoc_Retencion_LOCAL.ENTRetencionDocSustento)
                            Else
                                impfaIVA = New Entidades.wsEDoc_Retencion.ENTDetalleRetencion
                            End If

                            oRetencionDocSustento = New Entidades.wsEDoc_Retencion_LOCAL.ENTRetencionDocSustento
                            ...
                            If oRetencion.Tipo = 1 Then
                                ...
                                oRetencionDocSustento.FechaRegistroContable = DirectCast(r("FechaRegistroContable"), Date)
                                ...
                                Dim ListRetencionDocSustentoImp As New List(Of Entidades.wsEDoc_Retencion_LOCAL.ENTRetencionDocSustentoImpuesto)

                                If r("Base8") <> 0 Then
                                    Dim impoRetencionDocSustentoImp As New Entidades.wsEDoc_Retencion_LOCAL.ENTRetencionDocSustentoImpuesto
                            ...
                            Dim retPago As New Entidades.wsEDoc_Retencion_LOCAL.ENTRetencionDocSustentoPago
                    ...
                    ElseIf i = 2 Then
                        ...
                        For Each r As DataRow In ds.Tables(2).Rows
                            ...
                            Dim RetDocSusRet As New Entidades.wsEDoc_Retencion_LOCAL.ENTRetencionDocSustentoRetencion
                    ...
                    ElseIf i = 3 Then
                        ...
                        For Each r As DataRow In ds.Tables(3).Rows
                            ...
                            Dim oRetencionDocSustentoReem As New Entidades.wsEDoc_Retencion_LOCAL.ENTRetencionDocSustentoReembolso
                            ...
                            Dim listaoRetencionDocSustentoReemImp As New List(Of Entidades.wsEDoc_Retencion_LOCAL.ENTRetencionDocSustentoReembolsoImpuesto)

                            If r("Base12") <> 0 Then
                                Dim impoRetencionDocSustentoReemImp As New Entidades.wsEDoc_Retencion_LOCAL.ENTRetencionDocSustentoReembolsoImpuesto
                            ...
                            If r("Base13") <> 0 Then
                                Dim impoRetencionDocSustentoReemImp As New Entidades.wsEDoc_Retencion_LOCAL.ENTRetencionDocSustentoReembolsoImpuesto
                                impoRetencionDocSustentoReemImp.Codigo = r("CodigoBase13")
                                impoRetencionDocSustentoReemImp.CodigoPorcentaje = r("CodigoPorcentajeBase13")
                                impoRetencionDocSustentoReemImp.Tarifa = r("TarifaBase13")
                                impoRetencionDocSustentoReemImp.BaseImponibleReembolso = r("Base13")
                                impoRetencionDocSustentoReemImp.ImpuestoReembolso = r("ImpuestoReembolsoBase13")
                            ...
                            If r("Base8") <> 0 Then
                                Dim impoRetencionDocSustentoReemImp As New Entidades.wsEDoc_Retencion_LOCAL.ENTRetencionDocSustentoReembolsoImpuesto
                                impoRetencionDocSustentoReemImp.Codigo = r("CodigoBase8")
                                impoRetencionDocSustentoReemImp.CodigoPorcentaje = r("CodigoPorcentajeBase8")
                                impoRetencionDocSustentoReemImp.Tarifa = r("TarifaBase8")
                                impoRetencionDocSustentoReemImp.BaseImponibleReembolso = r("Base8")
                                impoRetencionDocSustentoReemImp.ImpuestoReembolso = r("ImpuestoReembolsoBase8")
                    ...
                    ElseIf i = 4 Then
                        For Each r As DataRow In ds.Tables(4).Rows
                            Dim itemDatoAdicionalFac As Object
                            If TipoWS = "LOCAL" Then
                                itemDatoAdicionalFac = New Entidades.wsEDoc_Retencion_LOCAL.ENTDatoAdicionalRetencion
                            Else
                                itemDatoAdicionalFac = New Entidades.wsEDoc_Retencion.ENTDatoAdicionalRetencion
                            End If
                            itemDatoAdicionalFac.Nombre = r("Concepto")
                            itemDatoAdicionalFac.Descripcion = r("Descripcion")
                            listaDatosAdicional.Add(itemDatoAdicionalFac)
            ...
            Try
                ...
                If System.IO.Directory.Exists(sRutaCarpeta) Then
                    ...
                    x = New XmlSerializer(GetType(Entidades.wsEDoc_Retencion_LOCAL.ENTRetencion))
    ...
    Public Function ConsultarRetencion_NUBE_4_1(ByVal TipoRE As String, ByVal DocEntry As Integer, ByVal TipoWS As String) As Object
        ...
        Dim oRetencion As New Entidades.wsEDoc_Retencion41.ENTRetencion
        ...
        Try
            ...
            If Functions.VariablesGlobales._ValidarCamposNulos = "Y" And _tipoManejo = "A" Then
                If Not ValidarCamposNulos(ds, "4") Then
                    Return Nothing
                End If
            End If
            ...
            If Not ds Is Nothing And Not ds.Tables.Count = 0 Then
                ...
                For i As Integer = 0 To ds.Tables.Count - 1
                    If i = 0 Then
                        ...
                        Try
                            For Each r As DataRow In ds.Tables(0).Rows
                                ...
                                'oRetencion.FechaEmision = r("FechaEmision")
                                oRetencion.FechaEmision = CDate(r("FechaEmision")).ToString("yyyy-MM-dd")
                                ...
                                'ADD DM 08012025
                                oRetencion.Campo4 = r("Campo4")
                                oRetencion.Campo5 = r("Campo5")
                                oRetencion.Campo6 = r("Campo6")
                                oRetencion.Campo7 = r("Campo7")
                                oRetencion.Campo8 = r("Campo8")
                                oRetencion.Campo9 = r("Campo9")
                                oRetencion.Campo10 = r("Campo10")
                                oRetencion.Campo11 = r("Campo11")
                                oRetencion.Campo12 = r("Campo12")
                                oRetencion.Campo13 = r("Campo13")
                                oRetencion.Campo14 = r("Campo14")
                                oRetencion.Campo15 = r("Campo15")
                        ...
                        Catch ex As Exception
                            If _tipoManejo = "A" Then
                                rsboApp.SetStatusBarMessage("Cabecera Retencion" & ex.Message().ToString(), SAPbouiCOM.BoMessageTime.bmt_Short, True)
                            End If
                    ...
                    ElseIf i = 1 Then
                        ...
                        Try
                            ...
                            For Each r As DataRow In ds.Tables(1).Rows
                                ...
                                oRetencionDocSustento.NumDocSustento = r("NumDocRetener")
                                'oRetencionDocSustento.FechaEmisionDocSustento = DirectCast(r("FechaEmisionDocRetener"), Date)
                                oRetencionDocSustento.FechaEmisionDocSustento = CDate(r("FechaEmisionDocRetener")).ToString("yyyy-MM-dd")
                                ...
                                If oRetencion.Tipo = 1 Then
                                    ...
                                    oRetencionDocSustento.CodSustento = r("CodSustento")
                                    'oRetencionDocSustento.FechaRegistroContable = r("FechaRegistroContable")
                                    oRetencionDocSustento.FechaRegistroContable = CDate(r("FechaRegistroContable")).ToString("yyyy-MM-dd")
                                    oRetencionDocSustento.NumAutDocSustento = r("NumAutDocSustento")
                                    oRetencionDocSustento.PagoLocExt = r("PagoLocExt")
                                    If oRetencionDocSustento.PagoLocExt = "02" Then
                                        oRetencionDocSustento.TipoRegi = r("TipoRegi")
                                    ...
                                    If r("Base13") <> 0 Then
                                        Dim impoRetencionDocSustentoImp As New Entidades.wsEDoc_Retencion41.ENTRetencionDocSustentoImpuesto
                                        impoRetencionDocSustentoImp.CodImpuestoDocSustento = r("CodImpDocSus13")
                                        impoRetencionDocSustentoImp.CodigoPorcentaje = r("CodPor13")
                                        impoRetencionDocSustentoImp.BaseImponible = r("Base13")
                                        impoRetencionDocSustentoImp.Tarifa = r("Tarifa13")
                                        impoRetencionDocSustentoImp.ValorImpuesto = r("ValorImpuesto13")
                        ...
                        Catch ex As Exception
                            If _tipoManejo = "A" Then
                                rsboApp.SetStatusBarMessage("Informacion documento retener " & ex.Message().ToString(), SAPbouiCOM.BoMessageTime.bmt_Short, True)
                            End If
                    ...
                    ElseIf i = 2 Then
                        ...
                        Catch ex As Exception
                            If _tipoManejo = "A" Then
                                rsboApp.SetStatusBarMessage("Informacion Retenciones " & ex.Message().ToString(), SAPbouiCOM.BoMessageTime.bmt_Short, True)
                            End If
                    ...
                    ElseIf i = 3 Then
                        ...
                        Try
                            ...
                            For Each r As DataRow In ds.Tables(3).Rows
                                Utilitario.Util_Log.Escribir_Log("oRetencion.Reembolso ", "ManejoDeDocumentos")
                                Dim oRetencionDocSustentoReem As New Entidades.wsEDoc_Retencion41.ENTRetencionDocSustentoReembolso
                                oRetencionDocSustentoReem.TipoIdentificacionProveedorReembolso = r("TipoIdentificacionProveedorReembolso")
                                oRetencionDocSustentoReem.IdentificacionProveedorReembolso = r("IdentificacionProveedorReembolso")
                                oRetencionDocSustentoReem.CodPaisPagoProveedorReembolso = r("CodPaisPagoProveedorReembolso")
                                ...
                                oRetencionDocSustentoReem.SecuencialDocReembolso = r("SecuencialDocReembolso")
                                'oRetencionDocSustentoReem.FechaEmisionDocReembolso = CDate(r("FechaEmisionDocReembolso"))
                                oRetencionDocSustentoReem.FechaEmisionDocReembolso = CDate(r("FechaEmisionDocReembolso")).ToString("yyyy-MM-dd")
                                oRetencionDocSustentoReem.NumeroAutorizacionDocReemb = r("NumeroAutorizacionDocReem")
                        ...
                        Catch ex As Exception
                            If _tipoManejo = "A" Then
                                rsboApp.SetStatusBarMessage("Reembolso Retencion " & ex.Message().ToString(), SAPbouiCOM.BoMessageTime.bmt_Short, True)
                            End If
                            _Error = "Reembolso Retencion: " + ex.Message.ToString()
                            Return Nothing
                        End Try
                        oRetencion.ENTRetencionDocSustento(0).ENTRetencionDocSustentoReembolso = ListoRetencionDocSustentoReem.ToArray
                    ElseIf i = 4 Then
                        Try
                            ...
                            For Each r As DataRow In ds.Tables(4).Rows
                                Dim itemDatoAdicionalFac As Object
                                itemDatoAdicionalFac = New Entidades.wsEDoc_Retencion41.ENTDatoAdicionalRetencion
                                Utilitario.Util_Log.Escribir_Log("oRetencion.Ingresando a informacion adicional ", "ManejoDeDocumentos")
                                itemDatoAdicionalFac.Nombre = r("Concepto")
                                itemDatoAdicionalFac.Descripcion = r("Descripcion")
                                listaDatosAdicional.Add(itemDatoAdicionalFac)
                            Next
                        Catch ex As Exception
                            If _tipoManejo = "A" Then
                                rsboApp.SetStatusBarMessage("Retencion Informacion Adicional " & ex.Message().ToString(), SAPbouiCOM.BoMessageTime.bmt_Short, True)
                            End If
            ...
            End If
            Utilitario.Util_Log.Escribir_Log("oRetencion.Serializer ", "ManejoDeDocumentos")
            Try
                'Dim sRutaCarpeta As String = ""
                'If _tipoManejo = "A" Then
                '    sRutaCarpeta = My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\LOG_SAED\"
    ...
    Public Function ProcesaEnvioDocumento(DocEntry As Integer, TipoDocumento As String, Optional ByVal sincronizado As Boolean = False) As String
        ...
        Try
            ...
            Else
                ...
                If _tipoManejo = "A" Then
                    rsboApp.SetStatusBarMessage("Seteando informacion a enviar..!!", SAPbouiCOM.BoMessageTime.bmt_Short, False)
                End If

                If TipoDocumento = "FCE" Or TipoDocumento = "FRE" Or TipoDocumento = "FAE" Then

                    oObjeto = ConsultarFactura(TipoDocumento, DocEntry, TipoWS)


                ElseIf TipoDocumento = "NDE" Then
                    oObjeto = ConsultarNotadeDebito(TipoDocumento, DocEntry, TipoWS)
                ElseIf TipoDocumento = "NCE" Then
                    oObjeto = ConsultarNotadeCredito(TipoDocumento, DocEntry, TipoWS)
                ...
                ElseIf TipoDocumento = "REE" Or TipoDocumento = "REA" Or TipoDocumento = "RER" Then
                    oObjeto = ConsultarRetencion(TipoDocumento, DocEntry, TipoWS)
                ElseIf TipoDocumento = "LQE" Then
                    'oObjeto = ConsultarLiquidacionCompra(TipoDocumento, DocEntry, TipoWS)
                ...
                If Not oObjeto Is Nothing Then
                    ...
                    If _tipoManejo = "A" Then
                        ...
                        oFuncionesAddon.GuardaLOG(TipoDocumento, DocEntry, "Envíando Documento al SRI", Functions.FuncionesAddon.Transacciones.Creacion, Functions.FuncionesAddon.TipoLog.Emision)

                    End If

                    Utilitario.Util_Log.Escribir_Log("Enviando documento al SRI, TipoDocumento " + TipoDocumento.ToString, "ManejoDeDocumentos")
                    Utilitario.Util_Log.Escribir_Log("Enviando documento al SRI, DocEntry " + DocEntry.ToString, "ManejoDeDocumentos")
                    Utilitario.Util_Log.Escribir_Log("Enviando documento al SRI, TipoWS " + TipoWS.ToString, "ManejoDeDocumentos")
        ...
        Catch ex As Exception
            _Error = ex.Message
            If _tipoManejo = "A" Then
                rsboApp.SetStatusBarMessage("Error:  " & ex.Message.ToString(), SAPbouiCOM.BoMessageTime.bmt_Short, True)
            End If
            Return _Error + _errorMensajeWSEnvío
            'oUtilitario_Email = New Utilitario.UtilManejador_Email("Error: UserControl_Factura/oBackgroundWorker_DoWork Usuario: " + _ConexionSAP.SBO_Application.Company.DatabaseName.ToString() + " - " + _ConexionSAP.SBO_Application.Company.UserName.ToString(), ConfigurationManager.AppSettings("CorreoResponsable"), lbErrorEnSAP.Text + " " + lblError.Text + " " + lblError2.Text + " " + ex.Message)
            'oUtilitario_Email.Enviar()
        End Try
    End Function
