    ...
    Public Function ConsultarRetencion(DocEntry As Integer, ByVal TipoRE As String) As Entidades.RequestRetencion
        ...
        If ds.Tables.Count > 0 Then
            For Each r As DataRow In ds.Tables(0).Rows
                ...
                Try
                    retencion.campoAdicional1 = r("campoAdicional1")
                    Utilitario.Util_Log.Escribir_Log(" retencion.campoAdicional1 : " & r("campoAdicional1"), "ManejoDeDocumentos")
                Catch ex As Exception
                    Utilitario.Util_Log.Escribir_Log(" retencion.campoAdicional1 : " & ex.Message.ToString, "ManejoDeDocumentos")
                End Try

                Try
                    retencion.campoAdicional2 = r("campoAdicional2")
                    Utilitario.Util_Log.Escribir_Log(" retencion.campoAdicional2 : " & r("campoAdicional2"), "ManejoDeDocumentos")
                Catch ex As Exception
                    Utilitario.Util_Log.Escribir_Log(" retencion.campoAdicional2 : " & ex.Message.ToString, "ManejoDeDocumentos")
                End Try
